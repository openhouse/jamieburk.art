  ...
  return (
    <section className="jb-frame py-16">
      <div className="jb-reading">
        ...
        <h2 className="jb-display mt-3 text-3xl font-bold text-jb-ink">What becomes usable</h2>
      </div>
      <div className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {capabilities.map((capability) => (
          <JBCard key={capability.title}>
            <h3 className="jb-display text-xl font-semibold text-jb-ink">{capability.title}</h3>
