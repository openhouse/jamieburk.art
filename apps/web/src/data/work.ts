...
const workItemsInput = [
  {
    ...
    evidence: [
      ...
      "TODO: Jamie approval required before launch. Contributed to 2x revenue growth",
  ...
  },
  {
    ...
    evidence: [
      "TODO: Jamie approval required before launch. 30+ pages of shared campaign-memory infrastructure",
  ...
  },
  {
    ...
    summary:
      "Co-built a Python / Django + Ember.js community-calendar platform organized around followable keyword communities, with adoption estimated across roughly 35 city ecosystems pending Jamie approval.",
    ...
    evidence: [
      ...
      "TODO: Jamie approval required before launch. Roughly 35 city ecosystems reached"
    ],
    knownOpenProtected: {
      known:
  ...
  },
  {
    ...
    summary:
      "Created repeatable hosting, onboarding, facilitation, documentation, and continuity systems across 300+ gatherings and 20+ resident artists, pending final claim approval.",
    ...
    evidence: [
      "TODO: Jamie approval required before launch. 300+ hosted gatherings",
      "TODO: Jamie approval required before launch. 20+ resident artists supported",
