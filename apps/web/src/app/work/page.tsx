  ...
  return (
    <div className="jb-frame py-12">
      <div className="jb-reading">
        <h1 className="jb-display text-5xl font-bold text-jb-ink">Selected work</h1>
      ...
      <div className="mt-12 space-y-14">
        {workGroups.map((group) => {
          ...
          if (group === "Source-backed memory / AI lab") {
            return (
              <section key={group}>
                <h2 className="jb-display text-3xl font-semibold text-jb-ink">{group}</h2>
                <div className="mt-5 rounded-lg border border-jb-ink/15 bg-jb-warm/88 p-5">
                  <h3 className="jb-display text-2xl font-semibold text-jb-ink">
