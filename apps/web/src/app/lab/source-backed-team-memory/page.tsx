  ...
  return (
    <article className="jb-frame py-12">
      <div className="jb-reading">
        <p className="jb-display text-sm font-semibold uppercase text-jb-blue">Lab / method</p>
        <h1 className="jb-display mt-3 text-5xl font-bold text-jb-ink">
        ...
        <div className="mt-6 rounded-lg border border-jb-ochre/50 bg-jb-lemon/25 p-5">
          <p className="leading-7 text-jb-ink/76">
            ...
            browser, or substitute for human review.
          </p>
        </div>
