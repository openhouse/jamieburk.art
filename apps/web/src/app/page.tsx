  ...
  return (
    <>
      ...
      <section className="jb-frame py-16">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div className="jb-reading">
            <p className="jb-display text-sm font-semibold uppercase text-jb-blue">
              Selected systems
            </p>
          ...
          <dl className="grid gap-3">
            {transformations.map(([from, to]) => (
              <div
                ...
                key={from}
              >
                <dt className="jb-display font-semibold text-jb-ink">{from}</dt>
                <dd className="hidden text-jb-blue sm:block">to</dd>
                <dd className="jb-display font-semibold text-jb-green">{to}</dd>
              </div>
            ))}
          </dl>
        </div>
      ...
      <section className="jb-frame grid gap-8 py-16 lg:grid-cols-[0.8fr_1.2fr]">
        <div>
          <p className="jb-display text-sm font-semibold uppercase text-jb-blue">How I work</p>
          <h2 className="jb-display mt-3 text-3xl font-bold text-jb-ink">
