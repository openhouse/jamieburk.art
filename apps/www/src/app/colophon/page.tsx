...
const details = [
  ...
  "Page-local numerical citations generated from a public-safe knowledge bank",
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-5 text-lg leading-8 text-jb-ink/72">
          Selected factual and quantitative claims use page-local numerical
          citations generated from a public-safe knowledge bank. Citations link
          to public sources where possible, identify private primary evidence
          without exposing it, preserve corrections, and retain uncertainty
