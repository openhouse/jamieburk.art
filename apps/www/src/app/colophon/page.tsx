...
const details = [
  ...
  "Public-safe artifacts, claim discipline, and knowledge-bank governed wording",
  "Accessibility-minded semantic HTML, keyboard focus states, and readable type",
  "Karla for body/UI/prose and Archivo Narrow for display headings and metadata",
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          ...
          content, public-safe artifacts, and a proofs bank that governs claim
          wording. The design uses Broadway blue, Jamie&apos;s oil-pastel palette,
