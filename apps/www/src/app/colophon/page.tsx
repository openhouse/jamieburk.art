...
const details = [
  ...
  "Karla for body/UI text and Archivo Narrow for proof labels and compact public-notice emphasis",
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          This site is built as a small public proof surface for technical
          project management, product operations, implementation, documentation,
          and public-facing systems work. It uses local MDX content, public-safe
          artifacts, and
