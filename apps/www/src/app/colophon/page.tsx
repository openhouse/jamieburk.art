...
const details = [
  ...
  "Karla for body/UI/prose and Archivo Narrow for display headings, proof labels, metadata labels, and selected emphasis",
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          This site is built as a small public proof surface for selected
          professional work. It uses local MDX content, public-safe artifacts,
          no analytics in V1, and staging-first deployment. The design uses
          Broadway blue, restrained oil-pastel accents, and a quiet
          proportional-grid sensibility. Staging is reviewable but not
          indexable, and production should only become indexable after content,
          metadata, and public-safety review.
        </p>
      </div>
