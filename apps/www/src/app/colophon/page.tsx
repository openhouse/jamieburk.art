...
const details = [
  ...
  "Karla for body/UI/prose and Archivo Narrow for display headings and proof labels",
  ...
  "Staging-first Docker / Dokku deployment with explicit opt-in production indexing",
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          ...
          content, public-safe artifacts, and no invasive tracking in V1. The
          ...
          reviewable but not indexable, and production can only become indexable
          after content and metadata review.
        </p>
      </div>
