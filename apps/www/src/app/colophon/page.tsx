...
export const metadata: Metadata = createMetadata({
  ...
  description:
    "Colophon for Jamie Burkart's public-safe proof site.",
  path: "/colophon"
});
...
const details = [
  ...
  "Karla for body/UI/prose and Oswald for labels and metadata",
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          This site is built as a small public-safe proof surface for technical
          project management, product operations, implementation, civic
          technology, documentation, and knowledge-systems work. It uses local
          MDX content, public-safe artifacts, and intentionally limited
          tracking. The design uses Broadway blue, Jamie&apos;s oil-pastel palette,
          and a quiet proportional grid derived from his print-layout
          sketchpad. Staging is reviewable but not indexable, and production
