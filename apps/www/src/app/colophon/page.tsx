...
export const metadata: Metadata = createMetadata({
  ...
  description:
    "Colophon for Jamie Burkart's public-safe portfolio and knowledge-bank projection.",
  path: "/colophon"
});

const details = [
  "Static-first Next.js App Router site with local MDX content",
  "Public-safe artifacts, claim discipline, and a repo knowledge bank",
  "Accessibility-minded semantic HTML, keyboard focus states, and readable type",
  "Karla for body/UI text and Archivo Narrow for display headings",
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          This site is built as a small public proof surface projected from a
          reviewed knowledge bank. It uses local MDX content, public-safe
          artifacts, and intentionally limited tracking. The design uses Broadway
          blue, Jamie&apos;s oil-pastel palette, and a quiet proportional grid
          derived from his print-layout sketchpad. Staging is reviewable but not
