...
const details = [
  ...
  "Karla for body text, Oswald for labels, and a Palatino-first system serif for display headings",
  "The social preview uses a metadata-stripped Palatino name raster; no private or proprietary font file is committed or served",
