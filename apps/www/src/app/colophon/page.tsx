...
const details = [
  ...
  "Karla for body/UI/prose and Archivo Narrow for display headings, eyebrows, and proof labels",
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          ...
          notebook. It uses local MDX content, public-safe artifacts, and no
          tracking in V1. The design uses Broadway blue, Jamie&apos;s
