...
const details = [
  ...
  "Karla for body/UI/prose and Archivo Narrow for display headings, eyebrows, proof labels, and compact metadata",
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          ...
          readable type, accessibility-minded structure, staging-first review,
          and intentionally limited tracking. Production only becomes indexable
          after content, metadata, and release-gate review.
        </p>
      </div>
