...
export const metadata: Metadata = createMetadata({
  ...
  description:
    "Colophon for Jamie Burkart's public-safe portfolio and proofs-bank projection.",
  path: "/colophon"
});
...
const details = [
  ...
  "Karla for prose and interface text; Archivo Narrow for compact headings and proof labels",
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          ...
          public-safe proofs bank. It uses local MDX content, public-safe
          artifacts, and intentionally limited tracking. Karla carries readable
          prose and interface text. Archivo Narrow carries compact headings,
          proof labels, metadata, and civic-notice moments. Staging is
