...
const details = [
  ...
  "Karla for body/UI/prose and Archivo Narrow for display headings, proof labels, and selected emphasis",
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          ...
          sensibility. Staging is reviewable but not indexable. Production should
          only become indexable after content, metadata, and public-safety review.
        </p>
      </div>
