...
export const metadata: Metadata = createMetadata({
  ...
  description:
    "Colophon for Jamie Burkart's public-safe technical operations portfolio.",
  path: "/colophon"
});
...
const details = [
  ...
  "Karla for body/UI/prose and Oswald for labels, metadata, and compact emphasis",
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          This site is built as a focused public proof surface for technical
          operations, product operations, implementation, and source-backed
          knowledge work. It uses local MDX content, public-safe artifacts, and
          intentionally limited tracking. The design uses Broadway blue,
          ...
          indexable, and production becomes indexable only through explicit
