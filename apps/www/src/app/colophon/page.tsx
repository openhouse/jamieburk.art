...
export const metadata: Metadata = createMetadata({
  ...
  description:
    "Colophon for Jamie Burkart's public-safe portfolio and source-backed work record.",
  path: "/colophon"
});
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          This site is built as a small public proof surface and source-backed
          work record. It uses local MDX content, public-safe artifacts, and no
          analytics or tracking in V1. The design uses Broadway blue, Jamie&apos;s
