...
const details = [
  ...
  "Karla for body/UI/prose and Archivo Narrow for display headings, eyebrows, proof labels, and selected emphasis",
  "No private or proprietary font files are committed or served",
  "Designed with Broadway blue, restrained oil-pastel accents, and a quiet proportional-grid sensibility",
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          ...
          Broadway blue, restrained oil-pastel accents, and a quiet
          proportional-grid sensibility.
        </p>
        <p className="mt-5 text-xl leading-8 text-jb-ink/76">
          No private or proprietary font files are committed or served. Staging
          is reviewable but not indexable. Production should only become
          indexable after content, metadata, and public-safety review.
        </p>
      </div>
