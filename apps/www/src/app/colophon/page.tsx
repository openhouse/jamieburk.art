    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          ...
          no invasive analytics in V1. The design uses Broadway blue,
          Jamie&apos;s oil-pastel palette, and a quiet proportional grid derived
          from his print-layout sketchpad. The site uses Karla for body/UI/prose
          and Archivo Narrow for display headings and compact proof labels.
          Fonts are loaded through next/font/google. No private or proprietary
          font files are committed or served.
        </p>
      </div>
