    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-6 text-xl leading-8 text-jb-ink/76">
          ...
          claim discipline, and intentionally limited tracking. Karla carries
          readable prose and interface text; Archivo Narrow carries headings and
          compact proof labels. Staging is reviewable but not indexable, and
          production becomes indexable only through explicit approval.
        </p>
      </div>
