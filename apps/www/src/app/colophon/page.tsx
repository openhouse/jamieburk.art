    ...
    <div className="jb-frame py-12">
      ...
      <section className="jb-reading mt-14 border-t-2 border-jb-blue pt-8">
        ...
        <p className="mt-5 leading-8 text-jb-ink/76">
          Selected factual, quantitative, and historical claims on this site are
          connected to page-local numbered citations. The underlying knowledge
          bank records what each source supports, what it does not establish, and
          what evidence remains protected.
        </p>
