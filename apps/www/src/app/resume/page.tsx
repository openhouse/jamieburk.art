...
const highlights = [
  "Long-running operating-structure work across civic, cultural, small-business, and technical environments",
  ...
  "Created repeatable hosting and continuity systems for gatherings and resident-artist support"
];
      ...
      <div className="grid gap-10 lg:grid-cols-[0.68fr_0.32fr]">
        <div className="jb-reading">
          ...
          <p className="mt-4 text-sm text-jb-ink/62">
            Public resume PDF for Technical Project Manager, Product Operations
