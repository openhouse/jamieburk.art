      ...
      <div className="grid gap-10 lg:grid-cols-[0.68fr_0.32fr]">
        <div className="jb-reading">
          ...
          <p className="mt-6 text-xl leading-8 text-jb-ink/76">
            ...
            onboarding materials, reporting rhythms, and durable handoffs.
          </p>
          ...
          <p className="mt-4 text-sm text-jb-ink/62">
            Current resume PDF is present for staging review. Production remains
            blocked until Jamie approves the public email, resume page, and PDF
            for promotion.
          </p>
        </div>
