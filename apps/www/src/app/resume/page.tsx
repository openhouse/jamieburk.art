...
const highlights = [
  ...
  "Helped a legacy industrial business translate catalog knowledge and operating routines into e-commerce workflows",
  "Helped build and steward 30+ pages of shared Commercial Rent Stabilization campaign memory",
  "Co-built community web systems for DIY arts and music organizers",
      ...
      <div className="grid gap-10 lg:grid-cols-[0.68fr_0.32fr]">
        <div className="jb-reading">
          ...
          <p className="mt-4 text-sm text-jb-ink/62">
            Resume download remains launch-gated until the approved current PDF
