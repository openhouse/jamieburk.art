...
import { proofStripItems } from "@/data/proofs";
      ...
      <div className="grid gap-10 lg:grid-cols-[0.68fr_0.32fr]">
        <div className="jb-reading">
          ...
          <p className="mt-6 text-xl leading-8 text-jb-ink/76">
            ...
            giving emerging work resilient form through requirements, workflows,
          ...
          <p className="mt-4 text-sm text-jb-ink/62">
            PDF download is intentionally withheld until the approved resume
            artifact is added.
          </p>
        </div>
