      ...
      <div className="grid gap-10 lg:grid-cols-[0.68fr_0.32fr]">
        <div className="jb-reading">
          ...
          <p className="mt-6 text-xl leading-8 text-jb-ink/76">
            ...
            helping teams surface the structure inside emerging work and turn it
            into requirements, workflows, documentation, source maps, decision
            records, action tracking, public guidance, launch support,
