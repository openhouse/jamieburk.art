      ...
      <div className="grid gap-10 lg:grid-cols-[0.68fr_0.32fr]">
        <div className="jb-reading">
          ...
          <p className="mt-6 text-xl leading-8 text-jb-ink/76">
            Resume for technical project management, technical operations,
            product operations, implementation, documentation systems, civic
            technology, and public-facing systems roles.
          </p>
          ...
          <p className="mt-4 text-sm text-jb-ink/62">
            Current PDF supplied for this production-readiness branch.
            Production still requires final written approval before promotion.
          </p>
        </div>
