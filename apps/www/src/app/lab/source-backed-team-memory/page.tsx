      ...
      <div className="jb-reading">
        ...
        <div className="mt-6 rounded-lg border border-jb-ochre/50 bg-jb-lemon/25 p-5">
          <p className="leading-7 text-jb-ink/76">
            Early research / method / consulting practice. Not a finished SaaS,
            chatbot, private archive browser, surveillance system, replacement
            for human judgment, or autonomous publishing system.
          </p>
        </div>
