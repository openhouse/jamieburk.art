    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-5 text-xl leading-8 text-jb-ink/76">
          For roles, referrals, consulting, or a bounded source-backed memory
          sprint, start with the approved resume and send a direct note.
        </p>
        <div className="mt-8 rounded-lg border border-jb-ink/12 bg-jb-warm p-6">
          <dl className="space-y-5">
            <div>
              <dt className="font-semibold text-jb-ink">Contact</dt>
