      ...
      <div className="jb-reading">
        ...
        <div className="mt-8 rounded-lg border border-jb-ink/12 bg-jb-warm p-6">
          <dl className="space-y-5">
            <div>
              <dt className="jb-meta-label text-sm text-jb-ink">Public email</dt>
              <dd className="mt-1 text-jb-ink/74">
                TODO: Jamie approval required before launch.
              </dd>
            </div>
            <div>
              <dt className="jb-meta-label text-sm text-jb-ink">Location</dt>
              <dd className="mt-1 text-jb-ink/74">{site.location}</dd>
            </div>
            <div>
              <dt className="jb-meta-label text-sm text-jb-ink">LinkedIn</dt>
              <dd className="mt-1 text-jb-ink/74">
                TODO: Jamie approval required before launch.
              </dd>
            </div>
            <div>
              <dt className="jb-meta-label text-sm text-jb-ink">GitHub</dt>
              <dd className="mt-1 text-jb-ink/74">
                TODO: Jamie approval required if public-ready.
              </dd>
            </div>
            <div>
              <dt className="jb-meta-label text-sm text-jb-ink">Resume</dt>
              <dd className="mt-1">
