    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-5 text-xl leading-8 text-jb-ink/76">
          For roles, referrals, best-fit consulting conversations, or
          collaborations, email Jamie.
        </p>
        ...
        <section className="mt-8 rounded-lg border border-jb-ink/12 bg-jb-paper p-6">
          ...
          <p className="mt-3 leading-7 text-jb-ink/76">{site.referralBlurb}</p>
        </section>
      </div>
    </div>
  );
