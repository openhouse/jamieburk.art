    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <div className="mt-8 space-y-6 text-xl leading-9 text-jb-ink/78">
          ...
          <p>
            My work sits where complex public-facing systems have more context
            than structure: civic technology, small-business operations,
          ...
          <p>
            ...
            interfaces, coordinate implementation, and leave behind source-aware
          ...
          <p>
            ...
            delivery, AI-evaluation-informed documentation, and source-backed
            knowledge systems.
          </p>
        </div>
