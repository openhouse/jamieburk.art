      ...
      <section className="jb-frame grid gap-8 py-16 lg:grid-cols-[0.8fr_1.2fr]">
        ...
        <div className="space-y-7">
          <p className="text-xl leading-9 text-jb-ink/78">
            I usually enter when the work is important but not yet fully
            structured: the requirements, workflows, decision records,
            ownership, or handoffs need to be made clear enough for people to
            act. I listen across stakeholders, map what is known and unknown,
            create the workflows or documentation the team needs, support launch
            or adoption, and leave behind materials that make the work easier to
            maintain.
          </p>
          <ContactCTA />
        </div>
