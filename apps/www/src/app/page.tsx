...
const startHereLinks = [
  {
    ...
    note: "The fastest role-fit proof surface for the New York City Office of Technology and Innovation (OTI), product operations, implementation, and delivery coordination."
  },
  {
