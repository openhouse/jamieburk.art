    ...
    <>
      ...
      <section className="jb-frame py-16">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          ...
          <p className="jb-meta-label text-sm text-jb-blue">
            Selected systems
          </p>
        ...
        <div className="jb-frame grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="jb-reading">
            ...
            <p className="mt-4 leading-8 text-jb-ink/76">
              ...
              work as it is forming, make the next useful structure visible, and
      ...
      <section className="jb-frame grid gap-8 py-16 lg:grid-cols-[0.8fr_1.2fr]">
        <div>
          <p className="jb-meta-label text-sm text-jb-blue">How I work</p>
          <h2 className="mt-3 text-3xl font-bold text-jb-ink">
        ...
        <div className="space-y-7">
          <p className="text-xl leading-9 text-jb-ink/78">
            I usually enter when the work is important, stakeholder-heavy, and
            still taking form. I listen across the people closest to the work,
            map what needs to be decided, create the workflows or documentation
            the team needs, support launch or adoption, and leave behind
