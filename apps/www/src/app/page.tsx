        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
          <div className="jb-reading">
            ...
            <p className="mt-4 leading-8 text-jb-ink/76">
              ...
              defined, stakeholder-heavy situations becoming usable systems,
      ...
      <section className="jb-frame grid gap-8 py-16 lg:grid-cols-[0.8fr_1.2fr]">
        ...
        <div className="space-y-7">
          <p className="text-xl leading-9 text-jb-ink/78">
            I usually enter when the work is important but ambiguous:
            stakeholder-heavy, loosely defined, and easy to lose track of. I
