...
export default function TechnicalOperationsPage() {
  return (
    <div className="jb-frame py-12">
      ...
      <section className="mt-10 rounded-lg border border-jb-blue/20 bg-jb-sky/15 p-6">
        <h2 className="text-2xl font-semibold text-jb-ink">
          Why this maps to Technical Operations
        </h2>
        <p className="mt-4 leading-7 text-jb-ink/76">
          Technical Operations work is the operating backbone of a team: how work
          is planned, tracked, documented, reported, onboarded, handed off, and
          improved over time.
        </p>
        <p className="mt-4 leading-7 text-jb-ink/76">
          Across civic, cultural, small-business, and public-facing technical
