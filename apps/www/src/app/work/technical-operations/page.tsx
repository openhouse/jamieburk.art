...
const operatingBackbone = [
  ...
  {
    title: "Dependencies and operating metrics",
    text:
      "I help teams see cross-functional dependencies, owner gaps, review status, adoption signals, and operational metrics without pretending every useful signal is a perfect KPI."
  },
  {
    title: "Team health and decision frameworks",
    text:
      "I create lightweight decision frameworks, retrospectives, and review rituals that make disagreement, risk, and next steps easier to handle without depending on heroic memory."
  }
];
    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-5 text-xl leading-8 text-jb-ink/76">
          ...
          delivery coordination, planning cycles, status reporting, decision
          frameworks, action trackers, onboarding materials, runbooks,
          operational metrics, documentation systems, launch support, and
          durable handoffs.
        </p>
      </div>
      <div className="mt-10">
