...
const proofMap = [
  ...
  },
  {
    ...
    proof:
      "shared campaign memory, live coalition mapping, decision records, source maps, action trackers, stakeholder follow-up, and public/private boundary management."
  },
  {
    project: "CallNYC",
    proof:
