    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-5 text-xl leading-8 text-jb-ink/76">
          These case studies show a recurring pattern: emerging work becoming
          usable systems, public-facing tools, documentation, decision trails,
          and durable handoffs.
        </p>
        <p className="mt-4 text-base leading-7 text-jb-ink/70">
          Each public summary is written from a Known / Open / Protected
          standard: what can be said plainly, what still needs approval, and
          what stays private.
        </p>
