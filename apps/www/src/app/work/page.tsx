    ...
    <div className="jb-frame py-12">
      <div className="jb-reading">
        ...
        <p className="mt-5 text-xl leading-8 text-jb-ink/76">
          These case studies show a recurring pattern: ambiguous,
          stakeholder-heavy work becoming usable systems, public-facing tools,
          documentation, decision records, launch support, and durable handoffs.
        </p>
              ...
              <section key={group}>
                ...
                <div className="mt-5 rounded-lg border border-jb-ink/15 bg-jb-warm/88 p-5">
                  ...
                  <p className="mt-3 leading-7 text-jb-ink/76">
                    A lab / method for turning meetings, decisions, open
                    questions, and source materials into human-reviewable
                    operating memory for knowledge-heavy teams.
                  </p>
