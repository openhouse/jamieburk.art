              ...
              <section key={group}>
                ...
                <div className="mt-5 rounded-lg border border-jb-ink/15 bg-jb-warm/88 p-5">
                  ...
                  <p className="mt-3 leading-7 text-jb-ink/76">
                    A lab / proof-of-practice for turning selected meetings,
                    documents, and product conversations into human-reviewed
                    decision records, onboarding context, open questions, and
