...
<Claim
  ...
  occurrenceId="attendance-workbook-scale"
/>

The aggregate is deliberately narrow: numbered workbook entries are not a
complete attendance census, and meals served are not unique people. Names,
contacts, invitation notes, and person-level participation remain private.
...
<Claim
  ...
  surface="/work/196-sunday-dinner"
  pageId="196-sunday-dinner"
  occurrenceId="facebook-milestone-chronology"
/>
...
<Claim
  ...
  surface="/work/196-sunday-dinner"
  pageId="196-sunday-dinner"
  occurrenceId="residency-onboarding-handoff"
/>
