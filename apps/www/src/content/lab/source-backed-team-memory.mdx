...
A first sprint can be small: map the team's current sources of truth, identify where decisions and ideas are getting lost, create a decision log, an open-question register, a meeting-memory template, and an onboarding reader, then hand off a practice the team can keep using.
