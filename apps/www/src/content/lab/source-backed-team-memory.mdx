...
A first engagement could be a small Team Memory / Decision Operations Sprint.

The goal would not be to install a heavy knowledge-management platform. The goal would be to create a repeatable habit: meetings become decisions, decisions become records, and records become onboarding memory.
