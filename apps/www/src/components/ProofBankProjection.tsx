    ...
    <section className="jb-frame py-16" aria-labelledby="selected-proof">
      <div className="jb-reading">
        ...
        <p className="mt-4 leading-8 text-jb-ink/76">
          The public story is narrower than the knowledge bank: a set of
          defensible claims that show Jamie creating operating structure across
          technical, civic, community, and source-backed work.
        </p>
      </div>
