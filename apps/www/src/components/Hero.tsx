      ...
      <div className="jb-frame grid gap-10 py-16 md:grid-cols-[1.25fr_0.75fr] md:items-end md:py-20">
        <div className="jb-reading">
          ...
          <p className="mt-5 text-xl leading-8 text-jb-ink/78">
            I help teams clarify requirements, map workflows, document
            decisions, coordinate launches, onboard people, and leave behind
            handoffs others can actually use.
          </p>
        ...
        >
          ...
          <p className="mt-5 text-sm leading-6 text-jb-ink/68">
            Work where the need is real but ownership, workflows, documentation,
            and next steps are not yet clear becomes shared records, public
            guidance, maintainable workflows, and materials people can use after
            the meeting is over.
          </p>
        </div>
      </div>
