      ...
      <div className="jb-frame grid gap-10 py-16 md:grid-cols-[1.25fr_0.75fr] md:items-end md:py-20">
        <div className="jb-reading">
          ...
          <p className="mt-6 text-2xl font-semibold leading-snug text-jb-green">
            I move ambiguous public-facing work toward launch and durable handoff.
          </p>
          <p className="mt-5 text-xl leading-8 text-jb-ink/78">
            I clarify what teams are trying to do, make ownership and decisions
            visible, and build the workflows, public tools, and documentation
            people need to deliver the work, maintain it, and safely continue it.
          </p>
