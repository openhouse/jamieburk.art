...
import { AtAGlance, ArtifactGallery, ArtifactList, CareNote, CaseStudyQuestions, CreditsList, KnownOpenProtected, PublicSafetyNote, SourceLayer, VisibilityNote } from "@/components/CaseStudyBlocks";
