...
import { AtAGlance, ArtifactGallery, ArtifactList, CareNote, CreditsList, KnownOpenProtected, ProofBankClaims, PublicSafetyNote, SourceLayer, VisibilityNote } from "@/components/CaseStudyBlocks";
