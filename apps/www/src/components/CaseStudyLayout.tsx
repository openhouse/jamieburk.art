...
import { AtAGlance, ArtifactGallery, ArtifactList, CareNote, CreditsList, KnownOpenProtected, ProjectLinks, PublicSafetyNote, SourceLayer, VisibilityNote } from "@/components/CaseStudyBlocks";
