...
export function KnownOpenProtected({ item }: { item: WorkMeta }) {
  ...
  return (
    <section aria-labelledby="known-open-protected">
      ...
      <p className="mt-3 max-w-3xl text-sm leading-6 text-jb-ink/74">
        ...
        intentionally omitted for privacy, consent, client trust, law, civic
        sensitivity, or community safety.
      </p>
      <div className="mt-5 grid gap-4 md:grid-cols-3">
