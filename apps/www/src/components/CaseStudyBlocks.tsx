...
const representativeArtifactExplainer =
  "These cards describe public-safe examples, redrawn structures, or artifact types. They do not imply that private source files, raw notes, legal-review materials, private screenshots, or unapproved documents are published here.";
  ...
  return (
    <section aria-labelledby="artifact-list">
      ...
      <p className="mt-3 max-w-3xl text-sm leading-6 text-jb-ink/70">
        {representativeArtifactExplainer}
      </p>
