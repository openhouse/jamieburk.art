    ...
    <section aria-labelledby="at-a-glance" className="rounded-lg bg-jb-blue p-5 text-jb-paper">
      ...
      <dl className="mt-5 grid gap-4 sm:grid-cols-2">
        {rows.map(([label, value]) => (
          <div key={label}>
            <dt className="jb-proof-label text-xs text-jb-paper/70">
              {label}
            </dt>
      ...
      <div className="mt-5">
        <p className="jb-proof-label text-xs text-jb-paper/70">
          Tags
        </p>
        <div className="mt-3">
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-3">
        {item.artifacts.map((artifact, index) => (
          <JBCard className="jb-artifact-surface min-h-56" key={artifact.title}>
            <p className="jb-proof-label text-xs text-jb-blue">
    ...
    <section aria-labelledby="known-open-protected">
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-3">
        {blocks.map(([label, text]) => (
          <JBCard key={label}>
            <h3 className="jb-proof-label text-lg text-jb-blue">{label}</h3>
