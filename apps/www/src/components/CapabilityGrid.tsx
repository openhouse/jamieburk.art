...
export function CapabilityGrid() {
  return (
    <section className="jb-frame py-16">
      ...
      <div className="mt-8 grid border-y border-jb-ink/16 md:grid-cols-2">
        {capabilities.map((capability) => (
          <article
            className="border-b border-jb-ink/16 py-6 md:odd:border-r md:odd:pr-7 md:even:pl-7 md:[&:nth-last-child(-n+2)]:border-b-0"
