...
export const site = {
  ...
  description:
    "Brooklyn-based technical project manager who builds operating structure across product operations, implementation, documentation, civic technology, web systems, knowledge systems, and public-facing tools.",
