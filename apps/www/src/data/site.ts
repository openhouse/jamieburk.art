...
export const site = {
  ...
  description:
    "Brooklyn-based technical project manager who turns loosely defined, high-stakes work into usable systems across product operations, implementation, documentation, civic technology, web systems, knowledge systems, and public-facing tools.",
