...
const claimsInput = [
  {
    ...
    evidenceBasis: [
      ...
      "cross-project public-safe claim synthesis",
      "selected work chronology"
    ],
    guardrail:
      "Use as role-fit positioning grounded in concrete artifacts. Do not imply Jamie replaces governance, leadership, or team judgment.",
    href: "/work/technical-operations",
    allowedSurfaces: ["resume-page", "about-page", "case-study", "internal-docs"],
    priority: 0.5
  },
  {
