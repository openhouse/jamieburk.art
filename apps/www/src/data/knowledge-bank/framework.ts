...
} from "./proof-debt-evidence-batch-2026-07-15.ts";
...
export const frameworkProjects = [
  ...
  },
  {
    ...
    claimIds: ["CLM-SUNDAY-DINNER-WEEKLY-OPEN", "CLM-196-RESIDENCY-ONBOARDING-2023", "CLM-SUNDAY-DINNER-300-GATHERING-ARCHIVE-2012-2021"],
...
export const frameworkInquiries = [
  ...
  openInquiry("INQ-NYCARTC-COFOUNDING-ROLE", "nyc-artist-coalition", "What do public formation records, launch materials, websites, correspondence, and collaborators establish about Jamie's role creating NYC Artist Coalition?", ["Recover dated public launch and formation materials.", "Map website authorship and coalition role language.", "Seek collaborator confirmation before broadening public wording."], ["Public records now trace a bounded sequence from WOW List's popular.vote route through Call Script and the January DCLA meeting discussion into an open February coalition priority-setting meeting. Jamie's firsthand confirmation supports his facilitation and systems lineage, but the complete founding group and independently corroborated co-founder wording remain open."], ["SRC-BEDFORD-BOWERY-DIY-SPACES-2017", "SRC-VICE-NYCARTC-DCA-2017", "SRC-X-WOWLIST-POPULAR-VOTE-2016", "SRC-FB-CALLSCRIPT-PAGE-2026", "SRC-FB-NYCAC-DCLA-FORMATION-DISCUSSION-2017", "SRC-NYCAC-FACEBOOK-EVENT-GENERAL-MEETING-2017", "SRC-JAMIE-CALLSCRIPT-PARTICIPATION-LINEAGE-2026"]),
  ...
  openInquiry("INQ-SUNDAY-DINNER-AGGREGATE-COUNTS", "sunday-dinner-196", "What public-safe records and calculations support the 300-plus gathering and 20-plus resident-artist totals?", ["Reconcile the private RSVP and attendance ledger with public-safe aggregate methods.", "Document the residency count methodology and date range.", "Keep identities and attendance rows protected."], ["The protected workbook now directly supports the 300-plus gathering floor through 345 event-specific columns and 340 positive cached yes-count columns across January 2012-March 2021. Numbering irregularities, livestream entries, formulas, plus-ones, and repeated participants bar unique-attendee inference. The separate 20-plus resident-artist methodology remains open."], ["SRC-GHFC-JAMIE-JULIA-QA-2017", "SRC-SUNDAY-DINNER-ATTENDANCE-WORKBOOK-2012-2021"]),
...
export const frameworkProofCoverage = [
  ...
  coverage("wowlist-community-platform", "partially-backed", "A deterministic protected database run directly supports the July 2017 scale: 1,846 users, 16,142 posts or events, and 35 city or region labels with at least 50 geocoded posts or events. Public and protected sources also support product function, Jamie's co-organizer role, member-led calendars, and bounded publishing work. Independent public coverage of the full geographic-adoption interpretation and complete technical and collaborator history remains useful proof depth.", ["SRC-WOWLIST-DATABASE-AGGREGATE-RUN-2017-2026", "SRC-GHFC-JAMIE-JULIA-QA-2017", "SRC-X-MUSIC-HACKATHON-URBANHERMIT-WOWLIST-2015", "SRC-FB-WOWLIST-NINE-CITY-CALENDARS-2015", "SRC-FB-WOWLIST-LA-FORTY-ONE-EVENTS-2015", "SRC-FB-WOWLIST-PHXDIY-CONTINUITY-2018", "SRC-FB-WOWLIST-PUBLISHER-ATTRIBUTION-RUN-2026"], ["INQ-WOWLIST-PUBLIC-SOURCE-COVERAGE", "INQ-WOWLIST-FACEBOOK-FULL-POPULATION-2026"]),
  coverage("sunday-dinner-196-participation-infrastructure", "partially-backed", "A protected workbook now directly supports the 300-plus gathering lane through 345 event-specific columns, 340 with positive cached yes counts, across January 2012-March 2021. Public sources confirm the weekly open practice and selected dated formats; a protected 2023 record confirms one residency workflow. The separate 20-plus resident-artist aggregate remains open and no workbook count is converted into unique attendees.", ["SRC-SUNDAY-DINNER-ATTENDANCE-WORKBOOK-2012-2021", "SRC-GHFC-JAMIE-JULIA-QA-2017", "SRC-JAMIE-FACEBOOK-EVENT-SUNDAY-DINNER-100-2014", "SRC-JAMIE-FACEBOOK-EVENT-SUNDAY-DINNER-NYC-2014", "SRC-JAMIE-FACEBOOK-EVENT-WHY-I-MARCH-2017", "SRC-GDRIVE-196-RESIDENCY-ACCEPTANCE-2023"], ["INQ-SUNDAY-DINNER-AGGREGATE-COUNTS", "INQ-JAMIE-FACEBOOK-HOSTED-EVENTS-2026"]),
