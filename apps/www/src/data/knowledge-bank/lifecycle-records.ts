...
export const lifecycleProjectionDecisions = [
  ...
  { id: "DEC-DEFER-HJE-GROWTH", claimId: "CLM-HJE-REVENUE-GROWTH-CONTRIBUTION", surface: "/work/harry-j-epstein", decision: "defer", rationale: "The numerical contribution claim remains recoverable but is removed from the website until a same-basis comparison and authorized contribution confirmation meet the research acceptance rule.", decidedAt: "2026-07-14", reviewedBy: ["Codex archive review", "Independent lifecycle judge"] },
