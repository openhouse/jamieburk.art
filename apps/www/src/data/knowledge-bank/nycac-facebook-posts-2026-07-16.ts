...
export const nycacFacebookPostSourceIds = {
  ...
  stewardshipMemory: "SRC-NYCAC-FACEBOOK-STEWARDSHIP-MEMORY-2026",
...
export const nycacFacebookPostClaimIds = {
  ...
  stewardshipMemory: "CLM-NYCAC-FACEBOOK-STEWARDSHIP-MEMORY-2026",
} as const;
...
export const nycacFacebookPostSourceRecords20260716 = [
  {
  ...
  {
    id: nycacFacebookPostSourceIds.stewardshipMemory,
    title: "Jamie Burkart memory of NYC Artist Coalition Facebook stewardship",
    ...
    publicCitation:
      "Jamie Burkart, first-person memory about NYC Artist Coalition Facebook stewardship, captured July 16, 2026.",
    publicNote:
      "Jamie recalls predominantly using the shared Page while believing other collaborators used it as well. The memory remains a research lead rather than post-level attribution.",
    protectedLocatorId: "LOC-NYCAC-FACEBOOK-STEWARDSHIP-MEMORY-2026",
    supportsGenerally: [
      "Jamie's present recollection that he predominantly used the Page",
      "Jamie's recollection that other collaborators also used the Page",
    ],
    doesNotEstablish: [
      "post-level human authorship",
      "a quantitative share of Page publishing",
      "sole administration or sole campaign leadership",
...
export const nycacFacebookPostClaimRecords20260716 = [
  {
    ...
    evidence: [
      ...
      },
      {
        ...
        locator:
          "five annual Published exports, private post-identity crosswalk, and terminal Page-feed traversal",
        confidence: "high",
        renderCitation: false,
      },
    ],
  ...
  },
  {
    ...
    evidence: [
      ...
      },
      {
        ...
        locator:
          "paragraphs describing the October 2018 M.A.R.C.H. inspection and public protest by the coalition, Hell's Kitchen Democrats, Stephen Levin, and Rafael Espinal",
        confidence: "high",
        renderCitation: false,
      },
      {
        ...
        locator:
          "headline, publication metadata, and paragraphs naming the March 30 Let NYC Dance event and partnership",
        confidence: "high",
        renderCitation: false,
      },
      {
        sourceId: nycacFacebookPostSourceIds.fox5,
        relationship: "context",
        supports: [
          "the first Office of Nightlife public event",
          "rent, noise, and city-bureaucracy concerns raised by nightlife participants",
        ],
        locator:
          "article headline and paragraphs naming the event, venue, participants, and concerns",
        confidence: "high",
        renderCitation: false,
      },
      {
        ...
        locator:
          "owner-export Page identity, authenticated management surface, and absence of a population-wide historical human-author field",
        confidence: "moderate",
        renderCitation: false,
      },
    ],
  ...
  {
    id: nycacFacebookPostClaimIds.stewardshipMemory,
    project,
    internalClaim:
      "Jamie remembers predominantly using the NYC Artist Coalition Facebook Page while believing other collaborators also used it.",
    status: "use-with-care",
    projections: [
      {
        key: "archive-note",
        text:
          "Jamie's present memory of predominant Page stewardship remains a protected research lead pending collaborator or native-record corroboration.",
        status: "hold",
        citationRequired: false,
        surfaces: [],
      },
    ...
    evidence: [
      {
        sourceId: nycacFacebookPostSourceIds.stewardshipMemory,
        relationship: "direct-support",
        supports: ["Jamie's present first-person recollection"],
        locator: "Dated first-person statement supplied July 16, 2026",
        confidence: "moderate",
        renderCitation: false,
      },
      {
        ...
        relationship: "supports-boundary",
        supports: [
          "the owner exports do not expose a population-wide historical human-author field",
          "current Page custody does not establish historical exclusivity",
        ],
        confidence: "high",
        renderCitation: false,
    ...
    boundaries: [
      "Treat the statement as Jamie's memory, not independent corroboration.",
      "Do not assign every shared-account post to Jamie.",
      "Retain collective credit and the possibility of changing Page stewardship.",
    ],
    antiClaims: [
      "Jamie authored all 444 exported posts",
      "Jamie was the only Page administrator",
      "current access proves historical authorship",
    ],
    researchInquiryIds: ["INQ-NYCAC-FACEBOOK-STEWARDSHIP-2026"],
    reviewedAt,
    reviewedBy: ["Jamie Burkart", "Codex authenticated archival review"],
  },
] satisfies ClaimRecord[];

export const nycacFacebookPostResearchInquiries20260716 = [
  {
    ...
    sourceIds: [
      ...
      "SRC-PRESS-GOTHAMIST-MARCH-RAIDS-2019",
      "SRC-PRESS-BEDFORD-MARCH-RAIDS-2019",
      "SRC-PRESS-NYTIMES-BOOGIE-2017",
  ...
  {
    id: "INQ-NYCAC-FACEBOOK-STEWARDSHIP-2026",
    project,
    question:
      "What collaborator testimony or native records can corroborate Jamie's memory of predominant NYC Artist Coalition Facebook Page stewardship?",
    methods: [
      "Captured Jamie's first-person memory as a protected research lead.",
      "Kept current custody, historical administration, post-level publishing, and campaign leadership separate.",
      "Reviewed the five owner exports for population controls without treating the shared Page identity as a human byline.",
    ],
    runAt: reviewedAt,
    resultStatus: "partially-recovered",
    findings: [
      "Jamie's present recollection is preserved.",
      "The owner export establishes 444 shared-Page records but not the historical human publisher of every row.",
      "The role claim remains held pending collaborator testimony or a durable native author field.",
    ],
    limitations: [
      "First-person memory is not independent corroboration.",
      "Current Page management access does not establish historical exclusivity.",
      "The shared Page identity must not be converted into post-level authorship.",
    ],
    sourceIds: [
      nycacFacebookPostSourceIds.stewardshipMemory,
      nycacFacebookPostSourceIds.protectedRun,
    ],
    protectedLocatorId: "LOC-NYCAC-FACEBOOK-STEWARDSHIP-INQUIRY-2026",
  },
] satisfies ResearchInquiry[];

export const nycacFacebookPostIntakeRecords20260716 = [
  {
    id: "INTAKE-NYCAC-FACEBOOK-POSTS-FULL-POPULATION-2026",
    capturedAt: reviewedAt,
    capturedBy: "Jamie Burkart and Codex authenticated archival review",
    kind: "engagement-lead",
    title: "Complete surviving NYC Artist Coalition Facebook Page post population",
    publicSafeSummary:
      "Five annual owner exports contain 444 Published records and 444 unique post IDs spanning 2017-2021, with a 67-route public-safe source inventory and bounded mission, stakeholder-reference, and metric summaries.",
    whyItMatters:
      "Preserves the Page as collective communications and source-routing infrastructure while keeping source circulation, incoming engagement, authorship, traction, and public projection distinct.",
    ...
    canonicalUrl: "https://www.facebook.com/nycartc/",
    sourceIds: nycacFacebookPostSourceRecords20260716
      .filter(({ id }) => id !== nycacFacebookPostSourceIds.stewardshipMemory)
      .map(({ id }) => id),
    claimIds: [
      nycacFacebookPostClaimIds.operatingRecord,
      nycacFacebookPostClaimIds.civicRelay,
      nycacFacebookPostClaimIds.metrics,
    ],
    inquiryIds: ["INQ-NYCAC-FACEBOOK-POST-POPULATION-2026"],
    limitations: [
      "Complete means every row Meta retained and returned through the annual Published exports, not every post ever created.",
      "Raw posts, post IDs, comments, engager identities, authenticated routes, and two sensitive routes remain outside the repository.",
      "Page-authored stakeholder references are not incoming engagement, endorsement, partnership, mandate, or policy impact.",
    ],
    nextActions: [
      "Close-read and preserve the 56 inventory-only routes when they can mature an atomic claim.",
      "Research incoming stakeholder engagement only from attributable public records.",
      "Version future owner exports so platform retention and metric drift remain visible.",
    ],
  },
  {
    id: "INTAKE-NYCAC-FACEBOOK-STEWARDSHIP-MEMORY-2026",
    capturedAt: reviewedAt,
    capturedBy: "Jamie Burkart and Codex",
    kind: "memory",
    title: "Jamie's memory of predominant NYC Artist Coalition Facebook stewardship",
    publicSafeSummary:
      "Jamie recalls predominantly using the shared Page while believing other collaborators also used it.",
    whyItMatters:
      "The memory may clarify Jamie's operating role, but it requires corroboration and cannot erase collective credit or imply population-wide authorship.",
    projectHints: [project],
    maturity: "captured",
    publicUse: "protected",
    editorialState: "unsurfaced",
    disposition: "research-inquiry-created",
    sourceIds: [nycacFacebookPostSourceIds.stewardshipMemory],
    claimIds: [nycacFacebookPostClaimIds.stewardshipMemory],
    inquiryIds: ["INQ-NYCAC-FACEBOOK-STEWARDSHIP-2026"],
    limitations: [
      "First-person memory is not independent corroboration.",
      "Current management access does not assign every historical Page post to Jamie.",
      "Other collaborators' use of the Page remains part of the record.",
    ],
    nextActions: [
      "Invite bounded collaborator testimony about Page stewardship and campaign-specific publishing.",
      "Look for durable native author fields without publishing private account data.",
