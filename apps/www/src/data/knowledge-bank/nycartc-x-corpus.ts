...
export const nycartcXCorpusIntakeItems = [{
  ...
  claimIds: [
    ...
    "CLM-NAC-X-REPOST-SOURCE-PATTERN",
...
export const nycartcXCorpusSources: KnowledgeBank["sources"] = [
  {
    ...
    metadataVerifiedBy: "Codex authenticated public-web archival review",
...
export const nycartcXCorpusObservations = [
  {
  ...
  {
    id: "OBS-NAC-X-REPOST-SOURCE-PATTERN",
    sourceId: "SRC-NAC-X-CORPUS-2026-07-15",
    project: "nyc-artist-coalition",
    text: "Recovered native reposts most frequently sourced Olympia Kazi (194), United for Small Business NYC (113), Future of Music Coalition (110), Street Vendor Project (91), Music Workers Alliance (89), Artist Studio Affordability Project (78), Indie Theater Fund (64), and Rafael Espinal (47). These are lower-bound source-circulation counts, not evidence that any person authored coalition posts or endorsed every coalition position.",
    locator: "Corpus stakeholderCommunication recoveredRepostSourceCounts",
    status: "verified",
    confidence: "high",
    claimIds: ["CLM-NAC-X-REPOST-SOURCE-PATTERN"],
    researchInquiryIds: ["INQ-NAC-X-FULL-POPULATION-2026"],
    reviewedAt: "2026-07-15",
    reviewedBy
  },
...
export const nycartcXCorpusClaims: KnowledgeBank["claims"] = [
  ...
  {
    id: "CLM-NAC-X-REPOST-SOURCE-PATTERN",
    project: "nyc-artist-coalition",
    internalClaim: "The recovered native-repost network repeatedly circulated work from coalition collaborators and mission-adjacent arts, labor, tenant, vendor, and government accounts; Olympia Kazi was the largest recovered repost source with 194 items.",
    status: "confirmed-with-boundary",
    projections: [{ key: "archive-note", text: "Recovered native reposts repeatedly circulated work from Olympia Kazi and arts, labor, tenant, vendor, and government accounts; the source counts remain lower bounds and do not establish account authorship or endorsement.", status: "hold", citationRequired: true, surfaces: [] }],
    evidence: [{ sourceId: "SRC-NAC-X-CORPUS-2026-07-15", relationship: "direct-support", supports: ["recovered native-repost source handles", "lower-bound source counts", "stakeholder-network pattern"], confidence: "high", renderCitation: false }],
    boundaries: ["Historical search did not expose every older native repost, so source counts are recovery lower bounds.", "The account was shared; repost-source counts do not identify who selected or published each repost.", "A repost documents circulation, not endorsement, formal partnership, reach, or policy effect."],
    antiClaims: ["Olympia Kazi authored 194 coalition posts", "Jamie authored every repost", "Every repost source endorsed every coalition position", "The recovered source ranking is a complete lifetime ranking"],
    researchInquiryIds: ["INQ-NAC-X-FULL-POPULATION-2026"],
    reviewedAt: "2026-07-15",
    reviewedBy
  },
...
export const nycartcXCorpusResearchInquiries: KnowledgeBank["researchInquiries"] = [{
  ...
  findings: [
    ...
    "Recovered repost sources show sustained circulation across collaborators and mission-adjacent groups; Olympia Kazi is the largest recovered source with 194 items, a lower bound rather than an authorship or endorsement claim.",
