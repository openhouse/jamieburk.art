...
export const socialMediaArchiveClaims: ClaimRecord[] = [
  ...
  },
  {
    ...
    internalClaim: "The complete 183-record @KCTownHall population shows the institutional account operating as a resident-input, recurring service-intake, civic-information, and stakeholder-response surface; it includes 100 tire-related records, 12 survey-linked records, direct responses from three sitting Council-member accounts and KCMO 311, and external tire-dropoff corroboration from a Bridging the Gap collaborator.",
    status: "confirmed-with-boundary",
    projections: [{ key: "case-study", text: "A complete 183-record archive shows the public account operating as project infrastructure: 100 records documented recurring household tire-pickup work and 12 linked the neighborhood survey. Direct responses came from three sitting Council-member accounts and KCMO 311; a Bridging the Gap collaborator independently reported receiving a substantial KC Town Hall tire drop-off.", status: "active", citationRequired: true, surfaces: ["/work/kc-town-hall"], rationale: "Use exact population, operating-pattern, and bounded stakeholder evidence to make the project's public operations legible without assigning every account post or program outcome to Jamie." }],
    evidence: [
...
export const socialMediaArchiveInquiries: ResearchInquiry[] = [
  ...
  },
  {
    ...
    sourceIds: ["SRC-KCTH-X-PROFILE-2026", "SRC-KCTH-X-CORPUS-2026-07-15", "SRC-KCTH-MISSION-2018", "SRC-KCTH-SURVEY-2018", "SRC-KCTH-TIRES-LAUNCH-2019", "SRC-KCTH-ROBINSON-REPLY-2020", "SRC-KCTH-JUSTUS-REPLY-2019", "SRC-KCTH-LUCAS-QUOTE-2019", "SRC-KCTH-KCMO311-REPLY-2018", "SRC-KCTH-BRIDGING-GAP-DROPOFF-2019"],
