...
export const socialMediaArchiveSources: SourceRecord[] = [
  ...
  profileSource("SRC-KCTH-X-PROFILE-2026", "KC Town Hall (@KCTownHall)", "KC Town Hall", "https://x.com/KCTownHall", "The profile reported 183 posts, 132 followers, and 225 following. A complete Posts-and-Replies reconciliation recovered all 183 profile-reported records.", ["dedicated project identity", "joined March 2018", "complete profile-reported population on the capture date"]),
...
export const socialMediaArchiveClaims: ClaimRecord[] = [
  ...
  },
  {
    ...
    internalClaim: "The complete 183-record profile-reported @KCTownHall population on the capture date shows the institutional account operating as a resident-input, recurring service-intake, civic-information, and stakeholder-response surface; it includes 100 tire-related records, 12 survey-linked records, direct responses from three then-serving Council-member accounts and KCMO 311, and external tire-dropoff corroboration from a Bridging the Gap collaborator.",
    status: "confirmed-with-boundary",
    projections: [{ key: "case-study", text: "A complete review of all 183 records reported by the profile on the capture date shows the public account operating as project infrastructure: 100 records documented recurring household tire-pickup work and 12 linked the neighborhood survey. Direct responses came from three then-serving Council-member accounts and KCMO 311; a Bridging the Gap collaborator independently reported receiving a KC Town Hall tire drop-off.", status: "active", citationRequired: true, surfaces: ["/work/kc-town-hall"], rationale: "Use exact population, operating-pattern, and bounded stakeholder evidence to make the project's public operations legible without assigning every account post or program outcome to Jamie." }],
    evidence: [
      { sourceId: "SRC-KCTH-X-CORPUS-2026-07-15", relationship: "direct-support", supports: ["complete 183-record population", "100 tire-related records", "12 survey-linked records", "strict stakeholder-response inventory", "public-safety method"], confidence: "high", renderCitation: true },
      { sourceId: "SRC-KCTH-X-ACQUISITION-LEDGER-2026-07-15", relationship: "corroborating", supports: ["redacted route-level acquisition provenance", "independent 183-ID reconciliation input"], confidence: "high", renderCitation: false },
      { sourceId: "SRC-KCTH-KCMO-COUNCIL-ROSTER-2019", relationship: "corroborating", supports: ["Quinton Lucas and Jolie Justus were serving on the Council on the interaction date"], confidence: "high", renderCitation: true },
      { sourceId: "SRC-KCTH-KCMO-ROBINSON-SERVICE-2020", relationship: "corroborating", supports: ["Melissa Robinson was serving on the Council on the interaction date"], confidence: "high", renderCitation: true },
      { sourceId: "SRC-KCTH-MISSION-2018", relationship: "direct-support", supports: ["neighborhood resource and cultural-center purpose"], confidence: "high", renderCitation: false },
      { sourceId: "SRC-KCTH-SURVEY-2018", relationship: "direct-support", supports: ["public resident-input invitation"], confidence: "high", renderCitation: false },
      ...
      ...["SRC-KCTH-ROBINSON-REPLY-2020", "SRC-KCTH-JUSTUS-REPLY-2019", "SRC-KCTH-LUCAS-QUOTE-2019", "SRC-KCTH-KCMO311-REPLY-2018"].map((sourceId) => ({ sourceId, relationship: "corroborating" as const, supports: ["one visible incoming public interaction"], confidence: "high" as const, renderCitation: true })),
      { sourceId: "SRC-KCTH-BRIDGING-GAP-DROPOFF-2019", relationship: "corroborating", supports: ["one externally reported tire drop-off"], confidence: "high", renderCitation: true },
      ...["SRC-KCTH-OAK-PARK-AMPLIFICATION-2019", "SRC-KCTH-OAK-PARK-AMPLIFICATION-TRUTHERESME-2019"].map((sourceId) => ({ sourceId, relationship: "context" as const, supports: ["one observable community amplification of a cleanup notice"], confidence: "high" as const, renderCitation: false }))
    ],
    boundaries: ["Do not publish historical phone numbers, pickup addresses, or raw post text.", "Do not assign every account post or later operation to Jamie.", "One hundred tire-related records measure publishing and operating continuity, not tire quantities, households served, or independently audited savings.", "Public dialogue does not establish project completion, policy causation, blanket endorsement, or independently verified program totals."],
    antiClaims: ["Jamie authored every @KCTownHall post", "every tagged official engaged", "three Council members endorsed KC Town Hall", "267 people engaged", "the social archive proves the redevelopment was completed or caused government action"],
    researchInquiryIds: ["INQ-KCTH-SOCIAL-ARCHIVE", "INQ-KCTH-X-TIRE-TOTALS-CORROBORATION", "INQ-KCTH-X-SURVEY-DECISION-TRAIL", "INQ-KCTH-X-POSTED-URL-TRIAGE"],
    reviewedAt,
    reviewedBy
  },
  {
...
export const socialMediaArchiveInquiries: ResearchInquiry[] = [
  ...
  },
  {
    ...
    methods: ["Traversed authenticated Posts and Replies timelines through repeated no-growth states.", "Separated 183 primary account records from five conversation-context cards by other accounts.", "Classified all primary records by authorship type, posted links, tire and survey patterns, and dated visible interaction.", "Counted only direct replies, quote responses, and explicit collaborator reports as incoming engagement.", "Excluded post text, historical phone numbers, pickup addresses, authentication identity, and private account state from the public fixture."],
    runAt: reviewedAt,
    resultStatus: "recovered",
    findings: ["All 183 profile-reported records materialized and were reviewed: 142 original posts, 13 replies, and 28 reposts.", "One hundred records are tire-related and document recurring household pickup communication from 2019 through 2022; 12 records link the neighborhood survey.", "The complete record preserves direct mission-relevant responses from three sitting Council-member accounts, KCMO 311, and an external tire-dropoff report from a Bridging the Gap collaborator.", "The account circulated 133 external-link occurrences across 118 records, including food-access, housing, election, transit, voter, public-health, emergency-resource, and cleanup sources.", "Visible interaction appeared on 77 account-authored records, but dated totals remain held from accomplishment messaging."],
    limitations: ["The institutional account does not identify the individual author of every post.", "The public corpus cannot recover deleted, private, liked, or platform-suppressed activity.", "Public dialogue does not prove service resolution, independently audited totals, project completion, endorsement, or policy causation."],
    sourceIds: ["SRC-KCTH-X-PROFILE-2026", "SRC-KCTH-X-CORPUS-2026-07-15", "SRC-KCTH-KCMO-COUNCIL-ROSTER-2019", "SRC-KCTH-KCMO-ROBINSON-SERVICE-2020", "SRC-KCTH-MISSION-2018", "SRC-KCTH-SURVEY-2018", "SRC-KCTH-TIRES-LAUNCH-2019", "SRC-KCTH-ROBINSON-REPLY-2020", "SRC-KCTH-JUSTUS-REPLY-2019", "SRC-KCTH-LUCAS-QUOTE-2019", "SRC-KCTH-KCMO311-REPLY-2018", "SRC-KCTH-BRIDGING-GAP-DROPOFF-2019"],
    publicSummary: "All 183 profile-reported records were reviewed. They show the institutional account operating as a resident-input, recurring service-intake, civic-information, and stakeholder-response surface, with individual authorship and independently audited outcomes kept behind explicit evidence gates."
  },
  {
...
export const socialMediaArchiveIntake = [
  ...
  { id: "INT-KCTH-SOCIAL-ARCHIVE-2026", receivedAt: reviewedAt, kind: "public-artifact", visibility: "public-safe", title: "KC Town Hall public-operations archive", description: "Complete 183-record profile review preserves neighborhood listening, recurring service communication, civic-source circulation, and direct stakeholder dialogue.", whyItMatters: "Shows that the project account functioned as operational infrastructure for resident participation, recurring household-service intake, and public-service coordination.", projectIds: ["kc-town-hall"], status: "matured", disposition: "claim-created", dispositionNote: "Promoted as a bounded case-study claim with phone, address, post-text, authorship, completion, endorsement, and outcome exclusions.", sourceIds: ["SRC-KCTH-X-PROFILE-2026", "SRC-KCTH-X-CORPUS-2026-07-15", "SRC-KCTH-X-ACQUISITION-LEDGER-2026-07-15", "SRC-KCTH-X-POSTED-URL-TRIAGE-2026-07-15", "SRC-KCTH-KCMO-COUNCIL-ROSTER-2019", "SRC-KCTH-KCMO-ROBINSON-SERVICE-2020", "SRC-KCTH-MISSION-2018", "SRC-KCTH-SURVEY-2018", "SRC-KCTH-TIRES-LAUNCH-2019", "SRC-KCTH-ROBINSON-REPLY-2020", "SRC-KCTH-JUSTUS-REPLY-2019", "SRC-KCTH-LUCAS-QUOTE-2019", "SRC-KCTH-KCMO311-REPLY-2018", "SRC-KCTH-BRIDGING-GAP-DROPOFF-2019"], claimIds: ["CLM-KCTH-SOCIAL-PUBLIC-OPERATIONS"], inquiryIds: ["INQ-KCTH-SOCIAL-ARCHIVE", "INQ-KCTH-X-TIRE-TOTALS-CORROBORATION", "INQ-KCTH-X-SURVEY-DECISION-TRAIL", "INQ-KCTH-X-POSTED-URL-TRIAGE"], boundaries: ["Do not publish historical contact details or raw post text.", "Do not infer individual post authorship, independently audited outcomes, endorsement, causality, or project completion."] },
