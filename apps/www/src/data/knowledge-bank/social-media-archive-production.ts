...
export const socialMediaArchiveClaims: ClaimRecord[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      { sourceId: "SRC-KCTH-BRIDGING-GAP-DROPOFF-2019", relationship: "corroborating", supports: ["one externally reported tire drop-off"], confidence: "high", renderCitation: false },
    ...
    researchInquiryIds: ["INQ-KCTH-SOCIAL-ARCHIVE", "INQ-KCTH-X-TIRE-TOTALS-CORROBORATION", "INQ-KCTH-X-SURVEY-DECISION-TRAIL"],
    reviewedAt,
    reviewedBy
  },
  {
