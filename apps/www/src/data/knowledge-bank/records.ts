...
const knowledgeBankInput = {
  sources: [
    ...
    },
    {
      ...
      contentReviewedBy: "Jamie Burkart and Codex article-level archival review",
    ...
    },
    {
      ...
      reviewStatus: "close-read",
      contentReviewedAt: "2026-07-12",
      contentReviewedBy: "Codex repository-history and implementation review",
    ...
    {
      id: "SRC-MATMOS-CONSUMING-FLAME-DISCOGS-2020",
      title: "The Consuming Flame: Open Exercises in Group Form release credits",
      ...
      preferredPublicUrl: "canonical",
      publicCitation: "Discogs release credits for Matmos, 'The Consuming Flame: Open Exercises in Group Form,' 2020.",
      publicNote: "The release record lists Jamie Burkart among the album's many participants. It is a secondary release database, so the specific contribution remains under research.",
      supportsGenerally: ["Jamie Burkart appears in the participant credits", "the collective participant structure of the album"],
      doesNotEstablish: ["Jamie's specific track, instrument, recording, or production contribution", "primary-source confirmation", "the extent or impact of Jamie's contribution"]
    },
    {
      id: "SRC-CLAUDETTE-AR-TECHNICAL-HANDOFF-2022",
      title: "Claudette augmented-reality technical handoff correspondence",
      kind: "project-archive",
      visibility: "protected",
      preservationStatus: "private",
      capturedAt: "2022-08-22",
      accessedAt: "2026-07-16",
      reviewStatus: "close-read",
      contentReviewedAt: "2026-07-16",
      contentReviewedBy: "Codex protected-archive review",
      publicCitation: "Public-safe archival summary of a 2022 Claudette augmented-reality technical handoff.",
      publicNote: "Protected collaborator correspondence documents a working 8th Wall implementation using a GLB scene and seven interactive video triggers, together with a handoff question.",
      protectedLocatorId: "ARCHIVE-CLAUDETTE-AR-HANDOFF-2022-001",
      supportsGenerally: ["a working 8th Wall implementation", "a GLB-based scene", "seven interactive video triggers", "technical handoff and continuity work"],
      doesNotEstablish: ["Jamie's sole implementation authorship", "public launch", "complete exhibition history", "audience or impact totals", "permission to publish private correspondence or implementation routes"]
    },
    {
      id: "SRC-CRS-INSTITUTIONAL-MEMORY-COORDINATION-2026",
      title: "Commercial Rent Stabilization early coordination record",
      kind: "project-archive",
      visibility: "protected",
      preservationStatus: "private",
      ...
      contentReviewedAt: "2026-07-16",
      contentReviewedBy: "Codex protected-archive review",
      publicCitation: "Public-safe archival summary of a 2026 Commercial Rent Stabilization coordination record.",
      publicNote: "A protected coordination record documents collaborators seeking Jamie's historical context, community relationships, and synthesis during early coalition planning, and Jamie describing civic-product patterns that connect legislative data to updates, maps, and next actions.",
      protectedLocatorId: "ARCHIVE-CRS-INSTITUTIONAL-MEMORY-2026-001",
      supportsGenerally: ["collaborators sought Jamie's historical and coalition context", "Jamie articulated a civic-product pattern connecting legislative data, public updates, maps, and next actions", "institutional memory was treated as useful to early coordination"],
      doesNotEstablish: ["Jamie's sole leadership", "adoption or implementation of the described product pattern", "permission to publish participant names, quotations, strategy, or the underlying protected record", "independent validation of impact"]
    },
    {
      ...
      reviewStatus: "close-read",
      contentReviewedAt: "2026-07-16",
      contentReviewedBy: "Jamie Burkart and Codex artifact review",
      publicCitation: "Maven certificate of completion for James Burkart, 'AI Evals For Engineers & PMs.'",
      publicNote: "The certificate directly records completion and names Hamel Husain and Shreya Shankar as instructors. The certificate itself does not display a completion date.",
      protectedLocatorId: "CERT-AI-EVALS-MAVEN-2026-001",
      supportsGenerally: ["James Burkart completed AI Evals For Engineers & PMs", "Hamel Husain and Shreya Shankar are named as instructors", "James Burkart is an established alias for Jamie Burkart in the knowledge bank"],
      doesNotEstablish: ["the completion date", "instructor affiliation", "that Jamie teaches the course", "certification authority beyond the certificate's completion wording"]
    },
    {
      id: "SRC-AI-EVALS-MAVEN-COURSE",
      ...
      preferredPublicUrl: "canonical",
      publicCitation: "Maven, 'AI Evals For Engineers & PMs,' course page.",
      publicNote: "Maven's public page identifies Hamel Husain and Shreya Shankar as instructors and describes an application-centered curriculum built around traces, error analysis, evaluator design, retrieval, regression testing, and human judgment.",
      supportsGenerally: ["the course title", "Hamel Husain and Shreya Shankar as instructors", "the public curriculum context"],
      doesNotEstablish: ["Jamie's enrollment or completion", "Jamie's cohort", "Jamie's performance", "the exact curriculum version Jamie completed"]
    },
    {
    ...
    },
    {
      ...
      reviewStatus: "close-read",
      contentReviewedAt: "2026-07-13",
      contentReviewedBy: "Codex public-archive content review",
    ...
    },
    {
      ...
      reviewStatus: "close-read",
      contentReviewedAt: "2026-07-16",
      contentReviewedBy: "Jamie Burkart approval and Codex PDF-to-site reconciliation",
    ...
    },
    {
      ...
      reviewStatus: "close-read",
      contentReviewedAt: "2026-07-13",
      contentReviewedBy: "Codex public-record page-and-locator review",
    ...
    },
    {
      ...
      reviewStatus: "close-read",
      contentReviewedAt: "2026-07-14",
      contentReviewedBy: "Codex authenticated ordinance and action-history review",
    ...
    },
    {
      ...
      reviewStatus: "close-read",
      contentReviewedAt: "2026-07-14",
      contentReviewedBy: "Codex authenticated resolution and action-history review",
    ...
    },
    {
      ...
      reviewStatus: "close-read",
      contentReviewedAt: "2026-07-14",
      contentReviewedBy: "Codex project-status table review",
    ...
    },
    {
      ...
      reviewStatus: "close-read",
      contentReviewedAt: "2026-07-14",
      contentReviewedBy: "Codex authenticated ordinance and endpoint review",
    ...
    },
    {
      ...
      reviewStatus: "close-read",
      contentReviewedAt: "2026-07-13",
      contentReviewedBy: "Codex public-meeting record review",
  ...
  claims: [
    ...
    {
      id: "CLM-AI-EVALS-COMPLETION-2026",
      project: "ai-evals-professional-development",
      internalClaim: "Jamie completed AI Evals For Engineers & PMs with Hamel Husain and Shreya Shankar through Maven in 2026; the work was professional development in application-centered evaluation practice.",
      status: "confirmed-with-boundary",
      projections: [{ key: "archive-note", text: "Jamie completed AI Evals For Engineers & PMs with Hamel Husain and Shreya Shankar through Maven in 2026.", status: "hold", citationRequired: true, surfaces: [] }],
      evidence: [
        { sourceId: "SRC-AI-EVALS-CERTIFICATE-2026", relationship: "direct-support", supports: ["completion by James Burkart", "the course title", "the named instructors"], locator: "Certificate title, learner name, completion line, and instructor line", confidence: "high", renderCitation: false },
        { sourceId: "SRC-JAMIE-APPROVED-RESUME-2026-07-13", relationship: "corroborating", supports: ["the 2026 completion year", "Jamie's approved public wording", "bounded curriculum topics"], confidence: "high", renderCitation: true },
        { sourceId: "SRC-AI-EVALS-MAVEN-COURSE", relationship: "context", supports: ["the official course title", "the named instructors", "application-centered curriculum context"], confidence: "high", renderCitation: true }
      ],
      boundaries: ["Treat the course as professional development and the certificate as a completion record.", "Do not imply that Jamie teaches the course, is affiliated with the instructors, or holds certification authority beyond the certificate's wording."],
      antiClaims: ["Jamie teaches AI Evals For Engineers & PMs", "Jamie is affiliated with Hamel Husain or Shreya Shankar", "The certificate establishes mastery, employment outcomes, or independent professional certification"],
      researchInquiryIds: [], reviewedAt: "2026-07-16", reviewedBy: ["Jamie Burkart", "Codex artifact and public-source review"]
    },
    {
      ...
      evidence: [
        { sourceId: "SRC-CLAUDETTE-MICHAEL-REES", relationship: "direct-support", supports: ["Jamie's AR collaboration with Michael Rees", "collective source-video production", "the 2017 shoot"], locator: "Project page closing collaboration paragraph", confidence: "high", renderCitation: true },
        { sourceId: "SRC-CLAUDETTE-AR-TECHNICAL-HANDOFF-2022", relationship: "private-support", supports: ["a working 8th Wall implementation", "a GLB-based scene", "seven interactive video triggers", "technical handoff and continuity work"], locator: "Public-safe summary of protected collaborator correspondence", confidence: "high", renderCitation: false }
      ],
      boundaries: ["Credit the collaboration and all named producers.", "The protected handoff supports technical form and continuity, not sole implementation authorship, public launch, or impact.", "Do not infer a complete exhibition history, audience totals, or media-republication rights."],
      ...
      researchInquiryIds: [], reviewedAt: "2026-07-16", reviewedBy: ["Codex public-source and protected-archive review"]
    },
    {
