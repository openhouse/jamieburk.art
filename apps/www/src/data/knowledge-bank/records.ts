...
import { dclaListeningSession } from "./dcla-listening-session-2026-08.ts";
...
const knowledgeBankInput = {
  intakeItems: [
    ...
    ...dclaListeningSession.intakeItems,
  ...
  observations: [
    ...
    ...dclaListeningSession.observations,
  ...
  researchInquiries: [
    ...
    ...dclaListeningSession.researchInquiries,
