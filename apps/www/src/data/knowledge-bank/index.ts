...
import researchInquiriesData from "./research-inquiries.json";
...
export const researchInquiries = researchInquirySchema.array().parse(researchInquiriesData);
export const mediaRecords = mediaRecordSchema.array().parse(mediaData);
...
export const mediaById = new Map(mediaRecords.map((media) => [media.id, media]));
