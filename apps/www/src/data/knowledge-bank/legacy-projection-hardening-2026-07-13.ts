...
export const legacyProjectionReadings = [
  ...
  },
  {
    ...
    propositions: [
      ...
      { id: "PROP-FAIRRENT-RESUME-CAMPAIGN-MEMORY-SCALE", text: "Jamie's public resume reports that he built and stewarded more than 30 pages of shared Commercial Rent Stabilization campaign-memory and coordination infrastructure.", relationToJamie: "direct-role", supportTags: ["fairrent-campaign-memory-scale"], confidence: "moderate", locator: "Selected Impact entry" }
    ],
    limitations: ["The source is Jamie's public resume rather than independent corroboration.", "Underlying business figures remain private and are not presented as audited financial disclosure.", "The resume does not independently corroborate the 20-plus resident-artist or 30-plus campaign-memory aggregates.", "The resume does not establish sole authorship of collective campaign records or policy causation."],
    researchTaskIds: []
  },
  {
