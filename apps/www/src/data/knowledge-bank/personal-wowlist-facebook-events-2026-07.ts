...
export const personalWowListFacebookEventSourceIds = {
...
export const personalWowListFacebookEventIntakeItems: KnowledgeBank["intakeItems"] = [
  {
    "id": "INTAKE-2026-07-15-PERSONAL-WOWLIST-FACEBOOK-EVENT-FULL-POPULATION",
    "receivedAt": "2026-07-15",
    "inputKind": "metric",
    "summary": "Authenticated public-safe archival production across every event-card instance exposed on Jamie Burkart's personal Facebook Past Events index and the WOW List page-owner Events surface.",
    "projectIds": [
      "196-sunday-dinner",
      "wowlist",
    ...
    "nextActions": [
      "Request native Meta owner exports to test the capture-date denominators against lifetime account history.",
      "Corroborate the selected Jamie-attributed event records with independent publications, collaborator accounts, and project archives.",
      "Keep private, merely profile-associated, and unresolved records out of public narrative surfaces."
    ]
  }
];

export const personalWowListFacebookEventSources: KnowledgeBank["sources"] = [
  {
    ...
    "supportsGenerally": [
      "511 capture-date personal-profile event-card instances",
      "502 unique parent events",
      "stable terminal population"
    ],
    "doesNotEstablish": [
      "a native Meta owner export",
      "Jamie's relationship to every displayed event",
      "attendance or unique people",
      "permission to publish private or personal records"
    ]
  },
  {
    "id": "SRC-FACEBOOK-WOWLIST-EVENT-SURFACE-2026",
    ...
    "supportsGenerally": [
      "zero current owner-visible WOW List event cards",
      "capture-date empty Events surface"
    ],
    "doesNotEstablish": [
      "that WOW List never created events",
      "that WOW List never cohosted or shared events",
      "a complete historical page export",
      "individual authorship of page activity"
    ]
  },
  {
    "id": "SRC-FACEBOOK-PERSONAL-WOWLIST-EVENT-CENSUS-2026",
    ...
    "supportsGenerally": [
      "511-row anonymous disposition ledger",
      "21 selected public Jamie-attributed event records",
      "23-event NYCAC census overlap",
      "77 external-URL occurrences",
      "nine mission-relevant source routes",
      "Sunday Dinner 100th and 200th event-page milestones",
      "direct WOW List route from the 200th Sunday Dinner page",
      "selected early participatory-program chronology"
    ],
    "doesNotEstablish": [
      "a complete native Meta export",
      "Jamie's role in profile-associated events without explicit attribution",
      "physical attendance or unique reach",
      "sole event authorship or production",
      "historical nonexistence from an empty current surface"
    ]
  },
  {
    "id": "SRC-FACEBOOK-PERSONAL-WOWLIST-EVENT-PROTECTED-RUN-2026",
    ...
    "supportsGenerally": [
      ...
      "475 recovered detail bodies",
      "33 private-display records withheld",
      "public-safe disposition review"
    ],
    "doesNotEstablish": [
      "permission to publish protected contents",
      "a native Meta owner export",
      "attendance",
      "Jamie's relationship to every card",
      "historical WOW List event completeness"
    ]
  },
  {
    ...
    "supportsGenerally": [
      "public 100th Sunday Dinner event-page milestone",
      "Jamie organizer display for the 100th event"
    ],
    "doesNotEstablish": [
      "an independent audit of 100 gatherings",
      "attendance",
      "sole production",
      "the complete Sunday Dinner history"
    ]
  },
  {
    ...
    "supportsGenerally": [
      "public 200th Sunday Dinner event-page milestone",
      "Julia Fredenburg and Jamie Burkart co-organizer display",
      "direct WOW List route from the 200th Sunday Dinner page"
    ],
    "doesNotEstablish": [
      "an independent audit of 200 gatherings",
      "attendance",
      "sole production by Jamie",
      "the complete Sunday Dinner history"
    ]
  },
  {
    "id": "SRC-FACEBOOK-RAFT-LAUNCH-2007",
    ...
    "supportsGenerally": [
      "Jamie-attributed public raft send-off",
      "found-material raft and bicycle-powered paddle-wheel description"
    ],
    "doesNotEstablish": [
      "the voyage's full route or completion",
      "attendance",
      "sole project authorship",
      "permission to publish private construction records"
    ]
  },
  {
    "id": "SRC-FACEBOOK-MICROPOP-2007",
    ...
    "supportsGenerally": [
      "Jamie-attributed scene-theory gathering",
      "public imagined-community and Kansas City DIY source routes"
    ],
    "doesNotEstablish": [
      "participant consensus with the reflection",
      "attendance",
      "a complete theory of WOW List",
      "sole authorship of every performance"
    ]
  },
  {
    "id": "SRC-FACEBOOK-SEMANTIC-WEB-2006",
    ...
    "supportsGenerally": [
      "Jamie-attributed 2006 Semantic Web event",
      "public Semantic Web standards discussion"
    ],
    "doesNotEstablish": [
      "implementation of a Semantic Web standard",
      "attendance",
      "endorsement by every performer",
      "a complete technical project history"
    ]
  }
];

export const personalWowListFacebookEventObservations: KnowledgeBank["observations"] = [
  {
  ...
  },
  {
    ...
    "sourceId": "SRC-FACEBOOK-RAFT-LAUNCH-2007",
...
export const personalWowListFacebookEventClaims: KnowledgeBank["claims"] = [
  {
    "id": "CLM-FACEBOOK-PERSONAL-WOWLIST-EVENT-POPULATION",
    "project": "196-sunday-dinner",
    ...
    "projections": [
      {
        "key": "archive-note",
        "text": "The public-safe census accounts for all 511 personal-profile event-card instances and the empty current WOW List owner Events surface without publishing private or merely personal records.",
        "status": "active",
        "citationRequired": true,
        "surfaces": [
          "docs/knowledge-bank/projects/personal-wowlist-facebook-events"
        ]
      }
    ],
    "evidence": [
      {
        "sourceId": "SRC-FACEBOOK-PERSONAL-EVENT-SURFACE-2026",
      ...
      },
      {
        ...
        "locator": "surfaces and populationLedger",
        "confidence": "high",
        "renderCitation": true
      }
    ],
    "boundaries": [
      "Complete means complete capture-date surface accounting, not a complete lifetime or native owner archive.",
      "Profile association does not establish Jamie's relationship to an event.",
      "Zero current WOW List event cards does not establish historical nonexistence.",
      "Private and personal rows remain anonymous."
    ],
    "antiClaims": [
      "Jamie organized 511 events",
      "Jamie attended 511 events",
      "The personal profile is a complete lifetime archive",
      "WOW List never had Facebook events",
      "Every displayed event is a Jamie project"
    ],
    "researchInquiryIds": [
      "INQ-FACEBOOK-PERSONAL-EVENT-OWNER-EXPORT",
      "INQ-FACEBOOK-WOWLIST-HISTORICAL-EVENT-EXPORT"
  ...
  {
    "id": "CLM-FACEBOOK-JAMIE-CONVENING-PRACTICE",
    "project": "196-sunday-dinner",
    ...
    "projections": [
      {
        "key": "archive-note",
        "text": "Twenty-one recovered public event pages spanning 2006-2019 explicitly name Jamie as organizer or co-organizer, preserving a long arc of participatory programs, community meals, music networks, waterways work, cultural-space safety, and civic participation.",
        "status": "active",
        "citationRequired": true,
        "surfaces": [
          "docs/knowledge-bank/projects/personal-wowlist-facebook-events"
    ...
    "boundaries": [
      "Use event-page organizer or co-organizer attribution; do not convert it into sole authorship or sole production.",
      "Do not infer Jamie's role from the other 490 personal-profile cards.",
      "Do not treat response labels as attendance or reach.",
      "Use independent sources for project outcomes."
    ],
    "antiClaims": [
      "Jamie alone produced all 21 events",
      "Jamie organized every event on his profile",
      "The selected records prove attendance",
      "Facebook response labels prove impact",
      "The list is a complete account of Jamie's event work"
    ],
    "researchInquiryIds": [
      "INQ-FACEBOOK-PERSONAL-EVENT-CORROBORATION"
    ],
  ...
  {
    "id": "CLM-FACEBOOK-SUNDAY-DINNER-MILESTONES",
    "project": "196-sunday-dinner",
    ...
    "projections": [
      {
        "key": "case-study",
        "text": "Public event pages preserve a 100th Sunday Dinner milestone in 2014, naming Jamie as organizer, and a 200th in 2016, naming Julia Fredenburg and Jamie as co-organizers. The numbered titles are contemporaneous records, not an independent audit of every gathering.",
        "status": "active",
        "citationRequired": true,
        "surfaces": [
    ...
    "boundaries": [
      "Treat 100th and 200th as contemporaneous event-page milestone titles, not independently audited totals.",
      "Preserve Julia Fredenburg's co-organizer credit on the 200th event.",
      "Do not infer attendance or continuous weekly frequency from the two pages.",
      "The pages do not independently verify the current 300-plus aggregate claim."
    ],
    "antiClaims": [
      "Facebook independently audited 200 Sunday Dinners",
      "Jamie solely produced both milestones",
      "The pages prove 300-plus gatherings",
      "The response labels are attendance",
      "Every Sunday Dinner had the same format"
    ],
    "researchInquiryIds": [
      "INQ-FACEBOOK-PERSONAL-EVENT-CORROBORATION"
    ],
  ...
  {
    "id": "CLM-FACEBOOK-WOWLIST-IN-PRACTICE",
    "project": "wowlist",
    ...
    "projections": [
      {
        "key": "case-study",
        "text": "A public 2016 event page for the 200th Sunday Dinner links directly to its WOW List event page, preserving one concrete route from the recurring gathering into the community-calendar platform.",
        "status": "active",
        "citationRequired": true,
        "surfaces": [
          "/work/wowlist"
    ...
    "evidence": [
      ...
      },
      {
        ...
        "locator": "missionRelevantSourceRoutes",
        "confidence": "high",
        "renderCitation": true
      }
    ],
    "boundaries": [
      "This is one documented route, not a complete adoption or traffic census.",
      "The historical WOW List page may no longer resolve.",
      "The event-page link does not establish who entered the event into WOW List.",
      "Keep platform and Sunday Dinner credit shared."
    ],
    "antiClaims": [
      "Every Sunday Dinner used WOW List",
      "The link proves platform-wide adoption",
      "Jamie alone created the event record",
      "The current WOW List Facebook page proves the product had no events",
      "The link establishes traffic or conversion"
    ],
    "researchInquiryIds": [
      "INQ-FACEBOOK-WOWLIST-HISTORICAL-EVENT-EXPORT",
      "INQ-FACEBOOK-PERSONAL-EVENT-CORROBORATION"
  ...
  {
    "id": "CLM-FACEBOOK-EARLY-PARTICIPATORY-PRACTICE",
    "project": "waterways-and-participatory-art",
    ...
    "projections": [
      {
        "key": "archive-note",
        "text": "Public event pages from 2006-2010 preserve an early participatory-program arc: a Semantic Web music-and-standards discussion, a trolley-tunnel screening, reflection on distributed music scenes, collaborative raft design and send-off, and a silent group night walk.",
        "status": "active",
        "citationRequired": true,
        "surfaces": [
          "docs/knowledge-bank/projects/personal-wowlist-facebook-events"
    ...
    "evidence": [
      ...
      {
        "sourceId": "SRC-FACEBOOK-MICROPOP-2007",
        "relationship": "direct-support",
        "supports": [
          "Jamie-attributed scene-theory gathering",
          "public imagined-community and Kansas City DIY source routes"
      ...
      {
        "sourceId": "SRC-FACEBOOK-SEMANTIC-WEB-2006",
        "relationship": "direct-support",
        "supports": [
          "Jamie-attributed 2006 Semantic Web event",
          "public Semantic Web standards discussion"
    ...
    "boundaries": [
      "The cross-event arc is an archival synthesis grounded in public invitations.",
      "Event pages do not establish attendance, participant experience, full project outcomes, or sole authorship.",
      "Use independent reporting and project archives to mature individual event claims.",
      "Do not conflate conceptual source links with technical implementation."
    ],
    "antiClaims": [
      "Every invited event occurred exactly as described",
      "Jamie alone authored every project",
      "The raft page proves arrival at the Gulf of Mexico",
      "The Semantic Web event implemented a standard",
...
export const personalWowListFacebookEventResearchInquiries: KnowledgeBank["researchInquiries"] = [
  {
    ...
    "methods": [
      "Repeatedly lazy-scrolled the authenticated personal Events index to a stable 511-card population.",
      "Recovered 475 detail bodies and assigned every row a public-safe disposition.",
      "Separated organizer displays, privacy states, profile association, NYCAC overlap, and detail gaps."
    ],
    "runAt": "2026-07-15",
    "resultStatus": "partially-recovered",
    "findings": [
      "The current index exposes 511 instances representing 502 unique parent events.",
      "Every exposed row has a disposition.",
      "Twenty-one public pages explicitly name Jamie as organizer or co-organizer.",
      "Thirty-six rows remain detail-recovery gaps."
    ],
    "limitations": [
      "No native Meta owner export was available in this pass.",
      "The current surface cannot reveal removed event records.",
      "Private records cannot be published merely because they are visible in an authenticated account.",
      "Profile association does not establish Jamie's event relationship."
    ],
    "sourceIds": [
      "SRC-FACEBOOK-PERSONAL-EVENT-SURFACE-2026",
      "SRC-FACEBOOK-PERSONAL-WOWLIST-EVENT-CENSUS-2026",
  ...
  },
  {
    ...
    "methods": [
      "Checked the current page alias Events route.",
      "Checked the legacy page-ID Events route.",
      "Verified the surface while acting as the WOW List page owner.",
      "Compared the empty current surface with public event pages linking into WOW List."
    ],
    "runAt": "2026-07-15",
    "resultStatus": "inconclusive",
    "findings": [
      "The current owner surface exposes zero event cards.",
      "The surface displays 'No events to show.'",
      "A 2016 Sunday Dinner event page independently preserves a direct WOW List event link."
    ],
    "limitations": [
      "No native WOW List page export was available.",
      "The current surface cannot establish historical nonexistence.",
      "Historical Facebook imports, shares, cohosts, and deleted events remain unrecovered.",
      "The direct WOW List route does not identify who entered the platform record."
    ],
    "sourceIds": [
      "SRC-FACEBOOK-WOWLIST-EVENT-SURFACE-2026",
      "SRC-FACEBOOK-SUNDAY-DINNER-200-2016",
  ...
  },
  {
    ...
    "methods": [
      "Selected only public pages explicitly naming Jamie as organizer or co-organizer.",
      "Created event-level public summaries without addresses or raw social data.",
      "Preserved nine mission-relevant source routes with relationship labels.",
      "Referenced overlapping NYCAC events to the stronger coalition census rather than duplicating stakeholder claims."
    ],
    "runAt": "2026-07-15",
    "resultStatus": "partially-recovered",
    "findings": [
      "The selected pages establish a 2006-2019 public organizer-attribution chronology.",
      "The 100th and 200th Sunday Dinner milestone pages strengthen chronology while preserving counting limits.",
      "The 200th page documents one direct WOW List route.",
      "Early event pages surface research leads for waterways, participatory art, public technology discussion, and distributed cultural scenes."
    ],
    "limitations": [
      "Event pages do not independently establish attendance or outcomes.",
      "Organizer display does not allocate every production task.",
      "Some historical project URLs may no longer resolve.",
      "Independent sources and collaborator consent remain necessary for stronger public projection."
    ],
    "sourceIds": [
      "SRC-FACEBOOK-PERSONAL-WOWLIST-EVENT-CENSUS-2026",
      "SRC-FACEBOOK-SUNDAY-DINNER-100-2014",
