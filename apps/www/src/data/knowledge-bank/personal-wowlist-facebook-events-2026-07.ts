...
export const personalWowListFacebookEventSources =
  personalWowListFacebookEventKnowledge.sources.map((source) => ({
    ...source,
    metadataVerifiedAt: reviewedAt,
    metadataVerifiedBy: "Codex authenticated public-safe archival review"
  })) as KnowledgeBank["sources"];

export const personalWowListFacebookEventClaims =
  personalWowListFacebookEventKnowledge.claims as KnowledgeBank["claims"];

export const personalWowListFacebookEventResearchInquiries =
  personalWowListFacebookEventKnowledge.researchInquiries as KnowledgeBank["researchInquiries"];
