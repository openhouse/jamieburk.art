...
export const nycacFacebookEventKnowledge = {
  ...
  sources: [
    ...
    },
    {
      ...
      publicNote: "Retains 33 event identities, dates, venues, organizer displays, limited response snapshots, topics, source routes, and public-safety dispositions without raw descriptions or participant and access data.",
