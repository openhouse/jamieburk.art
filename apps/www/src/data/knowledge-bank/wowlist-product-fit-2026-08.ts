...
const claims: KnowledgeBank["claims"] = [
  {
    ...
    evidence: [
      ...
      { sourceId: "SRC-PARTICIPATION-CONTINUITY-CONTROLS-2026", relationship: "corroborating", supports: ["bounded production scale and instrumentation"], confidence: "high", renderCitation: true },
