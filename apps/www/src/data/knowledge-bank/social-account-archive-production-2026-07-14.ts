...
export const socialArchiveClaims = [
  {
    ...
    status: "confirmed-with-boundary", maturity: "public-ready", intakeIds: ["INTAKE-NYCARTC-X-ARCHIVE-2026"], requiredSupportTags: ["nycartc-four-social-campaign-streams", "nycartc-olympia-sustained-public-use", "x-profile-nycartc-2026-identity", "nycartc-organizer-role"],
    ...
    boundaries: ["Authenticated search counts are recovered minimums and may change as X indexing changes.", "The record distinguishes collaborators using the identity from authorship of posts on the coalition account."],
