...
export const socialArchiveClaims = [
  ...
  },
  {
    ...
    status: "confirmed-with-boundary", maturity: "projected", intakeIds: ["INTAKE-WOWLIST-X-ARCHIVE-2026", "INTAKE-WOWLIST-FULL-POPULATION-X-CENSUS-2026"], requiredSupportTags: ["wowlist-social-origin", "wowlist-six-public-support-replies", "wowlist-community-adaptation"],
    ...
    projections: [{ key: "case-study", text: "A surviving 2014 post names Richard and Jamie as working on WOW List, while the recovered account record preserves six public replies explaining product use, onboarding, and local-calendar adaptations.", status: "active", citationRequired: true, surfaces: ["/work/wowlist"] }], evidence: [
      { sourceId: "SRC-X-WOWLIST-ORIGIN-2014", relationship: "direct-support", supports: ["Jamie and Richard's project connection to Sunday Dinner calendars"], propositionIds: ["PROP-X-WOWLIST-ORIGIN-2014"], confidence: "high", renderCitation: true },
      { sourceId: "SRC-X-WOWLIST-FULL-POPULATION-CENSUS-2026", relationship: "direct-support", supports: ["the complete six-reply public support and onboarding pattern"], propositionIds: ["PROP-X-WOWLIST-SIX-PUBLIC-SUPPORT-REPLIES"], confidence: "high", renderCitation: true },
      { sourceId: "SRC-X-WOWLIST-SUPPORT-2015", relationship: "direct-support", supports: ["public product-support workflow"], propositionIds: ["PROP-X-WOWLIST-SUPPORT-2015"], confidence: "high", renderCitation: true },
      { sourceId: "SRC-X-WOWLIST-NYCDIY-2016", relationship: "corroborating", supports: ["community-calendar adaptation"], propositionIds: ["PROP-X-WOWLIST-NYCDIY-2016"], confidence: "high", renderCitation: true }
  ...
  },
  {
    ...
    internalClaim: "Jamie supported KC Spaces Fund's behind-the-scenes digital infrastructure while the campaign's public site, fundraiser, X account, and complete surviving observed Facebook Page surface made applications, donations, rolling grants, partner fundraising, and named funding announcements visible.",
    status: "confirmed-with-boundary", maturity: "public-ready", intakeIds: ["INTAKE-KCSPACES-X-ARCHIVE-2026", "INTAKE-KCSPACES-DIGITAL-INFRASTRUCTURE-ARCHIVAL-REVIEW-2026", "INTAKE-KCSPACES-FACEBOOK-POST-CENSUS-2026", "INTAKE-KCSPACES-CAMPAIGN-SITE-2026", "INTAKE-KCSPACES-GOFUNDME-2026", "INTAKE-KCSPACES-ODDITIES-PRINT-FUNDRAISER-2026", "INTAKE-KCSPACES-KANSAS-CITY-STAR-2020"], requiredSupportTags: ["kcspaces-public-fund-operations", "kcspaces-public-grant-announcement", "kcspaces-eleven-grantee-announcements", "kcspaces-jamie-digital-infrastructure", "kcspaces-facebook-population-38", "kcspaces-facebook-readable-19", "kcspaces-facebook-ten-grantee-recognition", "kcspaces-facebook-public-application-route", "kcspaces-facebook-public-funding-announcement", "kcspaces-public-action-pathways", "kcspaces-public-fundraiser-result", "kcspaces-partner-print-fundraiser", "kcspaces-independent-resource-listing"],
    composition: { action: "Supported the campaign's behind-the-scenes web infrastructure while organizers used the public campaign identity to explain and route applications, donations, rolling grants, partner fundraising, and funding announcements.", intendedEnd: "Make emergency relief for grassroots arts and culture spaces understandable and actionable online.", usableResult: "The campaign site exposed donation, application, join, and contact pathways; the GoFundMe records $9,590 raised from 107 donations; the complete surviving observed Facebook surface dispositions 38 records or remnants, including 10 named grantee-recognition records; and an archived Oddities Prints storefront documents a 17-edition partner fundraising route.", audience: "Hiring readers assessing implementation, digital operations, and the project context for Jamie's behind-the-scenes infrastructure work.", collectiveCredit: "Public organizer, fundraiser, grant-making, social-publishing, and print-series credit remains with the campaign's named organizers, fiscal sponsor, account participants, partners, artists, donors, and recipient spaces; Jamie's supported role is technical and operational.", causalBoundary: "The evidence establishes Jamie's digital-infrastructure contribution and the campaign's public operating surfaces separately. It does not show that Jamie raised or allocated funds, authored campaign posts, produced the print series, caused donations, or owned the fundraiser." },
    projections: [], evidence: [
      ...
      { sourceId: "SRC-FACEBOOK-KCSPACES-POST-CENSUS-RUN-2026", relationship: "private-support", supports: ["the complete surviving observed Facebook population", "the readable-message and grantee-recognition pattern"], propositionIds: ["PROP-FACEBOOK-KCSPACES-POPULATION-38", "PROP-FACEBOOK-KCSPACES-READABLE-AND-GRANTEE-PATTERN"], confidence: "high", renderCitation: false },
      { sourceId: "SRC-FACEBOOK-KCSPACES-APPLICATION-DEADLINE-2020", relationship: "direct-support", supports: ["the public Facebook application route"], propositionIds: ["PROP-FACEBOOK-KCSPACES-APPLICATION-ROUTE"], confidence: "high", renderCitation: false },
      { sourceId: "SRC-FACEBOOK-KCSPACES-FIRST-ROUND-2020", relationship: "direct-support", supports: ["public first-round funding communication"], propositionIds: ["PROP-FACEBOOK-KCSPACES-FIRST-ROUND-COMMUNICATION"], confidence: "high", renderCitation: false },
      { sourceId: "SRC-KCSPACES-CAMPAIGN-SITE-2026", relationship: "direct-support", supports: ["the public donation, application, join, and contact pathways"], propositionIds: ["PROP-KCSPACES-CAMPAIGN-SITE-ACTION-PATHWAYS"], confidence: "high", renderCitation: false },
      { sourceId: "SRC-KCSPACES-GOFUNDME-2020", relationship: "direct-support", supports: ["the public fundraiser result"], propositionIds: ["PROP-KCSPACES-GOFUNDME-RESULT"], confidence: "high", renderCitation: false },
      { sourceId: "SRC-KCSPACES-ODDITIES-PRINT-FUNDRAISER-2020", relationship: "corroborating", supports: ["the partner print-fundraising route"], propositionIds: ["PROP-KCSPACES-ODDITIES-SEVENTEEN-PRINTS"], confidence: "high", renderCitation: false },
      { sourceId: "SRC-KANSAS-CITY-STAR-KCSPACES-2020", relationship: "corroborating", supports: ["independent inclusion in a Kansas City COVID-19 help guide"], propositionIds: ["PROP-KANSAS-CITY-STAR-KCSPACES-RESOURCE-LISTING"], confidence: "high", renderCitation: false }
    ], boundaries: ["The social surfaces are public project records, not a complete grant or disbursement ledger.", "The Facebook denominator is the complete surviving observed Page surface, not a native Meta export or deletion history.", "Jamie's digital-infrastructure role must retain the named-organizer, fiscal-sponsor, partner, grantee, and social-authorship boundaries.", "The Kansas City Star listing establishes independent resource-guide visibility, not endorsement, readership, or conversion."], antiClaims: ["Jamie organized the fund or owned the fundraiser.", "Jamie raised or allocated the funds.", "Jamie made grant decisions.", "Jamie authored every social post or administered every account.", "The social record proves fundraising causation, reach, adoption, or impact."], researchInquiryIds: ["INQ-KCSPACES-FACEBOOK-POST-CENSUS-2026"], reviewedAt: "2026-07-14", reviewedBy: ["Codex authenticated social-archive review", "Codex public-source review", "Codex Chad-lens composition review"]
  },
  {
...
export const socialArchiveResearchTasks = [
  ...
  },
  {
    ...
    status: "in-progress", priority: "medium", openedAt: "2026-07-14", intakeIds: ["INTAKE-KCSPACES-X-ARCHIVE-2026", "INTAKE-KCSPACES-DIGITAL-INFRASTRUCTURE-ARCHIVAL-REVIEW-2026", "INTAKE-KCSPACES-FACEBOOK-POST-CENSUS-2026", "INTAKE-KCSPACES-CAMPAIGN-SITE-2026", "INTAKE-KCSPACES-GOFUNDME-2026", "INTAKE-KCSPACES-ODDITIES-PRINT-FUNDRAISER-2026", "INTAKE-KCSPACES-KANSAS-CITY-STAR-2020"], sourceIds: ["SRC-X-REVIEW-KCSPACES-2026", "SRC-X-KCSPACES-LAUNCH-2020", "SRC-X-KCSPACES-ROLLING-GRANTS-2020", "SRC-KCSPACES-DIGITAL-INFRASTRUCTURE-ARCHIVAL-REVIEW-2026", "SRC-FACEBOOK-KCSPACES-POST-CENSUS-RUN-2026", "SRC-FACEBOOK-KCSPACES-APPLICATION-DEADLINE-2020", "SRC-FACEBOOK-KCSPACES-FIRST-ROUND-2020", "SRC-KCSPACES-CAMPAIGN-SITE-2026", "SRC-KCSPACES-GOFUNDME-2020", "SRC-KCSPACES-ODDITIES-PRINT-FUNDRAISER-2020", "SRC-KANSAS-CITY-STAR-KCSPACES-2020"], claimIds: ["CLM-KCSPACES-PUBLIC-GRANT-DOCUMENTATION"],
    nextActions: ["Map the dated public social calls to the campaign-site, theme, widget, and deployment chronology.", "Seek collaborator confirmation of Jamie's web-platform role without shifting organizer or grant-making credit.", "Retain named-organizer, fiscal-sponsor, partner, grantee, and social-authorship boundaries in every public composition."]
  },
  {
