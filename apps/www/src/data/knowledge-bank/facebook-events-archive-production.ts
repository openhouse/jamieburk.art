...
export const nycArtcFacebookEventClaims = [
  ...
  },
  {
    ...
    evidence: [
      ...
      { sourceId: "SRC-NYCARTC-ARCHIVE-PUBLIC-MEETING-PLAYBOOK-2018", relationship: "private-support", supports: ["three-week public-meeting workflow", "partner and elected-official outreach", "testimony, web, print, press, social, video, and day-of coordination"], confidence: "high", renderCitation: false },
      { sourceId: "SRC-NYCARTC-ARCHIVE-TESTIMONY-GUIDE-2017", relationship: "private-support", supports: ["two-minute first-person testimony support", "alternate participation route"], confidence: "high", renderCitation: false }
    ],
    boundaries: ["The public role wording is attributed to Jamie's first-person account; the event and reporting sources establish the collective practice and context, not his exact production share.", "Credit the event practice and outcomes collectively; Jamie's first-person account supports contribution, not sole organization or authorship.", "The protected playbook and testimony guide establish the operating design, not Jamie's authorship or completion of every task.", "Do not attribute every event page, invitation, or facilitation decision to Jamie without event-level production evidence or collaborator confirmation.", "The event record supports a recurring rotating-venue practice, not an uninterrupted monthly schedule in every year.", "Policy outcomes require independent official evidence and collective-work language."],
