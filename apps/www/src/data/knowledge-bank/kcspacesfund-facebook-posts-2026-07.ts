...
export const kcSpacesFundFacebookPostReviewSummary = {
  ...
  exactPublicRoutes: 5,
  previewOnlyOrUnrecoveredRoutes: 3,
  postedSourceArticlesRecovered: 0,
...
export const kcSpacesFundFacebookPostIntakeItems: KnowledgeBank["intakeItems"] = [
  {
    id: "INTAKE-2026-07-15-KCSPACES-FACEBOOK-POST-FULL-POPULATION",
    ...
    nextActions: [
      ...
      "Recover or disposition the three preview-only or historically unrecovered destination routes.",
...
const observation = (
  ...
  reviewers: string[] = ["Codex authenticated public-safe archival review"]
...
export const kcSpacesFundFacebookPostObservations: KnowledgeBank["observations"] = [
  observation(
    "OBS-KCSPACES-FACEBOOK-POST-POPULATION",
    sourceIds.census,
    "Three authenticated terminal traversals recovered 40, 38, and 40 Page records. The final slower traversal reproduced 40 after 24 no-addition passes; the same 21 public media IDs appeared across all three traversals. The resulting 40-row ledger accounts for every surviving public record exposed by the capture-date Page feed from April 7 through July 9, 2020, not deleted, private, unrendered, or owner-export-only history.",
  ...
  observation(
    "OBS-KCSPACES-FACEBOOK-POST-RECOVERY-STATES",
    sourceIds.census,
    "The 40-row ledger contains 20 media-backed and 20 non-media records. Nineteen records retain enough public material for content classification, 15 retain metadata-level depth, and six retain an unavailable-attachment disposition. A remnant is preserved as a remnant rather than converted into a recovered message or a claim that no message existed.",
  ...
  observation(
    "OBS-KCSPACES-FACEBOOK-MISSION-SEQUENCE",
    sourceIds.census,
    "Overlapping record classifications identify ten funded-space spotlights, eight application-routing records, and 13 fundraising records. The named spotlights are Vulpes Bastille, SWAN, Kansas City Textile Arts Center, Parker 2, Farewell Transmission, One Mic Stand, Blackbox on Troost, GetWoke: Queer and Trans People of Color, UN/TUCK Queer & Trans Collective, and Latino Foundation for the Arts.",
  ...
  observation(
    "OBS-KCSPACES-FACEBOOK-ROUTE-INVENTORY",
    sourceIds.census,
    "The surviving population routes people to the campaign site, application guidance, GoFundMe, Oddities Prints, and Farewell Transmission through five exact public destinations. Three additional destination families remain preview-only or historically unrecovered. No source-article route was recovered from the Page population, so the Page functions in this corpus as campaign, application, fundraising, resource, and funded-space communication rather than a press index.",
...
export const kcSpacesFundFacebookPostClaims: KnowledgeBank["claims"] = [
  ...
  },
  {
    ...
    project: "kc-spaces-fund",
    internalClaim: "The surviving Page population documents a mutual-aid operating sequence across campaign and application routes, fundraising, resource amplification, and ten named funded-space spotlights.",
    status: "confirmed-with-boundary",
    projections: [{
      key: "archive-note",
      text: "The surviving Page record routes applications and fundraising and preserves ten funded-space spotlights within a collaborator-led mutual-aid campaign.",
      status: "active",
      citationRequired: false,
      surfaces: ["docs/knowledge-bank/projects/kc-spaces-fund-facebook-posts"]
    }],
    evidence: [
      { sourceId: sourceIds.census, relationship: "direct-support", supports: ["ten spotlight rows", "eight application-routing rows", "13 fundraising rows", "destination inventory"], confidence: "high", renderCitation: false },
    ...
    boundaries: [
      ...
      "No source-article route was recovered from the Page population; independent coverage is governed separately."
    ],
    antiClaims: [
      ...
      "The Page population is a press corpus."
    ],
  ...
  },
  {
    ...
    project: "kc-spaces-fund",
    internalClaim: "The Kansas City Star independently listed KC Spaces Fund as a COVID-era artist-support resource, while an Oddities Prints page independently preserved a product-benefit connection to the campaign.",
    status: "confirmed-with-boundary",
    projections: [{
      key: "archive-note",
    ...
    boundaries: [
      ...
      "Neither source establishes Facebook distribution or post authorship."
    ],
    antiClaims: [
...
export const kcSpacesFundFacebookPostResearchInquiries: KnowledgeBank["researchInquiries"] = [
  ...
  },
  {
    ...
    resultStatus: "partially-recovered",
    findings: [
      "Five exact public destination routes are preserved and three route families remain preview-only or historically unrecovered.",
      "No source-article route was recovered from the Page population.",
    ...
    limitations: [
      "Not recovered is distinct from dead, nonexistent, or never posted.",
    ...
    sourceIds: [sourceIds.census, sourceIds.campaignSite, sourceIds.goFundMe, sourceIds.kansasCityStar, sourceIds.odditiesPrint],
    publicSummary: "The Page is an action and mutual-aid routing record rather than a press index; independent contemporary context is governed separately."
  }
];
