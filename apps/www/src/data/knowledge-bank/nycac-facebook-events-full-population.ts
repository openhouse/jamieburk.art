    ...
    evidence: [
      {
        ...
        locator: "populationReconciliation and manifest control fields",
      ...
      },
      {
        ...
        locator: "authenticated index traversal and replay reconciliation",
    ...
    evidence: [
      {
        ...
        relationship: "private-support",
        locator: "Jamie's July 2026 first-person event-practice account",
      ...
      },
      {
        sourceId: "SRC-NYCAC-FACEBOOK-EVENT-CENSUS-2026",
        relationship: "direct-support",
        locator: "derivedClassifications.recurringCoalitionMeetings and event ledger",
        supports: [
      ...
      },
      {
        ...
        locator: "passages identifying Jamie's fire-code study groups and City Hall advocacy",
        supports: [
      ...
      },
      {
        ...
        relationship: "corroborating",
        locator: "passage identifying Jamie as a founding coalition member",
      ...
      },
      {
        ...
        locator: "Q&A passages on WOW List, community events, and coalition advocacy",
        supports: [
    ...
    evidence: [
      {
        sourceId: "SRC-NYCAC-FACEBOOK-EVENT-CENSUS-2026",
        relationship: "direct-support",
        locator: "aggregateSnapshot response-threshold fields",
    ...
    evidence: [
      {
        sourceId: "SRC-NYCAC-FACEBOOK-EVENT-CENSUS-2026",
        relationship: "direct-support",
        locator: "postedSourceArticles and event outboundResources",
    ...
    evidence: [
      {
        sourceId: "SRC-NYCAC-FACEBOOK-EVENT-CENSUS-2026",
        relationship: "direct-support",
        locator: "event organizer, venueCategory, topic, and detailOrganizerDisplay fields",
        supports: [
    ...
    evidence: [
      {
        sourceId: "SRC-NYCAC-FACEBOOK-EVENT-FIRSTHAND-ROLE-2026",
        relationship: "private-support",
        locator: "Jamie's July 2026 democracy-lab interpretation",
      ...
      },
      {
        sourceId: "SRC-NYCAC-FACEBOOK-EVENT-CENSUS-2026",
        relationship: "context",
        locator: "recurring meeting chronology and stakeholder-interface classifications",
...
export const nycacFacebookEventIntake: IntakeRecord[] = [
  {
    id: "INTAKE-NYCAC-FACEBOOK-EVENTS-FULL-POPULATION-2026",
    capturedAt: reviewedAt,
    ...
    nextActions: [
      "Obtain and privately reconcile a native Meta owner export if the account owner authorizes access.",
      "Invite collaborator review of event-level roles before strengthening production credit.",
      "Close-read routed articles only when they can mature a specific claim or boundary."
    ]
  },
  {
    id: "INTAKE-NYCAC-FACEBOOK-EVENT-PRACTICE-MEMORY-2026",
    capturedAt: reviewedAt,
    capturedBy: "Jamie Burkart and Codex intake review",
    kind: "memory",
    ...
    nextActions: [
      "Invite collaborators and participants to add, correct, or complicate the event-practice account with consent.",
      "Keep democracy-lab and events-as-art interpretations held until an attributed essay or participant-supported account can carry them."
    ]
  }
];
