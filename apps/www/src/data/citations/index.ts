import assetsInput from "./assets.json";
...
export const citationCorrections = correctionsSchema.parse(correctionsInput);
export const citationAssets = assetsSchema.parse(assetsInput);
