...
const workCovers = {
  "harry-j-epstein": {
    ...
    caption: "The maintained public storefront brings discovery, editorial voice, customer guidance, and ordering into one system.",
    credit: "Public website capture, July 2026.",
    kind: "screenshot"
  },
  "fair-rent-nyc": {
    src: portfolioPhotos.saveNYCSpacesTownHall.src,
    width: portfolioPhotos.saveNYCSpacesTownHall.width,
    height: portfolioPhotos.saveNYCSpacesTownHall.height,
    alt: portfolioPhotos.saveNYCSpacesTownHall.alt,
    caption: portfolioPhotos.saveNYCSpacesTownHall.caption,
    credit: portfolioPhotos.saveNYCSpacesTownHall.credit,
    kind: "photograph",
  ...
  wowlist: {
    ...
    caption: "WOW List's current threshold pairs its returning interface with a photographic scene of people gathering.",
