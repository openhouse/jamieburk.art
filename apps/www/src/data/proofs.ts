...
const defensibilitySchema = z.enum([
  "strong",
  "bounded",
  "contextual"
]);
...
const proofClaimsInput = [
  {
    ...
    detailedClaim:
      "Across selected work from WOWList, Harry J. Epstein Company, civic-data prototypes, cultural infrastructure, coalition documentation, and source-backed memory practice, Jamie repeatedly turned under-structured work into workflows, documentation, public-facing tools, decision records, and durable handoffs.",
  ...
  },
  {
    ...
    sourceNote:
      "Supported by the approved resume, the public HJE website, public-safe narrative review, and firsthand operational record.",
    publicBoundary:
  ...
  },
  {
    ...
    sourceNote:
      "Supported by the approved resume and private operational context reviewed for public-safe wording.",
    publicBoundary:
