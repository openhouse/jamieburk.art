...
export const proofClaims: ProofClaim[] = [
  ...
  },
  {
    ...
    sourceBasis:
      "Governed CallNYC source, claim, evidence-note, research-run, media, and correction records; public GitHub repository; verified Politico New York coverage; and qualified public event evidence.",
