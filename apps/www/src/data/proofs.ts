...
export const selectedProofGroups = [
  ...
  },
  {
    ...
    claims: [
      "Designed a source-backed team-memory practice for selected meetings, documents, decision records, open questions, onboarding context, governance notes, and eval checks.",
