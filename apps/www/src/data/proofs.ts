export type ProofStatus = "approved" | "softened-for-v1" | "future-v1-1";
...
export const proofs = [
  {
    ...
    approvedWording: [
      "I build operating structure for emerging public-facing technical work.",
      "I help emerging, stakeholder-heavy work become usable systems: requirements, workflows, documentation, decision trails, launch support, onboarding, and durable handoffs.",
