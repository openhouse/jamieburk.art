...
const proofBankInput = [
  {
    ...
    publicClaim:
      "Jamie builds operating structure for emerging public-facing technical work: planning rhythms, decision records, action trackers, onboarding materials, stakeholder updates, documentation systems, launch support, and durable handoffs.",
    safeShortWording: "Builds operating structure for emerging public-facing technical work.",
