...
const workItemsInput = [
  {
    ...
    evidence: [
      ...
      "Contributed to 2x revenue growth while supporting e-commerce and operations",
      "Stakeholder translation across technical and nontechnical contexts"
    ],
    knownOpenProtected: {
      known:
        "Jamie contributed to 2x revenue growth while supporting e-commerce, analytics, marketing, content, and operational workflows for an 80+ year-old legacy industrial business.",
      open:
        "Screenshots, internal workflow diagrams, and detailed revenue breakdowns remain offline.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "Public sources, public campaign materials, meeting memory summaries, and private/redacted coalition context where relevant.",
    ...
    knownOpenProtected: {
      known:
        "Jamie helped build, structure, and steward public-safe campaign memory, coordination documents, source maps, and follow-up systems.",
      open:
        "Named artifacts, collaborator details, meeting materials, and screenshots are omitted unless reviewed for publication.",
      protected:
  ...
  },
  {
    ...
    artifacts: [
      ...
      },
      {
        ...
        description:
          "External coverage is not linked here until the exact citation is reviewed.",
        type: "press"
      }
    ],
    tags: [
    ...
    links: [
      { label: "CallNYC", url: "https://callnyc.org" },
      { label: "GitHub repository", url: "https://github.com/openhouse/CallNYC" }
    ],
    sourceLayer:
      "CouncilStat / constituent-services open data, archived project context, and public project links.",
    ...
    currentStatus: "Archived prototype with public project links.",
    group: "Civic and public-facing systems",
    roleFit:
    ...
    evidence: [
      ...
      "Historical civic-tech demo with public project links"
    ],
    knownOpenProtected: {
      known:
        "CallNYC translated civic open data into issue pathways and resident-facing guidance as an archived prototype.",
      open:
        "Screenshots and the exact press citation are omitted unless reviewed for publication.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "Public-safe summary and historical project context; private records intentionally omitted.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Screenshots, archive links, and precise adoption wording are omitted unless reviewed for publication.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "Public-safe summary; private records intentionally omitted.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Named participants, photos, and artifacts are omitted unless reviewed for publication and consented where needed.",
      protected:
  ...
  },
  {
    ...
    role: "Co-lead, Project Planning & Documentation",
    years: "2020s",
    status: "Short proof page",
    featured: false,
    priority: 6,
    ...
    whatBecameUsable:
      "Planning materials, public-benefit documentation, stakeholder context, and municipal-review support for a proposed adaptive reuse into four commercial spaces and three homes.",
    ...
    sourceLayer:
      "Public-safe summary; private project materials intentionally omitted.",
    ...
    evidence: [
      "Co-led redevelopment planning",
      "Public-benefit documentation",
      "Historic preservation context",
      "Approximately 6,500 sq. ft. adaptive reuse plan",
      "Four commercial spaces and three homes",
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific public-funding materials, named partners, and project status details are omitted unless reviewed for publication.",
      protected:
        "Private finance, legal, ownership, partner, property, banking, and stakeholder details are omitted."
    }
  }
] satisfies WorkMeta[];
