...
const workItemsInput = [
  ...
  },
  {
    ...
    sourceLayer:
      "Page-local notes connect the 2016 event history, independent follow-on chronology, data limits, press coverage, and public repository to the exact evidence they use.",
