...
const workItemsInput = [
  ...
  },
  {
    ...
    summary:
      "Built and stewarded public-safe campaign-memory and coordination infrastructure for Commercial Rent Stabilization and storefront-stability work.",
    ...
    whatBecameUsable:
      "Running minutes, action trackers, source maps, legal/policy question logs, public-data framing, stakeholder follow-up notes, public-safe explanations, and shared operating memory.",
    ...
    evidence: [
      ...
      "NYC Artist Coalition public campaign websites for FairRentNYC, Let NYC Dance, Save NYC Spaces, and Talks Not Raids"
    ],
    links: [
    ...
    knownOpenProtected: {
      ...
      protected:
        "Private coalition notes, legal-review materials, stakeholder lists, raw strategy context, private emails, and quotes not reviewed for public use are omitted."
    }
  },
  {
    title: "CallNYC.org",
  ...
  },
  {
    ...
    summary:
      "Co-built a Django / PostgreSQL / PostGIS and Ember community-calendar platform organized around followable keyword communities and used across roughly 35 active city ecosystems.",
    ...
    whatBecameUsable:
      "A followable keyword-community platform with event distribution workflows, organizer-facing publishing patterns, and adoption across roughly 35 active city ecosystems.",
    ...
    sourceLayer:
      "Public-safe summary, historical project context, aggregate records, and representative artifacts. Private user and organizer records are not shown.",
    ...
    evidence: [
      ...
      "1,800+ users, 16,000+ posts/events, and roughly 35 active city ecosystems by 2017"
    ],
    knownOpenProtected: {
      known:
        "WOWList was a co-built community-calendar platform organized around followable keyword communities.",
      open:
        "Screenshots, archive links, and more precise adoption wording require separate review.",
      protected:
  ...
  },
  {
    ...
    summary:
      "Co-led redevelopment planning and public-benefit documentation for adaptive reuse of a long-vacant building, including municipal-review support and a $490,539 public-funding recommendation.",
    ...
    sourceLayer:
      "Public-safe summary and public municipal record. Private project details are not shown.",
    ...
    evidence: [
      ...
      "$490,539 public-funding recommendation in Kansas City File 190649"
    ],
    links: [
      {
