...
const workItemsInput = [
  {
    ...
    publicSafety: {
      note: "Use only public-safe claims. Treat metrics as contribution language."
    },
    currentStatus: "Public-safe full case study. Private source materials are omitted.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific screenshots, internal workflow diagrams, and detailed revenue breakdowns are not shown in V1.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "Public sources, public campaign materials, meeting memory summaries, and private/redacted coalition context with collaborator-sensitive details omitted.",
    ...
    currentStatus: "Active public-safe summary with sensitive materials omitted.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific public artifacts, meeting materials, collaborator-sensitive details, and screenshots are not shown in V1.",
      protected:
  ...
  },
  {
    ...
    currentStatus: "Archived prototype with public-safe summary only.",
    group: "Civic and public-facing systems",
    roleFit:
    ...
    knownOpenProtected: {
      ...
      open:
        "Archive links, screenshots, and press citations are not shown in V1.",
      protected:
  ...
  },
  {
    ...
    knownOpenProtected: {
      ...
      open:
        "Screenshots, archive links, and more precise adoption wording are not shown in V1.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "Public-safe summary with private records intentionally omitted.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Named participants, photos, and artifacts are not shown in V1.",
      protected:
  ...
  },
  {
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific public-funding materials, named partners, and current project status details are not shown in V1.",
      protected:
