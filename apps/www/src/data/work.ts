...
const workItemsInput = [
  {
    ...
    careNote:
      "No private analytics dashboards, revenue details, access details, customer data, vendor information, or internal operational materials are published.",
    sourceLayer:
  ...
  },
  {
    ...
    summary:
      "Created repeatable hosting, onboarding, facilitation, documentation, and continuity systems for gatherings and resident artists.",
    ...
    evidence: [
      ...
      "Resident-artist continuity support",
