...
const workItemsInput = [
  {
    ...
    currentStatus: "Public-safe full case study with representative artifacts only.",
    ...
    evidence: [
      ...
      "Measurable growth contribution framed without sole-causation language",
      "Stakeholder translation across technical and nontechnical contexts"
    ],
    claimIds: ["hje-operating-surface", "hje-homepage-safe-proof", "hje-revenue-growth-2x"],
    knownOpenProtected: {
      known:
      ...
      open:
        "Specific public artifacts, internal workflow diagrams, and detailed revenue breakdowns are handled through the knowledge-bank review process before they are shown publicly.",
      protected:
  ...
  },
  {
    ...
    visibility: "public-safe",
    whatWasUnclear:
      "The work involved artists, venues, small-business advocates, public officials, policy questions, public/private source materials, city/state strategy lanes, shifting meetings, and sensitive coalition context that could easily become fragmented or overexposed.",
    whatBecameUsable:
    ...
    artifacts: [
      ...
      },
      {
        ...
        description:
          "Representative call scripts, signup pathways, public explainers, reference-library structures, and follow-up protocols for cultural-space and small-business advocacy.",
        type: "script"
      }
    ],
    tags: [
    ...
    sourceLayer:
      "Public sources, public campaign materials where appropriate, meeting-memory summaries, and private/redacted coalition context.",
    ...
    currentStatus: "Active public-safe summary of collective work.",
    ...
    evidence: [
      "Public campaign surfaces for cultural-space advocacy, FairRentNYC, and enforcement-transparency work",
    ...
    claimIds: [
      ...
      "nac-public-web-infrastructure",
      "fairrent-thirty-pages-memory"
    ],
    knownOpenProtected: {
      known:
      ...
      open:
        "Specific artifact, collaborator-name, meeting-material, and screenshot choices are handled through collaborator consent and knowledge-bank review.",
      protected:
  ...
  },
  {
    ...
    artifacts: [
      ...
      },
      {
        ...
        description:
          "External coverage can be linked once the correct Politico New York citation is confirmed.",
        type: "press"
      }
    ],
    tags: [
    ...
    sourceLayer:
      "CouncilStat / constituent-services open data, archived project context, and public-safe summary.",
    ...
    currentStatus: "Archived prototype with representative evidence only.",
    group: "Civic and public-facing systems",
    roleFit:
    ...
    evidence: [
      ...
      "Historical civic-tech demo with external citation to be confirmed"
    ],
    knownOpenProtected: {
      known:
  ...
  },
  {
    ...
    summary:
      "Co-built a Python / Django + Ember.js community-calendar platform organized around followable keyword communities and public event distribution for DIY arts, music, and local scenes.",
    ...
    sourceLayer:
      "Public-safe summary and historical project context.",
    ...
    evidence: [
      ...
      "Aggregate adoption evidence tracked in the knowledge bank rather than rendered as a homepage claim"
    ],
    claimIds: ["wowlist-platform", "wowlist-thirty-five-ecosystems"],
    knownOpenProtected: {
      known:
        "WOWList was a co-built community-calendar platform organized around followable keyword communities.",
      open:
        "Screenshots, archive links, and precise adoption wording are handled through knowledge-bank review.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "Public-safe summary and private records intentionally omitted.",
  ...
  },
  {
    ...
    sourceLayer:
      "Public-safe summary with private project materials omitted.",
    ...
    claimIds: ["kc-town-hall-adaptive-reuse", "kc-town-hall-funding"],
    knownOpenProtected: {
      known:
        "Jamie supported adaptive reuse planning and documentation for a long-vacant historic building.",
      open:
        "Specific public-funding materials, named partners, and project status details are handled through knowledge-bank review.",
      protected:
