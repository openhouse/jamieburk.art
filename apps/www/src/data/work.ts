...
const workItemsInput = [
  {
    ...
    evidence: [
      ...
      "Contributed to online growth through legacy e-commerce modernization",
  ...
  },
  {
    ...
    summary:
      "Co-built a Python / Django + Ember.js community-calendar platform organized around followable keyword communities for DIY arts and music organizers.",
    ...
    evidence: [
      ...
      "Community web systems for DIY arts and music organizers"
    ],
    knownOpenProtected: {
      known:
  ...
  },
  {
    ...
    whatBecameUsable:
      "Repeatable participation infrastructure for gatherings, resident-artist support, onboarding, facilitation, and handoffs.",
