...
const workItemsInput = [
  {
    ...
    summary:
      "Contributed to 2x online revenue growth while helping an 80+ year-old legacy industrial business adapt to e-commerce through web, analytics, marketing, content, and operational workflow improvements.",
    ...
    publicSafety: {
      note: "Use public-safe claims and contribution language for metrics."
    },
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific screenshots, internal workflow diagrams, and detailed revenue breakdowns stay offline.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "Public sources, public campaign materials, meeting-memory summaries, and redacted coalition context.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Additional named artifacts, collaborators, meeting materials, and screenshots remain offline unless cleared for public use.",
      protected:
  ...
  },
  {
    ...
    artifactTypes: ["prototype", "guide", "map"],
    artifacts: [
      {
    ...
    careNote:
      "Archived civic-data prototype. Not an official or current City service, legal service, emergency service, or comprehensive civic guidance source.",
    sourceLayer:
      "CouncilStat / constituent-services open data and archived project context.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Archive links, screenshots, and external citations remain offline until verified.",
      protected:
  ...
  },
  {
    ...
    knownOpenProtected: {
      ...
      open:
        "Screenshots, archive links, and more precise adoption details remain offline.",
      protected:
  ...
  },
  {
    ...
    careNote:
      "Summary-only page. Participant names, photos, guest data, attendance records, private community records, and unapproved photos stay offline unless explicitly cleared for publication.",
    sourceLayer:
    ...
    knownOpenProtected: {
      ...
      open:
        "Named participants, photos, and artifacts are omitted unless explicitly cleared for publication.",
      protected:
  ...
  },
  {
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific public-funding materials, named partners, and current project status details remain offline.",
      protected:
