...
const workItemsInput = [
  {
    ...
    publicSafety: {
      note: "Use only public-safe claims. Treat metrics as contribution language and omit private analytics, customer, revenue, and operations material."
    },
    currentStatus:
      "Public-safe full case study; private source material omitted.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Representative artifacts are described without publishing private dashboards, customer data, credentials, revenue detail, or internal operating materials.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "Public sources, public campaign materials, public-safe meeting memory summaries, private/redacted coalition context, and protected materials intentionally omitted.",
    ...
    currentStatus:
      "Public-safe summary of collective work; private notes, legal-review materials, stakeholder lists, and unapproved internal materials are omitted.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Additional named artifacts or collaborator details can be added only when they are public-safe, consented, and useful to the reader.",
      protected:
  ...
  },
  {
    ...
    currentStatus:
      "Archived civic-data prototype. Not an official or current City Council service, legal service, emergency service, or emergency guidance source.",
    group: "Civic and public-facing systems",
    roleFit:
  ...
  },
  {
    ...
    sourceLayer:
      "Public-safe summary, historical project context, and aggregate claims with private rows omitted.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Screenshots, archive links, and more precise adoption wording can be added only when public-safe and verified.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "Public-safe summary with private participant records, addresses, attendance lists, unapproved quotes, and unapproved images intentionally omitted.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Named participants, photos, and artifacts can be added only with consent and a clear public purpose.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "Public-safe summary and public-record-based funding recommendation language.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific public-funding materials, named partners, and current project status details can be added only when public-safe and verified.",
      protected:
