...
const workItemsInput = [
  ...
  },
  {
    ...
    evidence: [
      "Helped build and steward 30+ pages of shared campaign-memory infrastructure",
  ...
  },
  {
    ...
    evidence: [
      "Supported redevelopment planning",
      "Public-benefit documentation",
      "Historic preservation context",
      "Long-horizon project documentation"
    ],
    knownOpenProtected: {
      known:
