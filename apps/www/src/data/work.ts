...
const workItemsInput = [
  {
    ...
    artifactTypes: ["website", "workflow", "analytics summary", "diagram"],
    artifacts: [
      {
        title: "E-commerce workflow map",
        description:
          "Representative flow for translating inventory knowledge, customer language, and order handling into maintainable online workflows.",
        type: "workflow"
      },
      {
    ...
    sourceLayer:
      "Public website, resume-backed impact claims, representative workflow descriptions, and private operating materials intentionally omitted.",
    credits: ["Jamie Burkart", "Harry J. Epstein Company team"],
    publicSafety: {
      note: "The 2x revenue-growth point is framed as a contribution, not as a sole-causation claim."
    },
    currentStatus: "Selected public proof with private operating details omitted.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific screenshots, internal workflow diagrams, and detailed revenue breakdowns require separate review before publication.",
      protected:
  ...
  },
  {
    ...
    whatBecameUsable:
      "Running minutes, action trackers, source maps, legal/policy question logs, public-data framing, stakeholder follow-up notes, public explanations, public campaign websites, and shared campaign memory.",
    artifactTypes: ["website", "source map", "meeting memory", "decision record", "public handout"],
    artifacts: [
      {
        title: "Campaign-memory spine",
        description:
          "A shared documentation structure for meetings, next steps, decision context, and public continuity.",
        type: "meeting memory"
      },
      {
        title: "Source map",
    ...
    careNote:
      "This is a selected public summary of collective civic and coalition work. Private notes, legal-review materials, stakeholder lists, raw strategy documents, and unapproved internal materials stay offline.",
    sourceLayer:
      "Public sources, public campaign materials, meeting-memory summaries, source maps, and selected context with private coalition material withheld.",
    credits: ["Jamie Burkart", "NYC Artist Coalition collaborators", "Commercial Rent Stabilization advocates"],
    publicSafety: {
      note: "This page uses collective-work language: contributed to, helped structure, stewarded, supported, and translated."
    },
    currentStatus: "Active civic work summarized through selected public proof.",
    ...
    knownOpenProtected: {
      known:
        "Jamie helped structure and steward campaign memory, coordination documents, source maps, and follow-up systems.",
      open:
        "Specific public artifacts, collaborators, meeting materials, and screenshots require separate review before publication.",
      protected:
  ...
  },
  {
    ...
    artifacts: [
      ...
      },
      {
        ...
        description:
          "Politico New York covered the project in Miranda Neubauer's March 14, 2016 article about council-member focus.",
        type: "press"
      }
    ],
    tags: [
    ...
    sourceLayer:
      "CouncilStat / constituent-services open data, archived project context, CallNYC archive, GitHub source archive, and Politico New York coverage.",
    ...
    currentStatus: "Archived civic-data prototype with live archive and source links.",
    group: "Civic and public-facing systems",
    roleFit:
    ...
    evidence: [
      ...
      "Covered by Politico New York in Miranda Neubauer's March 14, 2016 article \"Website provides new information about council members' focus\""
    ],
    links: [
      { label: "Archive", url: "https://callnyc.org/" },
      {
        label: "Politico New York PDF",
        url: "https://callnyc.org/data/media/Politico-Website-provides-new-information-about-council-members-focus.pdf"
      },
      { label: "GitHub source archive", url: "https://github.com/openhouse/CallNYC" }
    ],
    knownOpenProtected: {
      known:
        "CallNYC translated civic open data into issue pathways and resident-facing guidance as an archived prototype.",
      open:
        "Screenshots and deeper archival artifacts require separate review before publication.",
      protected:
  ...
  },
  {
    ...
    careNote:
      "Historical proof page. Claims should avoid overreading adoption beyond defensible estimates.",
    sourceLayer:
      "Public summary, historical project context, and selected adoption claims from the approved resume.",
    credits: ["Jamie Burkart", "WOWList collaborators"],
    currentStatus: "Historical short proof page with private organizer data omitted.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Screenshots, archive links, and more granular adoption detail require separate review before publication.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "Public summary, approved resume metrics, and private community records intentionally omitted.",
    credits: ["Jamie Burkart", "196 / Sunday Dinner community"],
    currentStatus: "Summary proof with consent-sensitive details omitted.",
    group: "Community and cultural infrastructure",
    roleFit:
  ...
  },
  {
    ...
    summary:
      "Co-founded and project-managed long-horizon redevelopment planning and public-benefit documentation for adaptive reuse of a long-vacant historic building.",
    ...
    whatBecameUsable:
      "Planning materials, public-benefit documentation, funding context, and stakeholder materials for an adaptive reuse effort.",
    ...
    sourceLayer:
      "Public summary and selected resume-backed project details with private financial, legal, property, and stakeholder material omitted.",
    credits: ["Jamie Burkart", "KC Town Hall LLC collaborators"],
    currentStatus: "Short proof page with private project details omitted.",
    group: "Operating systems for teams",
    roleFit:
    ...
    evidence: [
      ...
      "Secured a $490,539 public funding recommendation"
    ],
    knownOpenProtected: {
      known:
        "Jamie co-founded and project-managed redevelopment planning and public-benefit documentation for adaptive reuse of a long-vacant historic building.",
      open:
        "Specific public-funding materials, named partners, and project status details require separate review before publication.",
      protected:
