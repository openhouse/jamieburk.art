...
const workItemsInput = [
  {
    ...
    evidence: [
      ...
      "Measurable online-growth contribution framed without sole-causation language",
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific public artifacts, internal workflow diagrams, and detailed revenue breakdowns require knowledge-bank review before public use.",
      protected:
  ...
  },
  {
    ...
    role: "Documentation Systems & Coalition Operations Support",
    years: "2024-Present",
    status: "Full case study",
    featured: true,
    priority: 2,
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific artifact, collaborator-name, meeting-material, and screenshot choices require collaborator consent and knowledge-bank review.",
      protected:
  ...
  },
  {
    ...
    knownOpenProtected: {
      ...
      open:
        "Screenshots, archive links, and precise adoption wording require knowledge-bank review.",
      protected:
  ...
  },
  {
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific public-funding materials, named partners, and project status details require knowledge-bank review.",
      protected:
