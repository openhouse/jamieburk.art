...
const workItemsInput = [
  {
    ...
    whatBecameUsable:
      "Improved searchable catalog, e-commerce, analytics, marketing, content, and operational systems that supported online growth while preserving the company's distinctive institutional voice.",
    ...
    sourceLayer:
      "Public website, public-safe summary, resume-backed impact claims, screenshots shown only when approved, and private materials intentionally omitted.",
    credits: ["Jamie Burkart", "Harry J. Epstein Company team"],
    publicSafety: {
      note: "Use only public-safe claims and approved screenshots. Treat metrics as contribution language."
    },
    ...
    evidence: [
      "Searchable catalog and dealer-aware e-commerce workflows",
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific screenshots, internal workflow diagrams, and detailed revenue breakdowns stay outside the public case study unless approved.",
      protected:
  ...
  },
  {
    ...
    whatBecameUsable:
      "Running minutes, action trackers, source maps, legal/policy question logs, public-data framing, consent-aware follow-up protocols, public-safe explanations, and shared campaign memory.",
    ...
    sourceLayer:
      "Public sources, public campaign materials where approved, meeting memory summaries, private/redacted coalition context, and named materials shown only when approved.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific public artifacts, collaborators, meeting materials, and screenshots stay omitted unless approved.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "CouncilStat / constituent-services open data, archived project context, and screenshots or press citations shown only when confirmed.",
    ...
    evidence: [
      ...
      "Historical civic-tech demo with citation omitted unless confirmed"
    ],
    knownOpenProtected: {
      known:
        "CallNYC translated civic open data into issue pathways and resident-facing guidance as an archived prototype.",
      open:
        "Archive links, screenshots, and press citations stay omitted unless confirmed.",
      protected:
  ...
  },
  {
    ...
    whatBecameUsable:
      "A followable keyword-community platform with event publishing, interest follows, email digests, calendar-sync patterns, and organizer-facing distribution workflows.",
    artifactTypes: ["website", "workflow", "prototype"],
    artifacts: [
      {
        title: "Keyword-community model",
        description:
          "A practical, low-overhead distribution pattern for followable arts, music, and local-interest communities.",
        type: "diagram"
      }
    ],
    ...
    sourceLayer:
      "Public-safe summary, historical project context, and screenshots omitted unless approved.",
    ...
    evidence: [
      ...
      "Email digests, saved events, and calendar-sync patterns",
    ...
    knownOpenProtected: {
      ...
      open:
        "Screenshots, archive links, and precise adoption wording stay omitted unless confirmed.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "Public-safe summary, public materials shown only when approved, and private records intentionally omitted.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Named participants, photos, and artifacts appear only with consent.",
      protected:
  ...
  },
  {
    ...
    sourceLayer:
      "Public-safe summary with public materials shown only when approved.",
    ...
    knownOpenProtected: {
      ...
      open:
        "Specific funding-process materials, named partners, and project status details stay omitted unless approved.",
      protected:
