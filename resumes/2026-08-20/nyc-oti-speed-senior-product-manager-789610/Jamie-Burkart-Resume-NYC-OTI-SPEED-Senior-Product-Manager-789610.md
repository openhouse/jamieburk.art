...
**Senior Product Manager | Permitting Systems, Service Delivery & Implementation**
...
Senior product and technical project manager with 14+ years turning complex civic, regulatory, operational, and technical conditions into usable products, services, and implementation plans. Builds business cases and roadmaps from stakeholder research, public data, system constraints, and root-cause analysis; carries work through requirements, prioritization, delivery, launch, measurement, and iteration. Influences across residents, program teams, designers, engineers, vendors, policy stakeholders, public officials, and senior decision-makers without confusing participation with authority. Brings hands-on systems fluency and direct experience with municipal compliance, public-benefit development, and resource-constrained delivery.

## Core Skills

- **Product strategy and lifecycle:** Business cases, problem framing, root-cause analysis, discovery, research and analytics synthesis, roadmaps, outcome and KPI definition, MVP scoping, prioritization, user stories, acceptance criteria, launch, and post-launch learning.
- **Complex service delivery:** Systems analysis, permitting and compliance translation, vendor and dependency coordination, cross-agency stakeholder alignment, influence without authority, plain-language briefings, rollout planning, and durable handoffs.
- **Responsible public technology:** Accessibility-aware implementation, privacy-conscious data practice, public-safety review, source governance, evidence boundaries, and clear documentation of assumptions, unknowns, and decisions.
...
- Built [CallNYC.org](https://callnyc.org/) as an independent follow-on to the New York City Council's first CouncilStat hackathon, translating constituent-services data into resident-facing issue pages and next-step guidance; covered in [Politico New York](https://callnyc.org/data/media/Politico-Website-provides-new-information-about-council-members-focus.pdf).
