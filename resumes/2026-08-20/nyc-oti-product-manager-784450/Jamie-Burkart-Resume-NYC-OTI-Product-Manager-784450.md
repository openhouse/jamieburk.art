...
**Product Manager | Resident-Facing Digital Services & Implementation**
...
Product and technical project manager with 14+ years taking public-facing products and services from problem framing and research through roadmaps, requirements, implementation, launch, measurement, and iteration. Synthesizes stakeholder listening, public data, analytics, and technical constraints into validated user problems, sequenced decisions, user stories, acceptance criteria, and plain-language plans. Works across residents, organizers, program teams, designers, engineers, operations, policy stakeholders, and senior decision-makers. Brings hands-on technical fluency with privacy-conscious, accessibility-aware delivery in legacy and resource-constrained environments.

## Core Skills

- **Product lifecycle:** Problem framing, discovery, public and user research, analytics synthesis, roadmaps, requirements, user stories, acceptance criteria, system requirements, MVP scoping, prioritization, prototyping, UAT/QA, launch, KPIs, and post-launch learning.
- **Cross-functional delivery:** Product ownership, stakeholder alignment, designer and engineer coordination, program and agency translation, plain-language briefings, rollout planning, risk and dependency tracking, adoption, and durable handoffs.
- **Resident-facing public technology:** Service journeys, information architecture, content structure, accessibility-aware implementation, privacy-conscious data practice, public-safety review, source governance, and documentation of decisions and unknowns.
