...
**Product Operations Manager | Launch Readiness, Implementation & Operational Systems**
...
Product operations and technical project manager with 14+ years turning ambiguous product, customer, and operational inputs into clear plans, readiness criteria, public launches, adoption workflows, documentation, and post-launch learning. Partners across product, engineering, operations, communications, customers, and community stakeholders to surface downstream impact early, sequence dependencies, make tradeoffs legible, and keep owners accountable through follow-through. Combines hands-on web systems fluency, analytics, facilitation, customer care, and scalable runbook and knowledge-system design in fast-moving, resource-constrained environments.

## Core Skills

- **Launch readiness:** Work-back plans, milestones, readiness criteria, risk and dependency tracking, release checklists, UAT/QA, decision support for go/no-go recommendations, rollout communications, adoption, and post-launch issue follow-up.
- **Product-to-operations translation:** Translate roadmaps, sprint work, technical constraints, customer needs, and public feedback into operational requirements, workflows, documentation, support preparation, and accountable owners.
- **Prioritization and learning:** Synthesize requests into problem statements and use cases; assess revenue, efficiency, risk, customer impact, and evidence quality; document tradeoffs, outcomes, limitations, and retrospectives.
- **Scalable operating systems:** Runbooks, playbooks, templates, status reporting, decision logs, action trackers, onboarding, shared knowledge, and human-correctable AI-assisted workflows.
...
- Created repeatable onboarding, scheduling, hospitality, facilitation, documentation, and continuity systems across 300+ gatherings and 20+ resident artists, joining operational consistency with care for individual needs.
