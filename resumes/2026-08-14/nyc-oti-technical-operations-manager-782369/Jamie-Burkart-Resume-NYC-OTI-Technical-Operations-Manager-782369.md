...
**Technical Operations Manager | Public-Interest Technology, Delivery & Team Systems**
...
Technical operations and project manager with 14+ years building the operating structure that helps public-facing teams move from ambiguity through delivery, launch, adoption, and continuous improvement. Coordinates concurrent work, risks, dependencies, decisions, documentation, onboarding, reporting, and handoffs across technical, policy, operational, executive, and community stakeholders. Brings hands-on web systems fluency, calm facilitation, candid status communication, and a public-service commitment to usable technology, durable in-house capacity, digital equity, privacy, accessibility, and collective learning.

## Core Skills

- **Delivery coordination:** Multi-project planning, sequencing, milestones, ownership, risk and dependency tracking, action and decision logs, stakeholder updates, escalation, launch coordination, and accountable follow-through.
- **Team operating systems:** Meeting rhythms, status reporting, decision records, source maps, onboarding guides, handbooks, runbooks, templates, resource libraries, retrospectives, and continuous process improvement.
- **Cross-functional translation:** Connect product, engineering, design, security, legal and policy questions, communications, operations, executives, vendors, public officials, and community partners without flattening their different responsibilities.
- **Technical and evidence fluency:** JavaScript/TypeScript, React/Next.js, Ember.js, Python/Django, SQL/PostgreSQL, Git/GitHub, Docker/Dokku, APIs, open data, analytics, AI-assisted evaluation, privacy-conscious source governance, and human review.
...
- Led long-running e-commerce, analytics, content, marketing, and operational improvements for [Harry J. Epstein Company](https://www.harryepstein.com/), contributing to a period of 2x revenue growth while helping an 80+ year-old business adapt its public and internal systems.
...
- Coordinate campaign websites, public meetings, policy communications, stakeholder follow-up, source material, public-data framing, and city/state workstreams across advocates, cultural-space operators, elected officials, staff, technical collaborators, and partner organizations.
...
- Supported organizer-led publishing and discovery active in 35+ city ecosystems. This is a limited geographic activity signal, not official chapters, measured readership, or resident outcomes.
...
Brooklyn, NY | 2012–Present

- Created repeatable invitation, onboarding, scheduling, facilitation, documentation, and continuity systems across 300+ gatherings and 20+ resident artists.
...
Authorized to work in the United States; no sponsorship required. Valid New York State driver's license. This expired role is retained only as a benchmark for future materially similar openings.
