...
- When uncertain, use review notes and launch blockers rather than public-facing
  TODOs.
- Maintain `docs/proofs-bank.md` and `docs/proofs-bank.json` as the public-safe
  knowledge base for strong professional claims. The website should project
  that bank for clarity, audience, and purpose rather than expose raw archival
  material or the internal proof scaffold as a visitor-facing page.
