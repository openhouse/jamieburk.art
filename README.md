...
- Treat `docs/knowledge-bank/` as the public-safe knowledge bank for
  professional accomplishment claims. Use `docs/knowledge-bank/claims.md` and
  `docs/knowledge-bank/claims.json` to track exact metrics, sensitive role
  claims, fallback wording, source classes, and approval owners.
...
- Confirm `npm run knowledge-bank`, `npm run public-safety`,
  `npm run preflight:staging`, and
