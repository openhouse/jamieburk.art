...
**Candidate commit:** `964abcb5e37b944b46ad8a58c08d494bd8bb6a1d`
**Portfolio snapshot:** `e1a718fdbe5f951fb85d93f036261563b40f3b2ed32d598d6125c49b41f28f95`
...
- `requirement.codepath.engineering-delivery`: **observed** on `/work/technical-operations`
...
- `requirement.aclu.project-strategy`: **observed** on `/resume`, `/work/technical-operations`
- `requirement.aclu.cross-department-delivery`: **observed** on `/work/technical-operations`
- `requirement.aclu.business-analysis`: **observed** on `/resume`
- `requirement.aclu.budget-and-resources`: **not observed**
- `requirement.aclu.organizational-standards`: **observed** on `/work/technical-operations`
...
- `requirement.oti-senior-product-manager.end-to-end-product`: **observed** on `/work/technical-operations`
- `requirement.oti-senior-product-manager.discovery-research`: **not observed**
- `requirement.oti-senior-product-manager.tradeoffs-and-briefs`: **observed** on `/work/technical-operations`
- `requirement.oti-senior-product-manager.agency-policy-translation`: **observed** on `/work/technical-operations`, `/work/fair-rent-nyc`
