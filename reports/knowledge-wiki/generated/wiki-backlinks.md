...
## Digital District breakout photograph

Target: [asset.photo.digital-district.001](../../../docs/knowledge-bank/assets/digital-district-photo.md)
...
- [CallNYC](../../../docs/knowledge-bank/projects/callnyc.md) — `has_asset` from `frontmatter`
...
- [Benepass Product Operations Manager](../../../docs/knowledge-bank/opportunities/benepass-product-operations.md) — `documents` from `frontmatter`
...
- [NYC OTI Technical Operations Manager](../../../docs/knowledge-bank/opportunities/oti-technical-operations.md) — `documents` from `frontmatter`
...
Target: [claim.callnyc.hackathon-date-time](../../../docs/knowledge-bank/claims/callnyc-hackathon-date-time.md)

- [Knowledge Wiki foundation pilot](../../../docs/knowledge-bank/indexes/pilot.md) — `links_to` from `markdown`
- [Civic Hall announcement of the January 2016 Council hackathon](../../../docs/knowledge-bank/sources/civic-hall-hackathon-announcement-2016.md) — `links_to` from `markdown`

## CallNYC independent follow-on chronology

Target: [claim.callnyc.independent-follow-on](../../../docs/knowledge-bank/claims/callnyc-independent-follow-on.md)

- [CallNYC chronology correction](../../../docs/knowledge-bank/corrections/callnyc-years.md) — `documents` from `frontmatter`
- [Knowledge Wiki foundation pilot](../../../docs/knowledge-bank/indexes/pilot.md) — `links_to` from `markdown`
- [Politico New York coverage of CallNYC](../../../docs/knowledge-bank/sources/politico-callnyc-2016-03-14.md) — `links_to` from `markdown`

## Superseded CallNYC project date range

Target: [claim.callnyc.project-years.legacy](../../../docs/knowledge-bank/claims/callnyc-project-years-legacy.md)
...
Target: [correction.callnyc-years](../../../docs/knowledge-bank/corrections/callnyc-years.md)

- [Superseded CallNYC project date range](../../../docs/knowledge-bank/claims/callnyc-project-years-legacy.md) — `documents` from `frontmatter`
- [Superseded CallNYC project date range](../../../docs/knowledge-bank/claims/callnyc-project-years-legacy.md) — `links_to` from `markdown`
- [Knowledge Wiki foundation pilot](../../../docs/knowledge-bank/indexes/pilot.md) — `links_to` from `markdown`

## New York City Council constituent-services hackathon at Civic Hall

Target: [event.nycc.constituent-services-hackathon.2016](../../../docs/knowledge-bank/events/nyc-council-constituent-services-hackathon-2016.md)

- [Digital District breakout photograph](../../../docs/knowledge-bank/assets/digital-district-photo.md) — `documents` from `frontmatter`
- [Knowledge Wiki foundation pilot](../../../docs/knowledge-bank/indexes/pilot.md) — `links_to` from `markdown`
- [CallNYC](../../../docs/knowledge-bank/projects/callnyc.md) — `informed_by` from `frontmatter`
- [Civic Hall announcement of the January 2016 Council hackathon](../../../docs/knowledge-bank/sources/civic-hall-hackathon-announcement-2016.md) — `documents` from `frontmatter`
- [New York City Council event-day CouncilStat post](../../../docs/knowledge-bank/sources/nyc-council-councilstat-hackathon-post-2016.md) — `documents` from `frontmatter`

## Absences, protections, and permissions

Target: [index.absences-protections-and-permissions](../../../docs/knowledge-bank/indexes/absences-protections-and-permissions.md)
...
Target: [index.knowledge-wiki](../../../docs/knowledge-bank/README.md)

- [Employment acceptance](../../../docs/knowledge-bank/indexes/employment-acceptance.md) — `part_of` from `frontmatter`
- [Knowledge Wiki missing pages](../../../docs/knowledge-bank/indexes/missing-pages.md) — `part_of` from `frontmatter`
- [Knowledge Wiki foundation pilot](../../../docs/knowledge-bank/indexes/pilot.md) — `links_to` from `markdown`
- [Knowledge Wiki foundation pilot](../../../docs/knowledge-bank/indexes/pilot.md) — `part_of` from `frontmatter`
- [Source re-encounter](../../../docs/knowledge-bank/methods/source-re-encounter.md) — `part_of` from `frontmatter`
...
- [NYC Artist Coalition shared-folder archival production](../../../docs/knowledge-bank/research/nycartc-shared-folder-archival-production-2026-07.md) — `links_to` from `markdown`
- [Art, life, waterways, and media archaeology, 2003-2011](../../../docs/knowledge-bank/timelines/art-life-waterways-and-media-archaeology-2003-2011.md) — `part_of` from `frontmatter`
- [NYC Artist Coalition events and venues, 2017-2021](../../../docs/knowledge-bank/timelines/nycartc-events-and-venues-2017-2021.md) — `part_of` from `frontmatter`
- [Participation infrastructure lineage, 2012-2026](../../../docs/knowledge-bank/timelines/participation-infrastructure-lineage-2012-2026.md) — `part_of` from `frontmatter`

## Knowledge Wiki foundation pilot

Target: [index.knowledge-wiki-pilot](../../../docs/knowledge-bank/indexes/pilot.md)
...
Target: [index.project-afterlives-and-handoffs](../../../docs/knowledge-bank/indexes/project-afterlives-and-handoffs.md)
...
Target: [index.scenes-of-work](../../../docs/knowledge-bank/indexes/scenes-of-work.md)
...
Target: [inquiry.nycartc.march-data-design-attribution](../../../docs/knowledge-bank/inquiries/nycartc-march-data-design-attribution.md)

- [MARCH open-data design lead](../../../docs/knowledge-bank/claims/nycartc-march-data-design-lead.md) — `links_to` from `markdown`
- [Knowledge Wiki missing pages](../../../docs/knowledge-bank/indexes/missing-pages.md) — `documents` from `frontmatter`
- [Knowledge Wiki missing pages](../../../docs/knowledge-bank/indexes/missing-pages.md) — `links_to` from `markdown`
...
## NYC Artist Coalition public-meeting and testimony participation

Target: [method.nycartc.public-meeting-and-testimony-participation](../../../docs/knowledge-bank/methods/nycartc-public-meeting-and-testimony-participation.md)
...
- [NYC Artist Coalition events and venues, 2017-2021](../../../docs/knowledge-bank/timelines/nycartc-events-and-venues-2017-2021.md) — `informed_by` from `frontmatter`

## Source-Backed Team Memory

Target: [method.source-backed-team-memory](../../../docs/knowledge-bank/methods/source-backed-team-memory.md)
...
- [Participation infrastructure lineage, 2012-2026](../../../docs/knowledge-bank/timelines/participation-infrastructure-lineage-2012-2026.md) — `informed_by` from `frontmatter`

## Source re-encounter

Target: [method.source-re-encounter](../../../docs/knowledge-bank/methods/source-re-encounter.md)

- [Absences, protections, and permissions](../../../docs/knowledge-bank/indexes/absences-protections-and-permissions.md) — `uses_method` from `frontmatter`
- [Knowledge Wiki missing pages](../../../docs/knowledge-bank/indexes/missing-pages.md) — `documents` from `frontmatter`
- [Knowledge Wiki missing pages](../../../docs/knowledge-bank/indexes/missing-pages.md) — `links_to` from `markdown`
...
- [NYC Artist Coalition public-meeting and testimony participation](../../../docs/knowledge-bank/methods/nycartc-public-meeting-and-testimony-participation.md) — `uses_method` from `frontmatter`
- [NYC Artist Coalition shared-folder archival production](../../../docs/knowledge-bank/research/nycartc-shared-folder-archival-production-2026-07.md) — `links_to` from `markdown`
- [Art, life, waterways, and media archaeology, 2003-2011](../../../docs/knowledge-bank/timelines/art-life-waterways-and-media-archaeology-2003-2011.md) — `uses_method` from `frontmatter`
- [NYC Artist Coalition events and venues, 2017-2021](../../../docs/knowledge-bank/timelines/nycartc-events-and-venues-2017-2021.md) — `uses_method` from `frontmatter`
- [NYC Artist Coalition nightlife recommendations, 2017-2019](../../../docs/knowledge-bank/timelines/nycartc-nightlife-recommendations-2017-2019.md) — `uses_method` from `frontmatter`
- [Participation infrastructure lineage, 2012-2026](../../../docs/knowledge-bank/timelines/participation-infrastructure-lineage-2012-2026.md) — `uses_method` from `frontmatter`

## ACLU Product Manager II, Discovery

Target: [opportunity.aclu.product-manager-ii-discovery.8482872002](../../../docs/knowledge-bank/opportunities/aclu-product-manager-discovery.md)

- [Employment acceptance](../../../docs/knowledge-bank/indexes/employment-acceptance.md) — `links_to` from `markdown`

## Asana AI Implementation Manager, Service Management

Target: [opportunity.asana.ai-implementation-manager.8027437](../../../docs/knowledge-bank/opportunities/asana-ai-implementation.md)

- [Employment acceptance](../../../docs/knowledge-bank/indexes/employment-acceptance.md) — `links_to` from `markdown`

## Benepass Product Operations Manager

Target: [opportunity.benepass.product-operations-manager.7f963a7a](../../../docs/knowledge-bank/opportunities/benepass-product-operations.md)

- [Employment acceptance](../../../docs/knowledge-bank/indexes/employment-acceptance.md) — `links_to` from `markdown`

## CodePath Senior Program Manager, Claude Corps

Target: [opportunity.codepath.senior-program-manager-claude-corps.5182020007](../../../docs/knowledge-bank/opportunities/codepath-claude-corps.md)

- [Employment acceptance](../../../docs/knowledge-bank/indexes/employment-acceptance.md) — `links_to` from `markdown`

## NYC OTI Technical Operations Manager

Target: [opportunity.nyc-oti.technical-operations-manager.782369](../../../docs/knowledge-bank/opportunities/oti-technical-operations.md)
...
Target: [opportunity.permitflow.product-operations-manager.8a6e6066](../../../docs/knowledge-bank/opportunities/permitflow-product-operations.md)

- [Employment acceptance](../../../docs/knowledge-bank/indexes/employment-acceptance.md) — `links_to` from `markdown`

## CallNYC portfolio projection

Target: [portfolio.work.callnyc](../../../docs/knowledge-bank/projections/work-callnyc.md)

- [CallNYC workshop date and time](../../../docs/knowledge-bank/claims/callnyc-hackathon-date-time.md) — `projected_to` from `frontmatter`
- [CallNYC independent follow-on chronology](../../../docs/knowledge-bank/claims/callnyc-independent-follow-on.md) — `projected_to` from `frontmatter`
- [Knowledge Wiki foundation pilot](../../../docs/knowledge-bank/indexes/pilot.md) — `links_to` from `markdown`
- [CallNYC](../../../docs/knowledge-bank/projects/callnyc.md) — `projected_to` from `frontmatter`

## Technical Operations portfolio projection

Target: [portfolio.work.technical-operations](../../../docs/knowledge-bank/projections/work-technical-operations.md)

- [Technical Operations](../../../docs/knowledge-bank/capabilities/technical-operations.md) — `projected_to` from `frontmatter`
- [Knowledge Wiki foundation pilot](../../../docs/knowledge-bank/indexes/pilot.md) — `links_to` from `markdown`
- [NYC OTI Technical Operations Manager](../../../docs/knowledge-bank/opportunities/oti-technical-operations.md) — `documents` from `frontmatter`

## CallNYC

Target: [project.callnyc](../../../docs/knowledge-bank/projects/callnyc.md)
...
- [ACLU Product Manager II, Discovery](../../../docs/knowledge-bank/opportunities/aclu-product-manager-discovery.md) — `documents` from `frontmatter`
- [PermitFlow Product Operations Manager](../../../docs/knowledge-bank/opportunities/permitflow-product-operations.md) — `documents` from `frontmatter`
- [CallNYC portfolio projection](../../../docs/knowledge-bank/projections/work-callnyc.md) — `documents` from `frontmatter`
...
- [NYC Artist Coalition public-meeting and testimony participation](../../../docs/knowledge-bank/methods/nycartc-public-meeting-and-testimony-participation.md) — `part_of` from `frontmatter`
...
- [NYC Artist Coalition Cabaret Law testimony guide](../../../docs/knowledge-bank/sources/nycartc-testimony-guide-2017.md) — `documents` from `frontmatter`
- [NYC Artist Coalition events and venues, 2017-2021](../../../docs/knowledge-bank/timelines/nycartc-events-and-venues-2017-2021.md) — `informed_by` from `frontmatter`
- [NYC Artist Coalition nightlife recommendations, 2017-2019](../../../docs/knowledge-bank/timelines/nycartc-nightlife-recommendations-2017-2019.md) — `part_of` from `frontmatter`
- [Participation infrastructure lineage, 2012-2026](../../../docs/knowledge-bank/timelines/participation-infrastructure-lineage-2012-2026.md) — `informed_by` from `frontmatter`
...
- [Knowledge Wiki](../../../docs/knowledge-bank/README.md) — `documents` from `frontmatter`
- [Knowledge Wiki](../../../docs/knowledge-bank/README.md) — `links_to` from `markdown`
- [Source re-encounter](../../../docs/knowledge-bank/methods/source-re-encounter.md) — `informed_by` from `frontmatter`
- [NYC Artist Coalition](../../../docs/knowledge-bank/projects/nyc-artist-coalition.md) — `informed_by` from `frontmatter`
- [NYC Artist Coalition](../../../docs/knowledge-bank/projects/nyc-artist-coalition.md) — `links_to` from `markdown`
...
- [CallNYC workshop date and time](../../../docs/knowledge-bank/claims/callnyc-hackathon-date-time.md) — `links_to` from `markdown`
- [CallNYC workshop date and time](../../../docs/knowledge-bank/claims/callnyc-hackathon-date-time.md) — `uses_source` from `frontmatter`
- [New York City Council constituent-services hackathon at Civic Hall](../../../docs/knowledge-bank/events/nyc-council-constituent-services-hackathon-2016.md) — `links_to` from `markdown`
...
- [MARCH data-design attribution and implementation inquiry](../../../docs/knowledge-bank/inquiries/nycartc-march-data-design-attribution.md) — `uses_source` from `frontmatter`
...
- [NYC Artist Coalition nightlife recommendations, 2017-2019](../../../docs/knowledge-bank/timelines/nycartc-nightlife-recommendations-2017-2019.md) — `uses_source` from `frontmatter`
...
- [NYC Artist Coalition public-meeting and testimony participation](../../../docs/knowledge-bank/methods/nycartc-public-meeting-and-testimony-participation.md) — `uses_source` from `frontmatter`
...
## NYC Artist Coalition Cabaret Law testimony guide

Target: [source.nycartc.testimony-guide.2017](../../../docs/knowledge-bank/sources/nycartc-testimony-guide-2017.md)

- [Knowledge Wiki missing pages](../../../docs/knowledge-bank/indexes/missing-pages.md) — `documents` from `frontmatter`
- [Knowledge Wiki missing pages](../../../docs/knowledge-bank/indexes/missing-pages.md) — `links_to` from `markdown`
- [People, places, and community testimony](../../../docs/knowledge-bank/indexes/people-places-and-community-testimony.md) — `uses_source` from `frontmatter`
- [NYC Artist Coalition public-meeting and testimony participation](../../../docs/knowledge-bank/methods/nycartc-public-meeting-and-testimony-participation.md) — `uses_source` from `frontmatter`

## New York City Council event-day CouncilStat post

Target: [source.nycc.councilstat-hackathon-post.2016](../../../docs/knowledge-bank/sources/nyc-council-councilstat-hackathon-post-2016.md)
...
## Politico New York coverage of CallNYC

Target: [source.politico.callnyc.2016-03-14](../../../docs/knowledge-bank/sources/politico-callnyc-2016-03-14.md)

- [CallNYC independent follow-on chronology](../../../docs/knowledge-bank/claims/callnyc-independent-follow-on.md) — `links_to` from `markdown`
- [CallNYC independent follow-on chronology](../../../docs/knowledge-bank/claims/callnyc-independent-follow-on.md) — `uses_source` from `frontmatter`
- [Knowledge Wiki foundation pilot](../../../docs/knowledge-bank/indexes/pilot.md) — `links_to` from `markdown`
- [CallNYC portfolio projection](../../../docs/knowledge-bank/projections/work-callnyc.md) — `uses_source` from `frontmatter`
- [CallNYC](../../../docs/knowledge-bank/projects/callnyc.md) — `uses_source` from `frontmatter`

## Art, life, waterways, and media archaeology, 2003-2011

Target: [timeline.art-life-waterways-media-archaeology.2003-2011](../../../docs/knowledge-bank/timelines/art-life-waterways-and-media-archaeology-2003-2011.md)
...
Target: [timeline.nycartc.events-and-venues.2017-2021](../../../docs/knowledge-bank/timelines/nycartc-events-and-venues-2017-2021.md)
...
- [NYC Artist Coalition](../../../docs/knowledge-bank/projects/nyc-artist-coalition.md) — `informed_by` from `frontmatter`
- [NYC Artist Coalition](../../../docs/knowledge-bank/projects/nyc-artist-coalition.md) — `links_to` from `markdown`
- [Participation infrastructure lineage, 2012-2026](../../../docs/knowledge-bank/timelines/participation-infrastructure-lineage-2012-2026.md) — `links_to` from `markdown`

## NYC Artist Coalition nightlife recommendations, 2017-2019

Target: [timeline.nycartc.nightlife-recommendations.2017-2019](../../../docs/knowledge-bank/timelines/nycartc-nightlife-recommendations-2017-2019.md)
...
Target: [timeline.participation-infrastructure.2012-2026](../../../docs/knowledge-bank/timelines/participation-infrastructure-lineage-2012-2026.md)
