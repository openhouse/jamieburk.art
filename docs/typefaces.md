...
- Archivo Narrow: H1/H2, display headings, compact proof labels, public metadata
  labels, and selected emphasis.

No private or proprietary font files should be committed or served. Do not ship
Trade Gothic, Verlag, Gotham Rounded, FondFont RISQUE, Maria, local handwriting
fonts, or local font binaries for V1.
