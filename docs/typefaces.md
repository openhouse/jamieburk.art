...
- Archivo Narrow: display headings, section eyebrows, compact proof labels,
  metadata labels, and selected emphasis.
...
- Use `next/font/google` for V1.
- Document any future typeface change before shipping it.
