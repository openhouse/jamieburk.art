---
id: index.capabilities-and-opportunities
title: Capabilities and opportunities
kind: index
status: maintained
...
summary: Task-oriented bridge from governed project evidence to a current role.
authority_refs: []
relations: []
---
...
These pages help an application teammate move from a role requirement to the
