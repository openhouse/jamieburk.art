...
role_requirements:
  ...
  - {id: requirement.aclu.privacy-and-governance, importance: critical, kind: judgment, text: "Balance innovation with privacy, security, counsel, and traceable governance.", proof_refs: [source-backed-team-memory-method, ai-evals-professional-development], wiki_records: [method.source-backed-team-memory], public_routes: [/lab/source-backed-team-memory, /about], coverage_status: visible-proven, gap_type: none, next_action: "Preserve human-review and protected-source boundaries."}
