...
- Treat `docs/knowledge-bank/claims.json` as the machine-checkable source of
...
because privacy, consent, client trust, legal sensitivity, civic sensitivity, or
...
Production mode should fail on approval blockers, protected rendered claims,
visible approval TODOs, private local paths, committed private source materials,
private/proprietary fonts, secrets, non-example env files, and placeholder
resume text.
