...
This file tracks where launch-critical claims appear in the site.

| Claim | Current public locations | Review posture |
| --- | --- | --- |
| Operating backbone for public-facing teams | Homepage hero, Technical Operations page, metadata, README | Approved for launch. |
| 14+ years creating operating structure | Proof strip, resume page, resume PDF, Knowledge Bank | Approved for launch. |
...
| Source-Backed Team Memory method | Lab page, work index, footer | Do not imply finished SaaS, AI replacement for judgment, or private archive browser. |

## Not For Public HTML

- Phone number outside the resume PDF.
- Raw transcripts, meeting notes, private archive paths, private source
  documents, unapproved quotes, private stakeholder lists, or private contact
  lists.
- Any claim that turns collective work into sole-author credit.
