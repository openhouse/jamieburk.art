...
- Adds `docs/knowledge-bank/` as a public-safe knowledge-bank directory.
- Adds public-safe claims, proofs, anti-claims, source policy, publication
  rules, opportunity notes, and a review checklist.
...
Production may also be deployed as noindex for quiet review; final indexing
still requires `NEXT_PUBLIC_ROBOTS_POLICY=index`.
