...
- Baseline: `docs/evals/runs/2026-07-19-knowledge-composite-v4-baseline.md`
...
spelling check. Version four expands exact-candidate binding to the complete
NYCAC shared-folder evidence layer, accounts for its public projection and
survivorship population, and adds file-specific semantic mutations. A
substantive rubric change requires a version increment, a new baseline, and new
holdouts.
