# Waterways and participatory programs

Status: developing knowledge cluster, not selected for website projection.

This cluster preserves public evidence and open questions about Jamie's early
participatory practice across galleries, domestic spaces, river expeditions,
and river-city public programs. It does not assume that every project used the
same method or produced the same result.
...
## Atomic claims retained

- `CLM-WATERWAYS-RAFT-IDEA-2007`
- `CLM-WATERWAYS-GREAT-ACCOMMODATIONS-ROLE-2009`
- `CLM-WATERWAYS-GREAT-ACCOMMODATIONS-OUTREACH-2009`
...
- `CLM-WATERWAYS-PARTICIPATORY-PRACTICE-2006-2009`

The final item is explicitly an inference across sources. It describes a
recurring practice of building bounded situations in which other people could
contribute art, stories, social relations, and interpretation. It is not a
claim of uniform impact.
...
- Locate public-safe programs, photographs, route logs, participant accounts,
  and collaborator credit.
- Distinguish Jamie's initiating, facilitating, technical, and collaborative
  roles project by project.

## Editorial position

These records deepen the bank's account of Jamie as a participatory systems
builder. They remain unsurfaced while the site is composed for current job
applications. A later editorial pass may select a small number of claims when
they clarify role fit better than the material already on the site.
