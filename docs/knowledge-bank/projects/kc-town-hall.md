# KC Town Hall knowledge-bank note
...
- 183 profile-reported posts
- 181 distinct account items recovered
- 2 profile-reported items not recovered
- 155 authored posts
- 26 reposts
- 7 separately rendered public conversation records, excluded from the account-post denominator
- Public range: July 2, 2018 through September 24, 2022

The pass therefore accounts for the full reported population without claiming that the two inaccessible items were recovered.

## Recovered project pages

Wayback recovery strengthened the internal-link layer:

- the [August 2018 root page](https://web.archive.org/web/20180803002431/http://kctownhall.com/) preserves the historic-neighborhood-resource purpose
- the [August 2019 join page](https://web.archive.org/web/20190813025929/http://kctownhall.com/join/) preserves the public participation invitation
- the [October 2020 Tired of Tires page](https://web.archive.org/web/20201030223311/http://kctownhall.com/tires/) identifies Julia and Jamie as authors and KC Town Hall with Oak Park Neighborhood Association as program partners
- a [November 2020 root-page capture](https://web.archive.org/web/20201106221214/http://kctownhall.com/) preserves cards for survey, COVID-19, and temporary-electricity pages whose bodies were not directly recovered in this pass

The Tired of Tires page repeats a project savings figure. That is corroborated project documentation, not independent verification.

## Mission-relevant patterns

The governed corpus records:

- 99 authored posts documenting or coordinating Tired of Tires activity
- 12 authored posts matching survey-and-listening language
- 11 authored posts preserving building-history or adaptive-reuse context
- 12 authored posts in a June 6, 2020 Black Lives Matter Kansas City Hall documentation series
- smaller public-resource patterns concerning grocery access, COVID-19 relief, voting, affordable housing, and neighborhood service response

These are pattern counts in shared project-account output. They do not establish the individual author of each post, program causation, survey representativeness, completed redevelopment, or Jamie's responsibility for later operations.

## Public civic dialogue

Seven public conversation records were recovered separately from the account-post denominator. Under a strict incoming-interaction rule, they support a lower bound of:

- three then-sitting Kansas City Council-member accounts visibly replying to or quote-posting KC Town Hall: Melissa Robinson, Jolie Justus, and Quinton Lucas
- one visible KCMO 311 reply in a neighborhood-service thread

Outbound mentions and tags are excluded. The finding documents public dialogue, not endorsement, policy causation, complete stakeholder participation, or completed service resolution.

## Source circulation

The 155 authored posts contain 130 outgoing-link occurrences across 115 posts: 119 point to KC Town Hall destinations and eleven to external destinations. Mission-relevant sources appraised in this pass include:

- [KCUR's 2018 Missouri primary guide](https://www.kcur.org/politics-elections-and-government/2018-08-05/a-cheat-sheet-for-tuesdays-primary-election-in-missouri)
- the [Missouri Secretary of State voter lookup](https://voteroutreach.sos.mo.gov/portal)
- [Northeast News reporting on Kansas City affordable-housing proposals](https://northeastnews.net/pages/affordable-housing-policy-hits-docket-kcmo/)
- a [KC Town Hall dumped-latex-paint video](https://www.youtube.com/watch?v=PmLjLyOpS9I)
- a [KC Town Hall COVID-19 relief-resource video](https://www.youtube.com/watch?v=onCKU-TuPhc)
- RideKC transit context
- a Kansas City Star Leon's Thriftway article lead whose body was not recovered
- a dead GoFundMe source lead
- two Facebook source leads not close-read in this pass

Linking a source documents circulation, not authorship, agreement, reach, uptake, or caused outcomes. Dead or inaccessible pages remain leads rather than substantive evidence.
...
Keep these out of accomplishment messaging until stronger evidence arrives:

- visible engagement totals, which are dated and volatile
...
1. Recover or continue to disclose the two-item population gap.
