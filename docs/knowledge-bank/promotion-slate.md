# Editorial Promotion Slate

This slate helps a future editor distinguish knowledge-bank depth from current
website selection. It is a recommendation, not publication approval.
...
- `CLM-NYCAC-OFFICE-NIGHTLIFE-ACCOUNTABILITY`: selected for post-creation
  recommendations, an announced invitation to public dialogue, and Jamie's
  later liaison request.
- `CLM-NYCAC-TALKS-NOT-RAIDS-TESTIMONY`: selected as direct, official-record
  evidence of Jamie's public advocacy.
- `CLM-NYCAC-MARCH-TRANSPARENCY-LAW`: selected as the documented legislative
...
- `CLM-WATERWAYS-GREAT-ACCOMMODATIONS-PROGRAM`: Jamie's spearheading,
  ...
  cultural-systems case study after visual rights review.
- `CLM-OPEN-HOUSE-PARTICIPATORY-DESIGN`: Jamie's initiating and tending role is
