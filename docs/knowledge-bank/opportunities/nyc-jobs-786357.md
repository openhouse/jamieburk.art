---
id: opportunity.nyc-jobs.786357
title: "OFFICE OF THE MAYOR - Deputy Chief of Staff"
kind: opportunity
status: maintained
...
canonical_path: docs/knowledge-bank/opportunities/nyc-jobs-786357.md
summary: "Strong-match NYC Jobs discovery candidate: Deputy Chief of Staff at OFFICE OF THE MAYOR."
canonical_url: https://cityjobs.nyc.gov/jobs?options=&page=1&q=786357
...
salary_maximum: 125000
positions: 1
fit_score: 90
securability_score: 75
combined_score: 84.3
...
discovery_terms:
  ...
  - public-service
hard_screens:
  - id: screen.nyc-jobs.786357.civil-service-and-posting
    ...
    disposition: verify
role_requirements:
  - id: requirement.nyc-jobs.786357.delivery
    importance: critical
    kind: capability
...
confirmed_facts:
  ...
  - The recorded annual salary range is $125,000 to $125,000.
...
This automatically admitted intake opportunity comes from the official NYC Jobs open-data feed. Its fit score (90), securability score (75), and combined score (84.3) clear the configured strong-match gate.
