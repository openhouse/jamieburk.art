---
id: opportunity.nyc-jobs.787600
title: "OFFICE OF CRIMINAL JUSTICE - Technical Project Manager"
kind: opportunity
status: maintained
...
canonical_path: docs/knowledge-bank/opportunities/nyc-jobs-787600.md
summary: "Strong-match NYC Jobs discovery candidate: Technical Project Manager at OFFICE OF CRIMINAL JUSTICE."
canonical_url: https://cityjobs.nyc.gov/jobs?options=&page=1&q=787600
source_type: official-employer
opportunity_status: live
application_status: not-recorded
posted_until: 2026-09-20
verified_at: 2026-08-21
job_id: "787600"
salary_minimum: 68213
salary_maximum: 100000
positions: 1
fit_score: 100
securability_score: 78
combined_score: 91.6
...
discovery_terms:
  ...
  - public-service
hard_screens:
  - id: screen.nyc-jobs.787600.civil-service-and-posting
    ...
    state: review-needed
    disposition: verify
  - id: screen.nyc-jobs.787600.salary-floor
...
role_requirements:
  - id: requirement.nyc-jobs.787600.delivery
    importance: critical
    kind: capability
...
confirmed_facts:
  ...
  - The recorded annual salary range is $68,213 to $100,000.
  - The dataset records 1 position and a 2026-09-20 deadline.
inferences:
...
This automatically admitted intake opportunity comes from the official NYC Jobs open-data feed. Its fit score (100), securability score (78), and combined score (91.6) clear the configured strong-match gate.
