---
id: opportunity.protected.source-backed-memory-consulting.2026
title: Protected source-backed team-memory consulting lead
kind: opportunity
...
hard_screens:
  ...
  - id: screen.protected-memory.explicit-acceptance
    text: A direct acceptance and agreed scope are required before describing this as client work.
    state: unknown
    disposition: conditional
role_requirements:
  - id: requirement.protected-memory.knowledge-friction
    importance: critical
    kind: capability
    text: Identify where ideas, decisions, context, and onboarding knowledge are being lost.
    wiki_evidence:
  ...
  - id: requirement.protected-memory.human-review
    importance: critical
    kind: capability
    text: Keep AI-assisted memory inspectable, correctable, and governed by human review.
    wiki_evidence:
      - method.source-backed-team-memory
    public_evidence:
      - route: /lab/source-backed-team-memory
        needle: Human review is part of the system
  ...
  - id: requirement.protected-memory.focused-sprint
    ...
    public_evidence:
      - route: /lab/source-backed-team-memory
        needle: Discuss a focused source-backed memory sprint
    status: visible-qualified
