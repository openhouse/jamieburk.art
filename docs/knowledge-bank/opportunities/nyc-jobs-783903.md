---
id: opportunity.nyc-jobs.783903
title: "CONSUMER AND WORKER PROTECTION - Senior Business Analyst/Project Manager"
kind: opportunity
status: maintained
...
discovery_terms:
  ...
  - public-service
hard_screens:
  - id: screen.nyc-jobs.783903.civil-service-and-posting
    ...
    state: review-needed
    disposition: verify
  - id: screen.nyc-jobs.783903.salary-floor
...
role_requirements:
  - id: requirement.nyc-jobs.783903.delivery
    importance: critical
    kind: capability
...
confirmed_facts:
  ...
  - The recorded annual salary range is $75,443 to $130,000.
  - The dataset records 1 position and a 2026-08-23 deadline.
inferences:
...
This automatically admitted intake opportunity comes from the official NYC Jobs open-data feed. Its fit score (100), securability score (63), and combined score (85.9) clear the configured strong-match gate.
