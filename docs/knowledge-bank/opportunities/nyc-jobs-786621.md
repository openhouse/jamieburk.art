---
id: opportunity.nyc-jobs.786621
title: "CONSUMER AND WORKER PROTECTION - Business Analyst / Project Manager"
kind: opportunity
status: maintained
...
canonical_path: docs/knowledge-bank/opportunities/nyc-jobs-786621.md
summary: "Strong-match NYC Jobs discovery candidate: Business Analyst / Project Manager at CONSUMER AND WORKER PROTECTION."
canonical_url: https://cityjobs.nyc.gov/jobs?options=&page=1&q=786621
source_type: official-employer
opportunity_status: live
application_status: not-recorded
posted_until: 2026-09-14
verified_at: 2026-08-21
job_id: "786621"
salary_minimum: 68214
salary_maximum: 130000
positions: 1
fit_score: 100
securability_score: 73
combined_score: 89.7
...
discovery_terms:
  ...
  - public-service
hard_screens:
  - id: screen.nyc-jobs.786621.civil-service-and-posting
    ...
    state: review-needed
    disposition: verify
  - id: screen.nyc-jobs.786621.salary-floor
...
role_requirements:
  - id: requirement.nyc-jobs.786621.delivery
    importance: critical
    kind: capability
...
confirmed_facts:
  ...
  - The recorded annual salary range is $68,214 to $130,000.
  - The dataset records 1 position and a 2026-09-14 deadline.
inferences:
  - The deterministic model found 8 Jamie-relevant signal families and admitted the role above the strong-match threshold.
unknowns:
...
This automatically admitted intake opportunity comes from the official NYC Jobs open-data feed. Its fit score (100), securability score (73), and combined score (89.7) clear the configured strong-match gate.
