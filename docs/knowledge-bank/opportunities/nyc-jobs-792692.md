---
id: opportunity.nyc-jobs.792692
title: "OFFICE OF THE MAYOR - Policy Analyst for Budget, Finance, and Labor"
kind: opportunity
status: maintained
...
canonical_path: docs/knowledge-bank/opportunities/nyc-jobs-792692.md
summary: "Strong-match NYC Jobs discovery candidate: Policy Analyst for Budget, Finance, and Labor at OFFICE OF THE MAYOR."
canonical_url: https://cityjobs.nyc.gov/jobs?options=&page=1&q=792692
...
discovery_terms:
  ...
  - technical-systems
hard_screens:
  - id: screen.nyc-jobs.792692.civil-service-and-posting
    ...
    disposition: verify
role_requirements:
  - id: requirement.nyc-jobs.792692.delivery
    importance: critical
    kind: capability
...
confirmed_facts:
  ...
  - The recorded annual salary range is $110,000 to $110,000.
...
# Policy Analyst for Budget, Finance, and Labor

This automatically admitted intake opportunity comes from the official NYC Jobs open-data feed. Its fit score (86), securability score (85), and combined score (85.6) clear the configured strong-match gate.
