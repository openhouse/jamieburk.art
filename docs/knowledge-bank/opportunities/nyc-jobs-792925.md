---
id: opportunity.nyc-jobs.792925
title: "CAMPAIGN FINANCE BOARD - Associate Director of Policy Implementation"
kind: opportunity
status: maintained
...
canonical_path: docs/knowledge-bank/opportunities/nyc-jobs-792925.md
summary: "Strong-match NYC Jobs discovery candidate: Associate Director of Policy Implementation at CAMPAIGN FINANCE BOARD."
canonical_url: https://cityjobs.nyc.gov/jobs?options=&page=1&q=792925
source_type: official-employer
opportunity_status: live
application_status: not-recorded
posted_until: 2026-10-13
verified_at: 2026-08-20
job_id: "792925"
salary_minimum: 125000
salary_maximum: 135000
positions: 1
fit_score: 98
securability_score: 70
combined_score: 87.4
...
discovery_terms:
  ...
  - public-service
hard_screens:
  - id: screen.nyc-jobs.792925.civil-service-and-posting
    ...
    disposition: verify
role_requirements:
  - id: requirement.nyc-jobs.792925.delivery
    importance: critical
    kind: capability
...
confirmed_facts:
  ...
  - The recorded annual salary range is $125,000 to $135,000.
  - The dataset records 1 position and a 2026-10-13 deadline.
inferences:
  - The deterministic model found 7 Jamie-relevant signal families and admitted the role above the strong-match threshold.
unknowns:
...
# Associate Director of Policy Implementation

This automatically admitted intake opportunity comes from the official NYC Jobs open-data feed. Its fit score (98), securability score (70), and combined score (87.4) clear the configured strong-match gate.
