---
id: opportunity.nyc-jobs.779597
title: "OFFICE OF THE MAYOR - Co-Governance Project Coordinator"
kind: opportunity
status: maintained
...
canonical_path: docs/knowledge-bank/opportunities/nyc-jobs-779597.md
summary: "Strong-match NYC Jobs discovery candidate: Co-Governance Project Coordinator at OFFICE OF THE MAYOR."
canonical_url: https://cityjobs.nyc.gov/jobs?options=&page=1&q=779597
...
discovery_terms:
  ...
  - technical-systems
hard_screens:
  - id: screen.nyc-jobs.779597.civil-service-and-posting
    ...
    state: review-needed
    disposition: verify
  - id: screen.nyc-jobs.779597.salary-floor
...
role_requirements:
  - id: requirement.nyc-jobs.779597.delivery
    importance: critical
    kind: capability
...
confirmed_facts:
  ...
  - The recorded annual salary range is $90,000 to $110,000.
  - The dataset records 1 position and a 2026-09-14 deadline.
inferences:
  - The deterministic model found 6 Jamie-relevant signal families and admitted the role above the strong-match threshold.
unknowns:
...
# Co-Governance Project Coordinator

This automatically admitted intake opportunity comes from the official NYC Jobs open-data feed. Its fit score (92), securability score (78), and combined score (86.7) clear the configured strong-match gate.
