...
This folder is the public-safe source of truth for how the portfolio represents
Jamie Burkart's work.
...
- a legal record;
- an evidence dump;
- a public proof browser.

Protected evidence stays outside Git and outside the Docker context.

## Core Rules

Do not make the reader decode Jamie.

The public site may use only Ready or carefully bounded public-safe claims from
this bank.
