---
wiki_record: true
id: timeline.art-life-waterways-media-archaeology.2003-2011
title: Art, life, waterways, and media archaeology, 2003-2011
kind: timeline
status: maintained
...
This timeline restores an artistic and intellectual lineage that the current
hiring frame can otherwise flatten. It records documented projects and
...
| --- | --- | --- |
| 2003-2005 | Shop Shows | Good Times described open, often potluck exhibitions in Jamie's shared residence where participants brought works, performances, scripts, films, and unfinished material. The article is a retrospective source, not a complete event census. |
| April 2006 | Open House | Good Times documented a ten-day Porter Bridge Gallery experiment in communal living, open participation, shared responsibility, and reflexive documentation, with Jamie instigating and continuously tending the space while rejecting sole leadership. |
| July 2006 | Time is Long | Cool Hunting documented Jamie's extended-VHS installation returning visitors' recorded images on another monitor after an approximately twenty-minute tape path. It supports behavior and authorship, not audience scale or reception. |
...
- What happens when a gallery becomes a household, workshop, public meeting, or
  live record rather than a container for finished objects?
- How can a technical system let participants perceive themselves in relation
  to other people, places, and time?
- What kinds of tending, facilitation, repair, and documentation allow an open
  situation to remain inhabitable?
- How can a river, a room, a tape path, or a text-message system become a social
  information space?
...
raft report, and Charlotte Street's Great Accommodations program page were
reopened and read against the current canonical claims. The direct Wayback
...
creative-technical practice. It does not authorize participant photographs,
private messages, source footage, or installation documentation. Collaborator
credit, rights, and consent travel with every future projection.
