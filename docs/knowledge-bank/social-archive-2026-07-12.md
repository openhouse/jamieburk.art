# Project Social Archive Inventory
...
- Checked live project sites for canonical social links and shared-account use.
- Inspected a bounded rendered capture of the CallNYC profile and recovered
  public post URLs from its link annotations. The source file remains outside
  the repository.
...
- Read the City of New York's CreateNYC Twitter-data appendix and published
  reporting that reproduced Council-member posts.
...
- [CreateNYC convening and cultural-planning participation in 2017](https://x.com/NYCArtC/status/847855360614563842).
- [Cabaret Law repeal in 2017](https://x.com/NYCArtC/status/926538867146149888).
- [Talks Not Raids public action in 2019](https://x.com/NYCArtC/status/1169388006844829696).
...
coalition account with gathering a large crowd for a DIY-spaces discussion.
[Brooklyn Daily Eagle reporting](https://brooklyneagle.com/67628/brooklyn-political-roundup-march-28-nixon-visits-nycha-in-crown-heights-with-adams/)
reproduces Rafael Espinal publicly describing joint work with @NYCArtC.

## Source Discovery

All 193 unique short links in the readable @NYCArtC corpus resolved. The pass
identified 59 distinct non-campaign external resource destinations across 42
domains. Significant recovered sources include:

- [City Limits on commercial rent stabilization during COVID-19](https://citylimits.org/citys-small-businesses-need-rent-stabilization-to-survive-covid-19-advocates-say/).
- [BuzzFeed News on gentrification, noise complaints, and enforcement](https://www.buzzfeednews.com/article/lamvo/gentrification-noise-complaints-police).
- [Gothamist on Book Culture's commercial-rent crisis](https://gothamist.com/news/uws-book-culture-seized-by-city-marshal-over-unpaid-rent).
- [Eater on the threatened closure of Neir's Tavern](https://ny.eater.com/2020/1/9/21058579/neirs-tavern-closed-nyc).

This pattern supports a bounded claim: the shared account connected campaign
action to reporting, government records, hearings, grants, and public resources.
...
- Named collaborator stewardship should be added only with direct confirmation.
