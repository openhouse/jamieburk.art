...
claims without confusing individual contribution, shared production, coalition
action, public testimony, institutional authorship, or legislative enactment.

## Governing rule

Every mature contribution relation must name:

- the actor or actors;
- the bounded action;
- the object of the action;
- the purpose and usable result;
- the credit scope;
- supporting claims and public sources;
- the boundary that prevents overstatement.

Advocating, organizing, speaking, or testifying must never be silently rewritten
as authoring legislation, enacting a law, or solely causing a collective outcome.

## Resolved contribution field

| Project | Actor | Supported action | Result and boundary |
| --- | --- | --- | --- |
| Waterways raft | Jamie | Originated the expedition | Public sources trace the recycled-material expedition from Kansas City across Missouri and later to salt water; the exact terminus and collective crew history remain open. |
| Great Accommodations | Jamie | Spearheaded the 2009 project | The project used waterways as social infrastructure through outreach, installations, public programs, facilitation, and working documentation; participant outcomes remain collective. |
| Open House | Jamie | Initiated the ten-day gallery experiment | Jamie opened the framework; the activity and governance became collective. |
| Open House | Participants | Co-governed the space | Participants shared operating decisions and multi-perspective documentation; the article is not permission to republish participant detail. |
| Shop Shows | Jamie and housemates | Co-created open shows | Housemates, artists, and visitors share credit for the participatory program. |
| NYC Artist Coalition | Jamie | Was described as a founding member and organizer | The founding-member wording is attributed to NPR and does not imply sole founding or sole leadership. |
| NYC Artist Coalition campaign sites | Jamie | Implemented and maintained the campaign web repositories | Retained Git history establishes repository-level implementation for FairRentNYC, Talks Not Raids, Let NYC Dance, and the coalition site's Ghost deployment; policy, copy, data, design, participation, and outcomes remain collectively bounded. |
| DIY-venue safety | Jamie | Organized fire-code study groups | Reporting establishes the groups and Jamie's safety analysis, not their full curriculum, attendance, or long-term effects. |
| Cabaret Law | Jamie | Rallied and advocated for repeal | This is direct individual contribution inside a broad collective campaign, not legislative authorship or sole causation. |
| Cabaret Law | Jamie | Testified before the Council | Reporting establishes his testimony and analysis, not the causal weight of that testimony. |
...
- **Waterways terminus and full program inventory:** salt water and several
  public-program forms are supported; the exact route, full crew, complete
  program set, and outcomes remain under research.

An unresolved relation is not absent from the knowledge system. It remains an
inquiry until evidence supports a bounded promotion.
