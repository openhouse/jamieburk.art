...
- Served as a founding member and organizer of NYC Artist Coalition and directly implemented and maintained campaign websites for cultural-space advocacy.
...
- Co-built and operated WOWList.org, a natural-language community-calendar platform across 35 city ecosystems, supporting local organizers who used it to run calendars, websites, and email lists for their own scenes.
