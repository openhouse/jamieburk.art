...
- Created repeatable hosting, onboarding, facilitation, documentation, and continuity systems across 300+ gatherings and 20+ resident artists. Public event pages document the 100th dinner, an eight-week New York City rotation, and a civic sign-making potluck. A protected ledger contains 345 numbered gathering columns; the workbook's own summary records 2,783 meals served through March 2021, while a separate aggregate audit found a small unreconciled difference. The 20+ resident aggregate retains separate source work.
...
- Co-led adaptive reuse planning and public-benefit documentation for a project that won City Council approval and appropriation of $490,539 in CCED funding; the money was not ultimately disbursed.
