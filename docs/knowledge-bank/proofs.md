...
This file summarizes public-safe proof posture. The canonical machine-readable claim bank is `apps/www/src/data/knowledge-bank/claims.json`; `apps/www/src/data/proofs.ts` is its backward-compatible public projection. The canonical human-readable claim register is `docs/knowledge-bank/claims.md`.
...
- Independently built CallNYC.org after participating in a January 2016 New York City Council constituent-services hackathon at Civic Hall, translating CouncilStat records into resident-facing next-step guidance.
