...
Date: July 15, 2026  
Operator: Codex, using Jamie Burkart's authenticated Chrome session  
Account: `@CallNYCapp`
...
The separate authenticated stakeholder-response audit recovered **at least 20
serving Council members** whose accounts visibly reposted, replied to,
quote-posted, named, or linked CallNYC. Nineteen identities appeared in public
repost lists, and Ydanis Rodriguez's separate quote post added one person to the
union. Eight members authored posts or replies explicitly involving CallNYC.
Keeping these numbers separate avoids turning targeted outreach into reciprocal
uptake.
...
- Politico-backed filtering, communication-channel, sharing, and discovery
  decisions;
- the separate lower bound of 20 Council members who visibly engaged back,
  including eight who authored posts or replies involving CallNYC.
