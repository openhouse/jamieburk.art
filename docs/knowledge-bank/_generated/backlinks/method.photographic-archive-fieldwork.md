...
- [Recover the context of a CallNYC interface-in-use photograph](../../research-inquiries/callnyc-interface-photo-oral-history.md) - `uses_method` (frontmatter)
- [First field and website-shortlist close reading](../../research-runs/photography-first-field-close-reading-2026-07-26.md) - `uses_method` (frontmatter)
