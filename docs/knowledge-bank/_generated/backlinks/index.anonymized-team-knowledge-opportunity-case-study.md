...
# Backlinks to Anonymized Team-Knowledge Opportunity Case Study
...
- [Jamie's Perspective](../../case-studies/anonymized-team-knowledge-opportunity/02-jamie-perspective.md) - `related_to` (frontmatter)
- [The Prospective Sponsor's Perspective](../../case-studies/anonymized-team-knowledge-opportunity/01-prospective-sponsor-perspective.md) - `related_to` (frontmatter)
...
- [Protected source-backed memory opportunity — metadata boundary](../../sources/protected-source-backed-memory-opportunity.md) - `related_to` (frontmatter)
