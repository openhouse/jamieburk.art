---
id: source.project-websites.live-check.2026-08-14
title: Jamie Burkart project websites live check
kind: source
status: maintained
...
The count includes a distinct public project home only when the Knowledge Wiki
has both a project record and a public-safe basis for Jamie's build,
implementation, maintenance, or systems-lead contribution. Shared and
collective work stays shared. The inventory does not claim sole authorship.
