...
**Structured claim IDs:** `CLM-NTERCHNG-COLLABORATIVE-INSTALLATION-2011`, `CLM-NTERCHNG-AMERICA-NOW-AND-HERE-2011`, `CLM-NTERCHNG-REINSTALLATION-OPERATIONS-2011`, `CLM-TIME-IS-LONG-INTERACTIVE-VHS-2006`, `CLM-SORTED-AUDIO-MAX-MSP-2013`, `CLM-MATMOS-CONSUMING-FLAME-PARTICIPANT-2020`
...
**Detailed public-safe wording:** Archived project and exhibition records document Jamie's collaboration with Drew Bolton and Garrett Fuselier on NTER CHNG, which joined software, gallery architecture, and audience text messages in a public group exchange. A protected 2011 installer plan names Jamie in the collaborative preparation schedule and shows a maintained production spanning software revision, hosting, display hardware, networking, architectural installation, gallery tuning, and teardown without assigning those workstreams individually. Additional dated records document Jamie's 20-minute VHS delay installation Time is Long and a Max/MSP experiment that reordered audio segments by pitch. A community-maintained Discogs release record lists him among the participants on Matmos's 99-contributor album The Consuming Flame; the official label page establishes the collaborative album context but does not individually name Jamie.
...
**Guardrail:** Keep each contribution at the precision of its source, preserve NTER CHNG's three-person credit, distinguish planned workstreams from completed tasks, and do not convert participation into individual task ownership, event organization, unspecified production credit, or sole authorship.
**Do not say:** Jamie solely created, programmed, designed, fabricated, installed, hosted, or produced NTER CHNG; every installer-plan task was completed; NTER CHNG was presented at the Nerman Museum; Jamie organized BAP Lab; the Max/MSP experiment was a production product; Jamie produced or composed the Matmos album; the reviewed records identify Jamie's specific Matmos contribution.
**Protected boundaries:** Source-document links, unapproved historical participants, participant messages or telephone numbers, personal scheduling and location details, uncleared event photographs or video, unrecovered source code, and unverified track-level credits stay offline.
**Review owner:** Jamie
**Last reviewed:** 2026-07-15
