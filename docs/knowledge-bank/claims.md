...
**2026-07-15 NYC Artist Coalition Facebook event population pass**

- `CLM-NYCAC-FACEBOOK-EVENT-POPULATION` reconciles the capture-date 34-slot
  control as 33 recovered event records plus one unresolved historical slot.
- `CLM-NYCAC-PARTICIPATION-SYSTEM` selects one attributed case-study claim:
  Jamie reports that he helped establish and produce the recurring event and
  participation system while event and policy outcomes remain collective.
- `CLM-NYCAC-FACEBOOK-EVENT-RESPONSE-SIGNALS` retains dated response labels only
  as held interface signals, never attendance, unique people, reach, or impact.
...
- `CLM-NYCAC-FACEBOOK-EVENT-STAKEHOLDER-INTERFACES` records cross-sector
  organizer, cohost, and venue displays without converting an event-level
  interface into endorsement, attendance, continuing partnership, or impact.
...
# 2026-07-12 portfolio-history maturation pass

The following public-source-backed claims have matured in the canonical typed
bank. Their website projections remain **held** while the site-level argument,
available imagery, and remaining role-attribution inquiries are evaluated.
...
**Status:** Careful
**Support level:** Strong
**Public wording:** As a founding member of NYC Artist Coalition, organized fire-code study groups, rallied at City Hall, and spoke publicly for Cabaret Law repeal inside the broader Let NYC Dance coalition.
**Guardrail:** Repeal was a collective accomplishment with decades of prior advocacy.
**Canonical claim:** `CLM-NYCAC-CABARET-ADVOCACY`.

### nyc-artist-coalition-office-nightlife-town-hall
...
### talks-not-raids-advocacy

**Status:** Careful
**Support level:** Strong
**Public wording:** Testified before the New York City Council for Talks Not Raids, describing NYC Artist Coalition's safety work and calling for transparency and engagement around M.A.R.C.H. operations.
**Guardrail:** Elected sponsors and collective advocates retain credit for the legislation.
**Canonical claim:** `CLM-TALKS-NOT-RAIDS-ADVOCACY`.

### march-transparency-to-cure
...
**Public wording:** Jamie reports that he helped establish and produce NYC Artist Coalition's recurring participation system across rotating cultural-space meetings, practical support sessions, public actions, hearings, and relief convenings.
...
**Guardrail:** Keep Jamie's broad production role attributed; preserve collective authorship and never convert Facebook response labels into attendance or impact.
...
**Public wording:** Supported KC Spaces Fund, a 2020 Kansas City mutual-aid campaign for grassroots arts and culture spaces, through campaign web infrastructure and an available cross-channel project identity.
...
**Guardrail:** Treat the source as AI-assisted archival review, not a human collaborator testimonial. Use bounded technical, identity, and operational support language only.
**Do not say:** Jamie organized KC Spaces Fund; Jamie managed or posted from the KC Spaces Fund Facebook Page; Jamie alone named KC Spaces Fund; Jamie ran the fundraiser; Jamie made grant decisions; Jamie was the fiscal sponsor; a human collaborator provided this testimonial.
...
**Canonical claims:** `CLM-KCSPACES-SOCIAL-GRANTEE-DOCUMENTATION` and `CLM-KCSPACES-CROSS-CHANNEL-DIGITAL-SUPPORT`.
