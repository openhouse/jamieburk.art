...
**Public wording:** Built CallNYC.org in 2016 as an independent follow-on project translating CouncilStat constituent-services records into resident-facing next-step guidance.
**Detailed public-safe wording:** CallNYC turned CouncilStat constituent-services records into issue pathways, district context, and archived resident-facing guidance while making its unofficial status clear; Politico New York covered the project in 2016.
...
**Do not say:** Built during the hackathon; formal hackathon submission; commissioned by the Council; current city service; official city guidance; emergency guidance; legal guidance.
