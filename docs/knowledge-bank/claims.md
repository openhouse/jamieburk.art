...
**Public wording:** Built CallNYC.org after the New York City Council's first CouncilStat hackathon, translating constituent-services open data into resident-facing next-step guidance.
...
**Guardrail:** Always describe it as archived and unofficial. Use "first CouncilStat hackathon" only with the Council source; do not broaden it into a first-hackathon claim.
**Do not say:** Current city service; official city guidance; emergency guidance; legal guidance; broad first-hackathon claims.
