...
**Guardrail:** Keep private finance, legal, ownership, partner, and property details offline.  
**Do not say:** Current property status; private finance details; private ownership details; private partner details; official municipal endorsement beyond the public record.  
**Protected boundaries:** Private finance, legal, ownership, partner, property, banking, and stakeholder details stay offline.  
**Review owner:** Jamie  
**Last reviewed:** 2026-07-07
...
**Public wording:** Source-Backed Team Memory is a lab / method for helping knowledge-heavy teams preserve decisions, open questions, source-linked notes, onboarding context, and next steps without turning AI into an unreviewed authority.  
...
**Guardrail:** Not a finished SaaS. Not a chatbot. Not a private archive browser. Not surveillance. Not a replacement for human judgment. Not an autonomous publishing system.  
**Do not say:** Built a production AI memory platform for a client; automated trust; replaces human review; autonomously publishes private archive material.  
