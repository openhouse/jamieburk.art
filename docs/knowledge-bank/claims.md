...
**Support level:** Careful  
**Evidence class:** Approved resume / public-safe archive summary / firsthand-collaborator context  
**Public wording:** Co-built WOWList.org, a Django, PostgreSQL/PostGIS, and Ember community-calendar platform whose July 2017 production snapshot recorded 1,846 users, 16,142 posts/events, and 35 city-region keys with at least 50 posts.  
...
**Guardrail:** Describe the 35 city-region figure as database activity, not adoption or official chapters.  
**Do not say:** Adopted in 35 cities; official chapters in 35 cities; full ownership of all organizer adoption; current active platform unless confirmed.  
