...
**Support level:** Careful  
**Evidence class:** Approved resume / public-safe archive summary / firsthand-collaborator context  
**Public wording:** Co-built WOWList.org, a Django, PostgreSQL/PostGIS, and Ember community-calendar platform for DIY arts and music organizers, with activity across roughly 35 city ecosystems.
...
**Guardrail:** Keep documented organizer use separate from aggregate geographic activity, and do not describe city activity as official chapters.
...
**Guardrail:** Distinguish the proposal, Board recommendation, Council acceptance, appropriation, May 2022 interim status, municipal withdrawal, and Jamie-confirmed transition. The municipal record does not prove the transition. Do not generalize the dated no-disbursement status beyond its reporting point or imply an executed funding agreement, completed construction, sole causality, fault, a transfer of public funds or property, the receiving organization's identity, or current operation.
**Do not say:** Final funding received; a funding agreement was executed; the appropriation was paid or disbursed; Jamie alone caused the Council action; the redevelopment was completed; the project remains active under the award; the City record documents the transition; public funds, real property, or project assets were transferred to the organization; the receiving organization currently operates the project; why the transition occurred; current property status; private financial details; official municipal endorsement beyond the public record.
...
## nter-chng-participatory-installation - Participatory software and spatial installation
