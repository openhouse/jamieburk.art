...
**Public wording:** Independently built CallNYC.org in 2016 as an archived civic-data prototype translating CouncilStat / constituent-services open data into resident-facing issue pathways and next-step guidance.
**Detailed public-safe wording:** CallNYC turned open constituent-services data into issue pathways, district context, and archived resident-facing guidance while making its unofficial status clear; public sources include March 2016 Politico New York coverage and the Openhouse CallNYC repository.
...
**Guardrail:** Always describe it as archived, unofficial, and independent; do not treat CouncilStat counts as simple office-performance metrics.
**Do not say:** Current city service; official city guidance; emergency guidance; legal guidance; documented formal hackathon submission; simple performance ranking.
**Protected boundaries:** No current-service claims, private user data, unverified guidance, participant identities, private photo files, or raw photo metadata.
**Review owner:** Jamie
