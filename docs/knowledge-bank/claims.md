...
**Guardrail:** This is a current-interface control, not an official Meta export or every event ever associated with Jamie.
...
## jamie-facebook-hosted-event-population - Hosted-event population accounting
...
**Where to project:** Knowledge-bank archive note only.
**Why it matters:** Preserves a complete control-slot accounting without silently erasing or inventing the missing record.
...
**Public wording:** Twenty recovered Facebook event pages hosted by Jamie from 2006 through 2017 document recurring structures for cultural production, hospitality and care, participatory place and water work, civic learning and making, and networked public culture.
...
**Guardrail:** The primary forms are interpretive; preserve collaborators, performers, venues, and participants; do not convert page or response counts into impact.
