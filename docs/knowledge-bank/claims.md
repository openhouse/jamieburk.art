...
**Public wording:** Participated in a New York City Council constituent-services workshop, then independently translated the published CouncilStat dataset into CallNYC.org, a resident-facing civic prototype with explicit limits on what the records could responsibly support.
**Detailed public-safe wording:** CallNYC reorganized constituent-service records into issue-oriented pages and office contact paths while making the limitations of inconsistent administrative records explicit. Structured citation records preserve the 2016 event history, public sources, qualifications, corrections, and protected boundaries.
