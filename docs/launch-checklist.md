...
- [ ] `npm run build`
- [ ] `npm run check`
- [ ] `npm run production-safety` has no blockers before production indexing.
...
- [ ] `docs/knowledge-bank/claims.json` has been reviewed as the public-safe source of professional accomplishment claims.
- [ ] `docs/knowledge-bank/approval-register.md` has been reviewed.
