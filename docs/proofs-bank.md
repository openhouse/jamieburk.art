...
| `nycac-cofounding-cultural-space-fieldwork` | Strong | Co-founding NYC Artist Coalition member supporting cultural-space fieldwork, campaign memory, and coalition operations. | Jamie-approved role framing, public-safe review, and firsthand operational record. | Does not imply Jamie is sole leader, sole spokesperson, sole policy author, or sole cause of coalition outcomes. |
| `nycac-public-advocacy-lineage` | Bounded | NYC Artist Coalition has participated in public advocacy around cultural-space safety, Cabaret Law repeal, Office of Nightlife engagement, MARCH transparency, COVID-era venue survival, and commercial rent stabilization. | Public coalition materials, public records, and public-safe narrative review. | Use collective-work language; do not overclaim causation, authorship, or representational authority. |
| `fairrent-current-work-lanes` | Bounded | As of May/June 2026, Jamie's FairRentNYC / NYC Artist Coalition work centers on CRS, public-data framing, legal-question tracking, cultural-space follow-up, and coalition operating structure. | Public-safe review of current-work summaries and firsthand operational record. | Date-bound claim only; no private partner lists, live strategy, raw notes, legal-review detail, or unapproved meeting context. |
