...
ARG NEXT_PUBLIC_CONTACT_EMAIL=jamie.burkart@gmail.com
ARG NEXT_PUBLIC_LINKEDIN_URL=https://linkedin.com/in/jamie-burkart
ARG NEXT_PUBLIC_GITHUB_URL=https://github.com/openhouse
ENV APP_ENV=$APP_ENV
