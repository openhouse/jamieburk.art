...
> **Repository note**
>
> This project uses Ember-inspired **Requests for Comments (RFCs)** as durable,
> reviewable design records for substantial cross-system changes. Jamie
> authorized implementation of RFC 0003 on July 26, 2026; human publication,
> rights, consent, and indexing gates remain separate.
>
> This proposal complements, rather than supersedes,
> [RFC 0002: Photography Archive Curation and Public Projection](./0002-photography-archive-curation-and-projection.md).
...
> **Implementation adaptation, July 26, 2026**
>
> Jamie selected the frozen `features/layout-A` branch as the implementation
> donor. Layout A does not contain the Layout C East River hero described below.
> The Phase 1 implementation therefore governs Layout A's existing Council
