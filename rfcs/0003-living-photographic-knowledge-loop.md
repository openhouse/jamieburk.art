...
implementation: feature/photo-knowledge-E
supersedes: []
superseded_by: null
---
...
> authorized implementation of this RFC in `feature/photo-knowledge-E` on
> 2026-07-26; production, indexing, rights, and exact-use approvals remain
...
> artistic decision.
>
> The donor drafts remain useful design history. This document is the canonical
...
- the eight active Layout E photographs;
- the withdrawn Talks Not Raids derivative and its unresolved history/cache
  review;
