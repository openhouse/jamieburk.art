...
implementation: feature/photo-knowledge-D
supersedes: []
superseded_by: null
---
...
> **Repository note**
>
> This repository uses Ember-inspired **Requests for Comments (RFCs)** for
> durable, reviewable discussion of substantial cross-system designs. Jamie
...
> rights, and publication boundaries directly while preserving that missing
> precursor as an explicit migration question. RFC 0003 specifies the living
> knowledge loop among the private photo
...
>
> This revision keeps draft O as the canonical base because it uses the intended
> RFC number, preserves the boundary attributed to draft RFC 0002, and provides a
...
- Do not weaken the private/public boundary attributed to draft RFC 0002.
...
#### 25.2 Draft RFC 0002 Design History

Draft RFC 0002 supplied a broader archive-selection and publication boundary,
but no canonical RFC 0002 is present in this branch. Until that lineage is
resolved, this RFC restates and enforces the boundary it relies on.
...
- Review this RFC against the draft RFC 0002 boundary and the current Knowledge Wiki schema.
...
- The team identifies no contradiction with the private/public boundary attributed to draft RFC 0002.
...
- Draft RFC 0002 design history supplied with the July 2026 photo-Wiki RFC family
  (not committed as a canonical RFC in this implementation).
