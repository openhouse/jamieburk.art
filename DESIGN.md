...
**Label/Mono Font:** Archivo Narrow for labels and compact metadata; there is
no mono system in the current site.

**Character:** The pairing is practical and public-facing. Archivo Narrow gives
headings, proof labels, and metadata a compressed civic-label quality; Karla
