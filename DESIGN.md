...
**Label/Mono Font:** Archivo Narrow for compact proof labels and metadata;
Karla for prose. There is no mono system in the current site.

**Character:** The pairing is practical and public-facing. Archivo Narrow gives
headings and metadata a compact dossier quality; Karla keeps long summaries
readable, approachable, and unshowy.
