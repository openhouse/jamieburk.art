...
**Label/Mono Font:** Oswald for labels and compact metadata; there is no mono
system in the current site.

**Character:** The pairing is practical and public-facing. Karla keeps headings
and long summaries readable, approachable, and unshowy; Oswald gives compact
metadata and labels a civic placard quality.
