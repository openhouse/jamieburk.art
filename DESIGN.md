...
**Label Font:** Archivo Narrow for compact proof and status labels; Karla for
longer UI text. There is no mono system in the current site.

**Character:** The pairing is practical and public-facing. Archivo Narrow gives
headings and labels a compact public-grotesque voice;
