...
**Label Font:** Oswald with Arial Narrow and system sans fallbacks. There is no
mono system in the current site.

**Character:** Karla keeps headings and long summaries readable, approachable,
and unshowy. Oswald gives short labels and civic emphasis a compact placard
quality without carrying long-form reading.
