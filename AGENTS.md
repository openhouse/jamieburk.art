...
- `docs/knowledge-bank.md` is the narrative source of truth.
- `docs/proofs-bank.md` records public-safe claim boundaries.
- `docs/public-claims-inventory.md` tracks public wording and status.
