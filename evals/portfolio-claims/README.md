...
references, committed run manifests, and public-safety posture. It does not call
an external model.
...
Committed runs live under `runs/<date>-<branch>/`. Each run records the candidate
selected for every fixture, independent judge outcomes, regressions, stopping
