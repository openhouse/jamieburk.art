# Launch-readiness evals v12

This suite turns the portfolio's publication intentions into an optimization
contract for human and LLM collaborators.

Version 12 extends the deterministic social-media archival-production gate
with the complete displayed `@KCTownHall` population: record-level
reconciliation, post-type and year controls, URL and source inventories,
bounded stakeholder-response and collaborator-corroboration floors, visible
engagement boundaries, and public-safety exclusions. It retains the v11 WOW
List population gate, the v10 Google Shared Drive gate, the v9 iCloud gate,
the v8 KC Town Hall stewardship gate, and every earlier invariant.
Versions 1 through 11 remain in the
...
```bash
cp evals/launch-readiness/v12/observation-template.json \
...
Read evals/launch-readiness/v12/evals.json and preserve every protected
