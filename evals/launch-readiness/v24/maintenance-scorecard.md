...
- Current launch-readiness suite: `v24`.
- Current suite size: 45 criteria, comprising 28 hard gates and 17 scored
  criteria.
- Active-version pointer: `evals/launch-readiness/active.json`.
...
- Knowledge operator and projection drift validation:
