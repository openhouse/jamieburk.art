# Launch-readiness evals v11

This suite turns the portfolio's publication intentions into an optimization
contract for human and LLM collaborators.

Version 11 adds a deterministic social-media archival-production gate. It
requires a queryable project-to-handle inventory, reconciliation of dated
profile controls to recovered and unresolved slots, a shared campaign identity
for `@NYCArtC`, bounded Council-member interaction floors, collective
authorship and changing-stewardship rules, and protection of authenticated
session data. It retains the v10 Google Shared Drive gate, the v9 iCloud gate,
the v8 KC Town Hall stewardship gate, and every earlier invariant.
Versions 1 through 10 remain in the
...
```bash
cp evals/launch-readiness/v11/observation-template.json \
...
- authenticated social-account inventory, recovery reconciliation, shared
  campaign identity, bounded interaction floors, and authorship boundaries;
...
Read evals/launch-readiness/v11/evals.json and preserve every protected
