# Launch-readiness evals v3

This suite turns the portfolio's publication intentions into an optimization
contract for human and LLM collaborators.

Version 3 adds lossless intake, resolvable disposition, projection discipline,
and source-decomposition criteria. Versions 1 and 2 remain in the repository
...
```bash
cp evals/launch-readiness/v3/observation-template.json \
...
Read evals/launch-readiness/v3/evals.json and preserve every protected
