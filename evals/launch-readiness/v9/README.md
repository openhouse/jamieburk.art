# Launch-readiness evals v9

This suite turns the portfolio's publication intentions into an optimization
contract for human and LLM collaborators.

Version 9 adds a deterministic archival-production gate for the iCloud Teams
collections. It requires close-read source, claim, inquiry, and intake edges
from Jamie Projects History, CRS, and job-hunt; distinguishes authored plans
and proposals from completed outcomes; preserves unread iCloud placeholders as
bounded research status; and permits only explicitly selected public-safe
projections. It retains the v8 KC Town Hall stewardship gate, the v7 interim
status gate, the v6 Council-action gate, the v5 campaign press gate, and every
earlier invariant. Versions 1 through 8 remain in the
...
```bash
cp evals/launch-readiness/v9/observation-template.json \
...
Read evals/launch-readiness/v9/evals.json and preserve every protected
