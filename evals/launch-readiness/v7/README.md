# Launch-readiness evals v7

This suite turns the portfolio's publication intentions into an optimization
contract for human and LLM collaborators.

Version 7 strengthens the deterministic KC Town Hall municipal-sequence gate
with a May 17, 2022, official project-status checkpoint. It preserves the
proposal, Board recommendation, Council acceptance, $490,539 appropriation,
interim negotiation and no-reported-disbursement-amount status, and later withdrawal without
turning appropriation into evidence of payment or turning a dated snapshot into
an all-time claim. It retains the v6 Council-action gate, the v5 campaign press
gate, and every earlier invariant. Versions 1 through 6 remain in the
...
```bash
cp evals/launch-readiness/v7/observation-template.json \
...
- KC Town Hall proposal, Council action, interim status, and withdrawal;
...
Read evals/launch-readiness/v7/evals.json and preserve every protected
