# Launch-readiness evals v6

This suite turns the portfolio's publication intentions into an optimization
contract for human and LLM collaborators.

Version 6 adds a deterministic KC Town Hall municipal-sequence gate. It
preserves the proposal, Board recommendation, Council acceptance, $490,539
appropriation, and later withdrawal without turning appropriation into evidence
of disbursement, construction, or sole causality. It retains the v5 campaign
press gate and every earlier invariant. Versions 1 through 5 remain in the
...
```bash
cp evals/launch-readiness/v6/observation-template.json \
...
Read evals/launch-readiness/v6/evals.json and preserve every protected
