...
if (process.argv.includes("--help") || process.argv.includes("-h")) {
  ...
  npm run report:knowledge-lifecycle -- --stdout

Writes the public-safe lifecycle report to reports/generated by default. Use
--stdout for read-only review environments.`);
