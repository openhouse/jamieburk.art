...
const prohibitedMutations = [
  ...
  "Unlabeled audience means public.",
  ...
  "Publish the friends-only posts and comment text."
];
...
const boundedStatements = [
  "Every record returned by the capture-date owner-filtered surface received a disposition.",
  "The 1,243-record control is not a lifetime archive or native Meta export.",
  "Unlabeled never means public.",
