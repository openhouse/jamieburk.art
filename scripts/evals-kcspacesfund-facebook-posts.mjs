...
check(
  ...
  records.length === 40 &&
    ...
    recordIdentityDigest ===
      "3909df5f5b5c7ff0be1dc50f8a45afb4f353cfd4bea3d3dac1305906e2f28cf1" &&
    records.every(
      (record, index) =>
...
check(
  ...
  count("recordForm", "media-backed") === 20 &&
    ...
    count("recoveryState", "content-materialized") === 19 &&
    count("recoveryState", "metadata-depth") === 15 &&
    count("recoveryState", "attachment-unavailable") === 6 &&
    fixture.aggregate.mediaBackedRecords === 20 &&
    fixture.aggregate.nonMediaRecords === 20 &&
    fixture.aggregate.contentMaterializedRecords === 19 &&
    fixture.aggregate.metadataDepthRecords === 15 &&
...
check(
  ...
  10,
  modeCount("funded-space-spotlight") === 10 &&
    modeCount("application-routing") === 8 &&
    modeCount("fundraising") === 13 &&
    ...
    fixture.aggregate.fundedSpaceSpotlights === 10 &&
    fixture.aggregate.applicationRoutingRecords === 8 &&
    fixture.aggregate.fundraisingRecords === 13 &&
    includesAll(normalizedDocs, [
...
check(
  ...
  "Exact, incomplete, and independently discovered routes remain distinct",
  10,
  exactRoutes.length === 5 &&
    incompleteRoutes.length === 3 &&
    incompleteRoutes.every((route) =>
      ["historical-route-not-recovered", "preview-only"].includes(
        route.retrievalState
      )
    ) &&
    includesAll(normalizedDocs, [
...
check(
  ...
  12,
  intake?.publicationStatus === "eligible" &&
    intake.sourceIds.length === 10 &&
    intake.observationIds.length === 11 &&
