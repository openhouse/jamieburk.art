...
function checkPdf(filePath) {
  ...
  if (/Placeholder Resume PDF/i.test(text)) {
    reportResumeIssue(rel, "placeholder resume PDF is still present");
  }

  if (placeholderResumeHashes.has(sha256(filePath))) {
    reportResumeIssue(rel, "known placeholder resume PDF hash is still present");
  }
