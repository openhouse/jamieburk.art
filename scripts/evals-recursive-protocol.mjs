...
const requiredFiles = [
  ...
  "docs/knowledge-bank/intake/2026-07-16-kansas-city-star-raft-article.md",
  ...
  "evals/knowledge-bank/runs/2026-07-16-kansas-city-star-raft-source.md",
  "docs/handoffs/2026-07-16-kansas-city-star-article-pass.md",
  ...
  "apps/www/src/data/knowledge-bank/waterways-kc-star-2007.ts",
...
if (
  scripts.check &&
  !scripts.check.includes("npm run evals:wowlist-facebook-posts")
) {
  fail(
    "package.json check script must include npm run evals:wowlist-facebook-posts"
  );
}
...
if (
  scripts.check &&
  !scripts.check.includes("npm run evals:kcspacesfund-facebook-posts")
) {
  fail(
    "package.json check script must include npm run evals:kcspacesfund-facebook-posts"
  );
}
...
if (
  scripts["evals:wowlist-facebook-posts"] !==
  "node scripts/evals-wowlist-facebook-posts.mjs"
) {
  fail(
...
if (
  scripts["evals:kcspacesfund-facebook-posts"] !==
  "node scripts/evals-kcspacesfund-facebook-posts.mjs"
) {
  fail(
    "package.json evals:kcspacesfund-facebook-posts must run scripts/evals-kcspacesfund-facebook-posts.mjs"
  );
}
