...
const screenshotPlan = new Map([
  ...
  ["1280:/work/fair-rent-nyc", "fair-rent-desktop.png"],
    ...
    for (const route of routes) {
      ...
      const before = await page.evaluate(() => {
        ...
        return {
          ...
          skipLinkHref,
          skipTargetPresent:
            skipLinkHref.startsWith("#") &&
            Boolean(document.querySelector(skipLinkHref)),
        };
      });
      ...
      rows.push({
        ...
        skipLinkHref: before.skipLinkHref,
        skipTargetPresent: before.skipTargetPresent,
        skipLinkWasFirst:
          before.skipLinkHref !== "" &&
          firstKeyboardTarget.includes(before.skipLinkHref),
