...
const lines = [
  ...
  `- Context-separated model holdouts: ${stop.contextSeparatedHoldouts}`,
  `- Reviewer identity assurance: ${stop.identityAssurance} (cryptographic verification: ${stop.cryptographicIdentityVerified})`,
